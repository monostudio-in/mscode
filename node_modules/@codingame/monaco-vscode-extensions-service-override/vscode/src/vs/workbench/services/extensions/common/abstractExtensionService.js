            ...
            veto(value, reason) {
                ...
                if (typeof value === "boolean") {
                    ...
                    value.then(value => {
                        ...
                        vetoReasons.add(( localize(16303, "{0} (Error: {1})", reason, toErrorMessage(error))));
                    });
                }
            }
        });
        ...
        if (!veto) {
            ...
            if (!auto) {
                ...
                const {
                    ...
                    message: ( localize(16304, "Please confirm restart of extensions.")),
                    detail: vetoReasonsArray.length === 1 ? vetoReasonsArray[0] : vetoReasonsArray.join("\n -"),
                    primaryButton: ( localize(16305, "Restart Anyway"))
                });
                if (confirmed) {
                    return true;
                }
    ...
    async _onRemoteExtensionHostCrashed(extensionHost, reconnectionToken) {
        try {
            ...
            if (this._remoteCrashTracker.shouldAutomaticallyRestart()) {
                ...
                this._notificationService.status(( localize(16306, "The remote extension host terminated unexpectedly. Restarting...")), {
                    hideAfter: 5000
                });
                ...
                this._notificationService.prompt(Severity.Error, ( localize(
                    ...
                    label: ( localize(16308, "Restart Remote Extension Host")),
                    run: () => {
                        this._startExtensionHostsIfNecessary(false, Array.from(( this._allRequestedActivateEvents.keys())));
                    }
                }]);
...
( Registry.as(Extensions.ExtensionFeaturesRegistry)).registerExtensionFeature({
    id: "activationEvents",
    label: ( localize(16309, "Activation Events")),
    access: {
        canToggle: false
    },
