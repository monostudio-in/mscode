...
let ExtensionBisectUi = class ExtensionBisectUi {
    ...
    _showBisectPrompt() {
        const goodPrompt = {
            label: ( localize(16196, "I can't reproduce")),
            run: () => this._commandService.executeCommand("extension.bisect.next", false)
        };
        const badPrompt = {
            label: ( localize(16197, "I can reproduce")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(16200, "Start Extension Bisect")),
    ...
    async run(accessor) {
        ...
        const res = await dialogService.confirm({
            message: ( localize(16201, "Extension Bisect")),
            detail: ( localize(
                16202,
            ...
            primaryButton: ( localize(16203, "&&Start Extension Bisect"))
        });
        if (res.confirmed) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(16204, "Continue Extension Bisect")),
            category: Categories.Help,
            f1: true,
    ...
    async run(accessor, seeingBad) {
        ...
        if (done.bad) {
            await dialogService.info(( localize(16205, "Extension Bisect")), ( localize(
                16206,
            ...
            const res = await dialogService.confirm({
                type: Severity.Info,
                message: ( localize(16205, "Extension Bisect")),
                primaryButton: ( localize(16207, "&&Report Issue & Continue")),
                cancelButton: ( localize(16208, "Continue")),
                detail: ( localize(
                    16209,
                ...
                checkbox: {
                    label: ( localize(16210, "Keep this extension disabled")),
                    checked: true
                }
            });
    ...
    async _checkForBad(dialogService, bisectService) {
        const {
            ...
            type: Severity.Info,
            message: ( localize(16211, "Extension Bisect")),
            detail: ( localize(
                16212,
                "Extension Bisect is active and has disabled {0} extensions. Check if you can still reproduce the problem and proceed by selecting from these options.",
            ...
            buttons: [{
                label: ( localize(16213, "I ca&&n't reproduce")),
                run: () => false
            }, {
                label: ( localize(16214, "I can &&reproduce")),
                run: () => true
            }, {
                label: ( localize(16215, "&&Stop Bisect")),
                run: () => undefined
            }],
            cancelButton: {
                label: ( localize(16216, "&&Cancel Bisect")),
                run: () => null
            }
        });
        return result;
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(16217, "Stop Extension Bisect")),
            category: Categories.Help,
            f1: true,
            precondition: ExtensionBisectUi.ctxIsBisectActive
        });
