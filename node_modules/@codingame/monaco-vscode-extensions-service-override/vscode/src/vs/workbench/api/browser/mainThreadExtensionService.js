        ...
        if (this._extensionEnablementService.isEnabled(missingInstalledDependency)) {
            this._notificationService.notify({
                ...
                actions: {
                    primary: [toAction({
                        id: "reload",
                        label: ( localize(2556, "Reload Window")),
            ...
            if (enablementState === EnablementState.DisabledByVirtualWorkspace) {
                ...
                this._notificationService.notify({
                    ...
                    actions: {
                        primary: [toAction({
                            ...
                            label: ( localize(2559, "Manage Workspace Trust")),
                ...
                this._notificationService.notify({
                    ...
                    actions: {
                        primary: [toAction({
                            id: "enable",
                            label: ( localize(2561, "Enable and Reload")),
                            enabled: true,
        ...
        if (dependencyExtension) {
            this._notificationService.notify({
                ...
                actions: {
                    primary: [toAction({
                        id: "install",
                        label: ( localize(2564, "Install and Reload")),
