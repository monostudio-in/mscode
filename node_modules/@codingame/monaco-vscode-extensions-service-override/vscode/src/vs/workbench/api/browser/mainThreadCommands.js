...
MainThreadCommands = __decorate([extHostNamedCustomer(MainContext.MainThreadCommands), ( __param(1, ICommandService)), ( __param(2, IExtensionService))], MainThreadCommands);
function _generateMarkdown(description) {
    if (typeof description === "string") {
        return description;
    } else {
        const descriptionString = isString(description.description) ?
        description.description : description.description.original;
