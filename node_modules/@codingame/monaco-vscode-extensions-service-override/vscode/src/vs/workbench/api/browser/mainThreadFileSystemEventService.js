        ...
        const fileOperationParticipant = new (class {
                ...
                if (showPreview === undefined) {
                    ...
                    if (needsConfirmation) {
                        const {
                            ...
                            type: Severity.Info,
                            message,
                            primaryButton: ( localize(2574, "Show &&Preview")),
                            cancelButton: ( localize(2575, "Skip Changes"))
                        });
                        showPreview = true;
                        if (!confirmed) {
                            return;
                        ...
                        const {
                            ...
                            message,
                            buttons: [{
                                label: ( localize(2576, "&&OK")),
                                run: () => Choice.OK
                            }, {
                                label: ( localize(2574, "Show &&Preview")),
                                run: () => Choice.Preview
                            }],
                            cancelButton: {
                                label: ( localize(2575, "Skip Changes")),
                                run: () => Choice.Cancel
                            },
                            checkbox: {
                                label: ( localize(2577, "Do not ask me again"))
                            }
                        });
            ...
            _progressLabel(operation) {
                ...
                case FileOperation.CREATE:
                    return localize(2578, "Running 'File Create' participants...");
                case FileOperation.MOVE:
                    return localize(2579, "Running 'File Rename' participants...");
                case FileOperation.COPY:
                    return localize(2580, "Running 'File Copy' participants...");
                case FileOperation.DELETE:
                    return localize(2581, "Running 'File Delete' participants...");
                case FileOperation.WRITE:
                    return localize(2582, "Running 'File Write' participants...");
                }
            }
        })();
        this._listener.add(
...
registerAction2(class ResetMemento extends Action2 {
    constructor() {
        super({
            ...
            title: {
                value: ( localize(2583, "Reset choice for 'File operation needs preview'")),
