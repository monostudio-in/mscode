...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2966, "Go to File...")),
            metadata: {
...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(2967, "Quick Open")),
            icon: Codicon.search,
            menu: {
...
class QuickAccessNavigateNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super("workbench.action.quickOpenNavigateNext", ( localize2(2968, "Navigate Next in Quick Open")), true, true);
    }
}
class QuickAccessNavigatePreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super("workbench.action.quickOpenNavigatePrevious", ( localize2(2969, "Navigate Previous in Quick Open")), false, true);
    }
}
class QuickAccessSelectNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super("workbench.action.quickOpenSelectNext", ( localize2(2970, "Select Next in Quick Open")), true, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
            mac: {
...
class QuickAccessSelectPreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super("workbench.action.quickOpenSelectPrevious", ( localize2(2971, "Select Previous in Quick Open")), false, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
            mac: {
                primary: KeyMod.WinCtrl | KeyCode.KeyP
            }
        });
    }
}
