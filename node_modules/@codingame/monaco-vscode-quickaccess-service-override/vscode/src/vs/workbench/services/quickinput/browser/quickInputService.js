...
import { InQuickPickContextKey } from '@codingame/monaco-vscode-api/vscode/vs/workbench/browser/quickaccess';
...
QuickInputService = ( __decorate([( __param(0, IConfigurationService)), ( __param(1, IInstantiationService)), ( __param(2, IKeybindingService)), ( __param(3, IContextKeyService)), ( __param(4, IThemeService)), ( __param(5, ILayoutService))], QuickInputService));
