...
let CommandsQuickAccessProvider = class CommandsQuickAccessProvider extends AbstractEditorCommandsQuickAccessProvider {
    ...
    constructor(
        ...
        super({
            ...
            noResultsPick: () => ({
                label: ( localize(12097, "No matching commands")),
                commandId: ""
            })
    ...
    updateOptions(e) {
        ...
        const suggestedCommandIds = config.experimental.suggestCommands && this.productService.commandPaletteSuggestedCommandIds?.length ? ( new Set(this.productService.commandPaletteSuggestedCommandIds)) : undefined;
    ...
    async getCommandPicks(token) {
        ...
        return ([...this.getCodeEditorCommandPicks(), ...this.getGlobalCommandPicks()].map(picks => ({
            ...
            buttons: [{
                ...
                tooltip: ( localize(12098, "Configure Keybinding"))
            }],
            trigger: () => {
    ...
    getGlobalCommandPicks() {
        ...
        for (const action of globalCommandsMenuActions) {
            ...
            if (category) {
                label = ( localize(12101, "{0}: {1}", category, label));
            }
...
CommandsQuickAccessProvider = CommandsQuickAccessProvider_1 = ( __decorate([( __param(0, IEditorService)), ( __param(1, IMenuService)), ( __param(2, IExtensionService)), ( __param(3, IInstantiationService)), ( __param(4, IKeybindingService)), ( __param(5, ICommandService)), ( __param(6, ITelemetryService)), ( __param(7, IDialogService)), ( __param(8, IConfigurationService)), ( __param(9, IEditorGroupsService)), ( __param(10, IPreferencesService)), ( __param(11, IProductService)), ( __param(12, IAiRelatedInformationService)), ( __param(13, IChatAgentService))], CommandsQuickAccessProvider));
class ShowAllCommandsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(12102, "Show All Commands")),
            keybinding: {
...
class ClearCommandHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12103, "Clear Command History")),
            f1: true
        });
    }
    async run(accessor) {
        ...
        if (commandHistoryLength > 0) {
            const {
                ...
                type: "warning",
                message: ( localize(12104, "Do you want to clear the history of recently used commands?")),
                detail: ( localize(12105, "This action is irreversible!")),
                primaryButton: ( localize(12106, "&&Clear"))
            });
            if (!confirmed) {
                return;
            }
