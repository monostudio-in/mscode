...
let ViewQuickAccessProvider = class ViewQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    constructor(
        ...
        super(ViewQuickAccessProvider_1.PREFIX, {
            noResultsPick: {
                label: ( localize(12119, "No matching views")),
                containerLabel: ""
            }
        });
    ...
    doGetViewPickItems() {
        ...
        addPaneComposites(ViewContainerLocation.Sidebar, ( localize(12120, "Side Bar")));
        addPaneComposites(ViewContainerLocation.Panel, ( localize(12121, "Panel")));
        addPaneComposites(ViewContainerLocation.AuxiliaryBar, ( localize(12122, "Secondary Side Bar")));
        ...
        this.terminalGroupService.groups.forEach((group, groupIndex) => {
            group.terminalInstances.forEach((terminal, terminalIndex) => {
                ...
                viewEntries.push({
                    label,
                    containerLabel: ( localize(12124, "Terminal")),
                    accept: async () => {
        ...
        this.debugService.getModel().getSessions(true).filter(s => s.hasSeparateRepl()).forEach((session, _) => {
            ...
            viewEntries.push({
                label,
                containerLabel: ( localize(12125, "Debug Console")),
                accept: async () => {
        ...
        for (const channel of channels) {
            viewEntries.push({
                label: channel.label,
                containerLabel: ( localize(12126, "Output")),
...
ViewQuickAccessProvider = ViewQuickAccessProvider_1 = ( __decorate([( __param(0, IViewDescriptorService)), ( __param(1, IViewsService)), ( __param(2, IOutputService)), ( __param(3, ITerminalService)), ( __param(4, ITerminalGroupService)), ( __param(5, IDebugService)), ( __param(6, IPaneCompositePartService)), ( __param(7, IContextKeyService))], ViewQuickAccessProvider));
class OpenViewPickerAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(12127, "Open View")),
...
class QuickAccessViewPickerAction extends Action2 {
    ...
    static {
        this.KEYBINDING = {
            ...
            mac: {
                primary: KeyMod.WinCtrl | KeyCode.KeyQ
            },
            linux: {
                primary: 0
            }
    ...
    constructor() {
        super({
            ...
            title: ( localize2(12128, "Quick Open View")),
            category: Categories.View,
            f1: false,
            keybinding: {
