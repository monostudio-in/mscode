...
GotoLineQuickAccessProvider = ( __decorate([( __param(0, IEditorService)), ( __param(1, IConfigurationService)), ( __param(2, IStorageService))], GotoLineQuickAccessProvider));
class GotoLineAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(7890, "Go to Line/Column...")),
            f1: true,
            keybinding: {
                ...
                mac: {
                    primary: KeyMod.WinCtrl | KeyCode.KeyG
                }
            }
        });
    }
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    helpEntries: [{
        description: ( localize(7892, "Go to Line/Column")),
...
class GotoOffsetAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(7893, "Go to Offset...")),
            f1: true
        });
    }
    async run(accessor) {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    helpEntries: [{
        description: ( localize(7894, "Go to Offset")),
