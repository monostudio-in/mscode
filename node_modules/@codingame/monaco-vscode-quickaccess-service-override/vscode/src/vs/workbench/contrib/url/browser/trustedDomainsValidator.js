...
import { isURLDomainTrusted } from '@codingame/monaco-vscode-api/vscode/vs/platform/url/common/trustedDomains';
...
OpenerValidatorContributions = ( __decorate([( __param(0, IOpenerService)), ( __param(1, IStorageService)), ( __param(2, IDialogService)), ( __param(3, IProductService)), ( __param(4, IQuickInputService)), ( __param(5, IEditorService)), ( __param(6, IClipboardService)), ( __param(7, ITelemetryService)), ( __param(8, IInstantiationService)), ( __param(9, IConfigurationService)), ( __param(10, IWorkspaceTrustManagementService)), ( __param(11, ITrustedDomainService))], OpenerValidatorContributions));
