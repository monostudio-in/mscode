...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    helpEntries: [{
        description: ( localize(12108, "Show all Quick Access Providers")),
        commandCenterOrder: 70,
        commandCenterLabel: ( localize(12109, "More"))
    }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: ( localize(12110, "Type the name of a view, output channel or terminal to open.")),
    helpEntries: [{
        description: ( localize(12111, "Open View")),
...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: ( localize(12112, "Type the name of a command to run.")),
    helpEntries: [{
        description: ( localize(12113, "Show and Run Commands")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    ...
    command: {
        ...
        title: ( localize(12114, "&&Command Palette..."))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarHelpMenu, {
    ...
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(12115, "Show All Commands"))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    ...
    command: {
        ...
        title: ( localize(12116, "&&Open View..."))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        ...
        title: ( localize(12117, "Go to &&Line/Column..."))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
    ...
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(12118, "Command Palette..."))
    },
    order: 1
});
