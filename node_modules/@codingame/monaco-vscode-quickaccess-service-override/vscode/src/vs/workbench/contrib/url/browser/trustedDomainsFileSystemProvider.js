...
import { TRUSTED_DOMAINS_CONTENT_STORAGE_KEY, readTrustedDomains, TRUSTED_DOMAINS_STORAGE_KEY } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/url/browser/trustedDomains';
...
TrustedDomainsFileSystemProvider = ( __decorate([( __param(0, IFileService)), ( __param(1, IStorageService)), ( __param(2, IInstantiationService))], TrustedDomainsFileSystemProvider));
