...
let TextFileSaveParticipant = class TextFileSaveParticipant extends Disposable {
    ...
    async participate(model, context, progress, token) {
        ...
        progress.report({
            message: ( localize(16621, "Running Code Actions and Formatters..."))
        });
        let bubbleCancel = false;
        await this.progressService.withProgress({
            priority: NotificationPriority.URGENT,
            location: ProgressLocation.Notification,
            cancellable: ( localize(16622, "Skip")),
...
TextFileSaveParticipant = ( __decorate([( __param(0, ILogService)), ( __param(1, IProgressService))], TextFileSaveParticipant));
