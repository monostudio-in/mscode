...
let TextFileEditorModelManager = class TextFileEditorModelManager extends Disposable {
    ...
    registerListeners() {
        ...
        this._register(
            this.fileService.onDidChangeFileSystemProviderRegistrations(e => this.onDidChangeFileSystemProviderRegistrations(e))
        );
        this._register(
    ...
    registerModel(model) {
        ...
        modelListeners.add(model.onDidResolve(reason => this._onDidResolve.fire({
            model,
            reason
        })));
        ...
        modelListeners.add(model.onDidSave(e => this._onDidSave.fire({
            model,
            ...e
        })));
...
TextFileEditorModelManager = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, IFileService)), ( __param(2, INotificationService)), ( __param(3, IWorkingCopyFileService)), ( __param(4, IUriIdentityService))], TextFileEditorModelManager));
