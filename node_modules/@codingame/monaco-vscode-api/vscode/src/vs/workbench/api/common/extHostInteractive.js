...
class ExtHostInteractive {
    constructor(
        ...
        const openApiCommand = ( new ApiCommand(
            ...
            [( new ApiCommandArgument("showOptions", "Show Options", v => true, v => v)), ( new ApiCommandArgument("resource", "Interactive resource Uri", v => true, v => v)), ( new ApiCommandArgument("controllerId", "Notebook controller Id", v => true, v => v)), ( new ApiCommandArgument("title", "Interactive editor title", v => true, v => v))],
