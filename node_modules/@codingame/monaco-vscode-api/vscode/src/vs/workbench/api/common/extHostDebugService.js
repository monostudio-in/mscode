...
let ExtHostDebugServiceBase = class ExtHostDebugServiceBase extends Disposable {
    ...
    async getAdapterDescriptor(adapterDescriptorFactory, session) {
        ...
        if (adapterDescriptorFactory) {
            ...
            return asPromise(
                () => adapterDescriptorFactory.createDebugAdapterDescriptor(session.api, this.daExecutableFromPackage(session, extensionRegistry))
            ).then(daDescriptor => {
                if (daDescriptor) {
                    return daDescriptor;
                }
...
ExtHostDebugServiceBase = ( __decorate([( __param(0, IExtHostRpcService)), ( __param(1, IExtHostWorkspace)), ( __param(2, IExtHostExtensionService)), ( __param(3, IExtHostConfiguration)), ( __param(4, IExtHostEditorTabs)), ( __param(5, IExtHostVariableResolverProvider)), ( __param(6, IExtHostCommands)), ( __param(7, IExtHostTesting))], ExtHostDebugServiceBase));
...
WorkerExtHostDebugService = ( __decorate([( __param(0, IExtHostRpcService)), ( __param(1, IExtHostWorkspace)), ( __param(2, IExtHostExtensionService)), ( __param(3, IExtHostConfiguration)), ( __param(4, IExtHostEditorTabs)), ( __param(5, IExtHostVariableResolverProvider)), ( __param(6, IExtHostCommands)), ( __param(7, IExtHostTesting))], WorkerExtHostDebugService));
