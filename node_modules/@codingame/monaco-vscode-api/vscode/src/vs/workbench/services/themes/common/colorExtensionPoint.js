...
const configurationExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(16646, "Contributes extension defined themable colors")),
        type: "array",
        items: {
            type: "object",
            properties: {
                id: {
                    type: "string",
                    description: ( localize(16647, "The identifier of the themable color")),
                ...
                description: {
                    type: "string",
                    description: ( localize(16649, "The description of the themable color"))
                },
                defaults: {
                    type: "object",
                    properties: {
        ...
        configurationExtPoint.setHandler((extensions, delta) => {
            for (const extension of delta.added) {
                ...
                if (!extensionValue || !Array.isArray(extensionValue)) {
                    collector.error(( localize(16654, "'configuration.colors' must be a array")));
                    return;
                }
                ...
                for (const colorContribution of extensionValue) {
                    if (typeof colorContribution.id !== "string" || colorContribution.id.length === 0) {
                        collector.error(( localize(16656, "'configuration.colors.id' must be defined and can not be empty")));
                        return;
                    }
...
class ColorDataRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [( localize(16662, "ID")), ( localize(16663, "Description")), ( localize(16664, "Dark Default")), ( localize(16665, "Light Default")), ( localize(16666, "High Contrast Default"))];
