...
const extensionVerifiedPublisherIconColor = registerColor("extensionIcon.verifiedForeground", textLinkForeground, ( localize(16284, "The icon color for extension verified publisher.")), false);
