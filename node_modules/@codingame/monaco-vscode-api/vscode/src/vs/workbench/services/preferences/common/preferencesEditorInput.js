...
const SettingsEditorIcon = registerIcon("settings-editor-label-icon", Codicon.settings, ( localize(16508, "Icon of the settings editor label.")));
let SettingsEditor2Input = class SettingsEditor2Input extends EditorInput {
    ...
    getName() {
        return localize(16509, "Settings");
    }
    getIcon() {
...
const PreferencesEditorIcon = registerIcon("preferences-editor-label-icon", Codicon.settings, ( localize(16510, "Icon of the preferences editor label.")));
class PreferencesEditorInput extends EditorInput {
    ...
    getName() {
        return localize(16511, "Preferences");
    }
    getIcon() {
