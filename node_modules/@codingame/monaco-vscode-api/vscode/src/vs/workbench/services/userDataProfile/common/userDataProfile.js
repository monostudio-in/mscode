...
const defaultUserDataProfileIcon = registerIcon("defaultProfile-icon", Codicon.settings, ( localize(16880, "Icon for Default Profile.")));
const PROFILES_TITLE = ( localize2(16881, "Profiles"));
const PROFILES_CATEGORY = {
    ...PROFILES_TITLE
};
const PROFILE_EXTENSION = "code-profile";
const PROFILE_FILTER = [{
    name: ( localize(16882, "Profile")),
