...
let WorkspaceExtensionsConfigService = class WorkspaceExtensionsConfigService extends Disposable {
    ...
    async toggleRecommendation(extensionId) {
        ...
        const workspaceOrFolders = isRecommended ? await this.pickWorkspaceOrFolders(
            ...
            ( localize(16285, "Remove extension recommendation from"))
        ) : await this.pickWorkspaceOrFolders(
            workspace.folders,
            workspace.configuration ? workspace : undefined,
            ( localize(16286, "Add extension recommendation to"))
        );
    ...
    async pickWorkspaceOrFolders(workspaceFolders, workspace, placeHolder) {
        ...
        const folderPicks = ( workspaceFolders.map(workspaceFolder => {
            return {
                ...
                description: ( localize(16287, "Workspace Folder")),
        ...
        if (workspace) {
            ...
            folderPicks.push({
                label: ( localize(16288, "Workspace")),
