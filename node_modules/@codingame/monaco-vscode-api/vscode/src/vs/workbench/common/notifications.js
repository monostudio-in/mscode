...
class NotificationViewItem extends Disposable {
    ...
    get sticky() {
        ...
        if (
        (hasActions && this._severity === Severity$1.Error) || (!hasActions && this._expanded) || (this._progress && !this._progress.state.done)) {
            return true;
        }
        return false;
    }
...
export { ChoiceAction, NotificationChangeType, NotificationHandle, NotificationViewItem, NotificationViewItemContentChangeKind, NotificationViewItemProgress, NotificationsModel, NotificationsPosition, NotificationsSettings, StatusMessageChangeType, getNotificationsPosition, isNotificationViewItem };
