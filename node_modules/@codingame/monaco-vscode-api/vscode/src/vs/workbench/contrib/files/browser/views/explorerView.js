...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    renderHeader(container) {
        ...
        const setHeader = () => {
            ...
            this.ariaHeaderLabel = ( localize(9981, "Explorer Section: {0}", this.name));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(9983, "New Folder...")),
            f1: false,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9984, "Refresh Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(9985, "Forces a refresh of the Explorer."))
            },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9986, "Collapse Folders in Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(9987, "Folds all folders in the Explorer."))
            }
        });
    }
    run(accessor) {
