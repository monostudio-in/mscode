...
const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: ( localize(13682, "Contributes terminal functionality.")),
        type: "object",
        properties: {
            profiles: {
                type: "array",
                description: ( localize(13683, "Defines additional terminal profiles that the user can create.")),
                items: {
                    type: "object",
                    required: ["id", "title"],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: ( localize(13684, "The ID of the terminal profile provider.")),
                            type: "string"
                        },
                        title: {
                            description: ( localize(13685, "Title for this terminal profile.")),
                            type: "string"
                        },
                        icon: {
                            ...
                            anyOf: [{
                                ...
                                properties: {
                                    light: {
                                        description: ( localize(13687, "Icon path when a light theme is used")),
                                        type: "string"
                                    },
                                    dark: {
                                        description: ( localize(13688, "Icon path when a dark theme is used")),
                                        type: "string"
                                    }
                                }
                            }]
