...
let MergeEditorInput = class MergeEditorInput extends AbstractTextResourceEditorInput {
    ...
    getName() {
        return localize(10969, "Merging: {0}", super.getName());
    }
    async resolve() {
        if (!this._inputModel) {
...
function alertFocusedEditor(editor) {
    switch (editor) {
    case "input1":
        alert(( localize(10970, "Incoming, Left Input")));
        break;
    case "input2":
        alert(( localize(10971, "Current, Right Input")));
        break;
    case "result":
        alert(( localize(10972, "Merge Result")));
        break;
    }
}
