...
let DefaultFormatter = class DefaultFormatter extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFormatter_1.extensionItemLabels.push(( localize(10035, "None")));
        DefaultFormatter_1.extensionDescriptions.push(( localize(10036, "None")));
    ...
    async _selectFormatter(formatter, document, mode, kind) {
        ...
        if (mode !== FormattingMode.Silent) {
            const {
                ...
                message: ( localize(10041, "Configure Default Formatter")),
                detail: formatterOrMessage,
                primaryButton: ( localize(10042, "&&Configure..."))
            });
            if (confirmed) {
            ...
            this._notificationService.prompt(Severity$1.Info, formatterOrMessage, [{
                label: ( localize(10043, "Configure...")),
    ...
    _updateStatus() {
        ...
        this._analyzeFormatter(FormattingKind.File, formatter, document).then(result => {
            ...
            const command = {
                ...
                title: ( localize(10045, "Configure..."))
            };
...
async function showFormatterPick(accessor, model, formatters) {
    ...
    const picks = ( formatters.map((provider, index) => {
        ...
        const pick = {
            ...
            description: isDefault ? ( localize(10049, "(default)")) : undefined
        };
        if (isDefault) {
    ...
    const configurePick = {
        label: ( localize(10050, "Configure Default Formatter..."))
    };
    const pick = await quickPickService.pick([...picks, {
        type: "separator"
    }, configurePick], {
        placeHolder: ( localize(10051, "Select a formatter")),
...
registerEditorAction(class FormatDocumentMultipleAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(10052, "Format Document With...")),
...
registerEditorAction(class FormatSelectionMultipleAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(10053, "Format Selection With...")),
            alias: "Format Code...",
