...
let SearchWidget = class SearchWidget extends Widget {
    ...
    static {
        this.REPLACE_ALL_DISABLED_LABEL = ( localize(12869, "Replace All (Submit Search to Enable)"));
    }
    static {
        this.REPLACE_ALL_ENABLED_LABEL = keyBindingService2 => {
            return keyBindingService2.appendKeybinding(( localize(12870, "Replace All")), ReplaceAllAction.ID);
        };
    }
    constructor(
        container,
    ...
    _updateSearchInputAriaLabel(includeHint) {
        ...
        let searchLabel = ( localize(12871, "Search: Type Search Term and press Enter to search"));
        if (includeHint && !this._accessibilityHelpHintAnnounced && this.configurationService.getValue("accessibility.verbosity.find") && this.accessibilityService.isScreenReaderOptimized()) {
            ...
            if (keybinding) {
                searchLabel += ", " + ( localize(12872, "Press {0} for accessibility help", keybinding));
                this._accessibilityHelpHintAnnounced = true;
                this._labelResetTimeout?.dispose();
                this._labelResetTimeout = disposableTimeout(() => {
                    if (this.searchInput) {
                        this.searchInput.inputBox.setAriaLabel(( localize(12871, "Search: Type Search Term and press Enter to search")));
                    }
                }, 1000);
            }
        }
    ...
    renderToggleReplaceButton(parent) {
        const opts = {
            ...
            title: ( localize(12873, "Toggle Replace")),
    ...
    renderSearchInput(parent, options) {
        ...
        const inputOptions = {
            label: ( localize(12871, "Search: Type Search Term and press Enter to search")),
            validation: value => this.validateSearchInput(value),
            placeholder: ( localize(12874, "Search")),
        ...
        this.showContextToggle = ( new Toggle({
            isChecked: false,
            title: this.keybindingService.appendKeybinding(( localize(12875, "Toggle Context Lines")), ToggleSearchEditorContextLinesCommandId),
    ...
    renderReplaceInput(parent, options) {
        ...
        this.replaceInput = this._register(( new ContextScopedReplaceInput(replaceBox, this.contextViewService, {
            label: ( localize(12876, "Replace: Type replace term and press Enter to preview")),
            placeholder: ( localize(12877, "Replace")),
