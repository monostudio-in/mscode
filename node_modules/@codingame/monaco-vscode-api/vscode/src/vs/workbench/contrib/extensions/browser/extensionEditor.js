...
class VersionWidget extends ExtensionWithDifferentGalleryVersionWidget {
    constructor(container, hoverService) {
        ...
        this._register(
            hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), this.element, ( localize(9024, "Extension Version")))
        );
        this.render();
    }
    render() {
...
let ExtensionEditor = class ExtensionEditor extends EditorPane {
    ...
    createEditor(parent) {
        ...
        this._register(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), name, ( localize(9025, "Extension name")))
        );
        const versionWidget = ( new VersionWidget(title, this.hoverService));
        const preview = append(title, $("span.preview"));
        this._register(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), preview, ( localize(9026, "Preview")))
        );
        preview.textContent = ( localize(9026, "Preview"));
        const builtin = append(title, $("span.builtin"));
        builtin.textContent = ( localize(9027, "Built-in"));
    ...
    renderNavbar(extension, manifest, template, preserveFocus) {
        ...
        template.navbar.push(ExtensionEditorTab.Readme, ( localize(9028, "Details")), ( localize(9029, "Extension details, rendered from the extension's 'README.md' file")));
        if (manifest) {
            template.navbar.push(ExtensionEditorTab.Features, ( localize(9030, "Features")), ( localize(9031, "Lists features contributed by this extension")));
        }
        if (extension.hasChangelog()) {
            template.navbar.push(ExtensionEditorTab.Changelog, ( localize(9032, "Changelog")), ( localize(
                9033,
                "Extension update history, rendered from the extension's 'CHANGELOG.md' file"
            )));
        }
        if (extension.dependencies.length) {
            template.navbar.push(ExtensionEditorTab.Dependencies, ( localize(9034, "Dependencies")), ( localize(9035, "Lists extensions this extension depends on")));
        }
        if (manifest && manifest.extensionPack?.length && !this.shallRenderAsExtensionPack(manifest)) {
            template.navbar.push(ExtensionEditorTab.ExtensionPack, ( localize(9036, "Extension Pack")), ( localize(
                9037,
    ...
    async openDetails(extension, contentContainer, token) {
        ...
        if (manifest && manifest.extensionPack?.length && this.shallRenderAsExtensionPack(manifest)) {
            ...
            activeElement = await this.openMarkdown(extension, this.extensionReadme.get(), ( localize(9038, "No README available.")), contentContainer, WebviewIndex.Readme, ( localize(9039, "Readme")), token);
        }
    ...
    async openExtensionPackReadme(extension, manifest, container, token) {
        ...
        extensionPackHeader.textContent = ( localize(9040, "Extension Pack ({0})", manifest.extensionPack.length));
        ...
        await Promise.all([
            ...
            this.openMarkdown(extension, this.extensionReadme.get(), ( localize(9038, "No README available.")), readmeContent, WebviewIndex.Readme, ( localize(9039, "Readme")), token)
        ]);
        return {
    ...
    async openChangelog(extension, contentContainer, token) {
        const activeElement = await this.openMarkdown(extension, this.extensionChangelog.get(), ( localize(9041, "No Changelog available.")), contentContainer, WebviewIndex.Changelog, ( localize(9042, "Changelog")), token);
        return activeElement;
    }
    ...
    openExtensionDependencies(extension, contentContainer, token) {
        ...
        if (isFalsyOrEmpty(extension.dependencies)) {
            append(contentContainer, $("p.nocontent")).textContent = ( localize(9043, "No Dependencies"));
...
let AdditionalDetailsWidget = class AdditionalDetailsWidget extends Disposable {
    ...
    renderCategories(container, extension) {
        if (extension.categories.length) {
            ...
            append(
                categoriesContainer,
                $(".additional-details-title", undefined, ( localize(9044, "Categories")))
            );
    ...
    renderExtensionResources(container, extension) {
        ...
        if (extension.repository) {
            try {
                resources.push([( localize(9045, "Repository")), ThemeIcon.fromId(Codicon.repo.id), ( URI.parse(extension.repository))]);
            } catch (error) {}
        }
        if (extension.supportUrl) {
            try {
                resources.push([( localize(9046, "Issues")), ThemeIcon.fromId(Codicon.issues.id), ( URI.parse(extension.supportUrl))]);
            } catch (error) {}
        }
        if (extension.licenseUrl) {
            try {
                resources.push([( localize(9047, "License")), ThemeIcon.fromId(Codicon.linkExternal.id), ( URI.parse(extension.licenseUrl))]);
            } catch (error) {}
        }
        ...
        if (extension.url) {
            resources.push([( localize(9048, "Marketplace")), ThemeIcon.fromId(Codicon.linkExternal.id), ( URI.parse(extension.url))]);
        }
        if (resources.length || extension.publisherSponsorLink) {
            const extensionResourcesContainer = append(container, $(".resources-container.additional-details-element"));
            append(
                extensionResourcesContainer,
                $(".additional-details-title", undefined, ( localize(9049, "Resources")))
            );
    ...
    renderInstallInfo(container, extension) {
        ...
        append(
            ...
            $(".additional-details-title", undefined, ( localize(9050, "Installation")))
        );
        const installInfo = append(installInfoContainer, $(".more-info"));
        append(installInfo, $(
            ".more-info-entry",
            undefined,
            $("div.more-info-entry-name", undefined, ( localize(9051, "Identifier"))),
        ...
        if (extension.type !== ExtensionType.System) {
            append(installInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(9052, "Version"))),
        ...
        if (extension.installedTimestamp) {
            append(installInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(9053, "Last Updated"))),
                $("div", {
        ...
        if (!extension.isBuiltin && extension.source !== "gallery") {
            const element = $("div", undefined, extension.source === "vsix" ? ( localize(9054, "VSIX")) : ( localize(9055, "Local")));
            append(installInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(9056, "Source"))),
                element
            ));
        ...
        if (extension.size) {
            ...
            append(
                ...
                $(".more-info-entry", undefined, $("div.more-info-entry-name", {
                    title: ( localize(9057, "Size when installed"))
                }, ( localize(9058, "Size"))), element)
            );
        ...
        this.getCacheLocation(extension).then(cacheLocation => {
            ...
            computeSize(cacheLocation, this.fileService).then(cacheSize => {
                ...
                append(
                    installInfo,
                    $(".more-info-entry", undefined, $("div.more-info-entry-name", {
                        title: ( localize(9059, "Cache size"))
                    }, ( localize(9060, "Cache"))), element)
                );
                if (isNative && extension.location.scheme === Schemas.file) {
                    element.classList.add("link");
                    element.tabIndex = 0;
    ...
    renderMarketplaceInfo(container, extension) {
        ...
        append(
            moreInfoContainer,
            $(".additional-details-title", undefined, ( localize(9061, "Marketplace")))
        );
        ...
        if (gallery) {
            ...
            append(moreInfo, $(
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(9062, "Published"))),
                $("div", {
                ...
                ".more-info-entry",
                undefined,
                $("div.more-info-entry-name", undefined, ( localize(9063, "Last Released"))),
                $("div", {
...
registerAction2(class StartExtensionEditorFindPreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(9066, "Find Previous")),
            keybinding: {
                when: ( ContextKeyExpr.and(contextKeyExpr, KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_FOCUSED)),
