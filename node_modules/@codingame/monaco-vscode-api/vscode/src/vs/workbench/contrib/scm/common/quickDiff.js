...
const editorGutterModifiedBackground = registerColor("editorGutter.modifiedBackground", {
    ...
    hcDark: "#1B81A8",
    hcLight: "#2090D3"
}, ( localize(12545, "Editor gutter background color for lines that are modified.")));
...
const editorGutterAddedBackground = registerColor("editorGutter.addedBackground", {
    ...
    hcDark: "#487E02",
    hcLight: "#48985D"
}, ( localize(12547, "Editor gutter background color for lines that are added.")));
...
const editorGutterDeletedBackground = registerColor("editorGutter.deletedBackground", editorErrorForeground, ( localize(12549, "Editor gutter background color for lines that are deleted.")));
...
const minimapGutterModifiedBackground = registerColor(
    ...
    ( localize(12551, "Minimap gutter background color for lines that are modified."))
);
const minimapGutterAddedBackground = registerColor(
    "minimapGutter.addedBackground",
    editorGutterAddedBackground,
    ( localize(12552, "Minimap gutter background color for lines that are added."))
);
const minimapGutterDeletedBackground = registerColor(
    "minimapGutter.deletedBackground",
    editorGutterDeletedBackground,
    ( localize(12553, "Minimap gutter background color for lines that are deleted."))
);
const overviewRulerModifiedForeground = registerColor("editorOverviewRuler.modifiedForeground", ( transparent(editorGutterModifiedBackground, 0.6)), ( localize(12554, "Overview ruler marker color for modified content.")));
const overviewRulerAddedForeground = registerColor("editorOverviewRuler.addedForeground", ( transparent(editorGutterAddedBackground, 0.6)), ( localize(12555, "Overview ruler marker color for added content.")));
const overviewRulerDeletedForeground = registerColor("editorOverviewRuler.deletedForeground", ( transparent(editorGutterDeletedBackground, 0.6)), ( localize(12556, "Overview ruler marker color for deleted content.")));
registerColor("editorGutter.itemGlyphForeground", {
    dark: editorForeground,
    light: editorForeground,
    hcDark: Color.black,
    hcLight: Color.white
}, ( localize(12557, "Editor gutter decoration color for gutter item glyphs.")));
