...
const testStateNames = {
    [TestResultState.Errored]: ( localize(14803, "Errored")),
    [TestResultState.Failed]: ( localize(14804, "Failed")),
    [TestResultState.Passed]: ( localize(14805, "Passed")),
    [TestResultState.Queued]: ( localize(14806, "Queued")),
    [TestResultState.Running]: ( localize(14807, "Running")),
    [TestResultState.Skipped]: ( localize(14808, "Skipped")),
    [TestResultState.Unset]: ( localize(14809, "Not yet run"))
};
const labelForTestInState = (label, state) => ( localize(14810, "{0} ({1})", stripIcons(label), testStateNames[state]));
const testConfigurationGroupNames = {
    [TestRunProfileBitset.Debug]: ( localize(14811, "Debug")),
    [TestRunProfileBitset.Run]: ( localize(14812, "Run")),
    [TestRunProfileBitset.Coverage]: ( localize(14813, "Coverage"))
};
var TestCommandId;
