...
let AbstractRuntimeExtensionsEditor = class AbstractRuntimeExtensionsEditor extends EditorPane {
    ...
    constructor(
        ...
        _environmentService,
        _clipboardService,
        _extensionFeaturesManagementService,
        _hoverService,
        _menuService
    ) {
        super(
            AbstractRuntimeExtensionsEditor_1.ID,
            group,
            telemetryService,
            themeService,
            storageService
        ...
        this._register(
            this._extensionFeaturesManagementService.onDidChangeAccessData(() => this._updateSoon.schedule())
        );
    ...
    createEditor(parent) {
        ...
        const renderer = {
            ...
            renderElement: (element, index, data) => {
                ...
                if (activationTimes) {
                    ...
                    if (activationEvent === "*") {
                        title = ( localize(9004, "Activated by {0} on start-up", activationId));
                        ...
                        title = ( localize(9008, "Activated by {0} after start-up finished", activationId));
                        ...
                        title = ( localize(9010, "Activated by {1} on {0}", activationEvent, activationId));
                    }
                } else {
                    title = ( localize(9011, "Extension is activating..."));
                }
                ...
                if (this._getUnresponsiveProfile(element.description.identifier)) {
                    ...
                    const extensionHostFreezTitle = ( localize(9012, "Extension has caused the extension host to freeze."));
                    data.elementDisposables.push(
                ...
                if (isNonEmptyArray(element.status.runtimeErrors)) {
                    const el = $("span", undefined, ...renderLabelWithIcons(`$(bug) ${( localize(9013, "{0} uncaught errors", element.status.runtimeErrors.length))}`));
                    data.msgContainer.appendChild(el);
                }
                ...
                for (const feature of features) {
                    ...
                    if (accessData) {
                        ...
                        if (status) {
                            ...
                            data.msgContainer.appendChild($("span", undefined, ...renderLabelWithIcons(
                                `$(${status.severity === Severity$1.Error ? errorIcon.id : warningIcon.id}) ${status.message}`
                            )));
                        }
                        if (accessData?.accessTimes.length > 0) {
                            ...
                            ))}${accessData.current ? ( localize(9015, ", {0} Requests (Session)", accessData.current.accessTimes.length)) : ""}`);
        ...
        this._list = this._instantiationService.createInstance(WorkbenchList, "RuntimeExtensions", parent, delegate, [renderer], {
            ...
            accessibilityProvider: new (class {
                getWidgetAriaLabel() {
                    return localize(9017, "Runtime Extensions");
                }
        ...
        this._register(this._list.onContextMenu(e => {
            ...
            const actions = [];
            actions.push(( new Action("runtimeExtensionsEditor.action.copyId", ( localize(9018, "Copy id ({0})", e.element.description.identifier.value)), undefined, true, () => {
            ...
            if (e.element.marketplaceInfo) {
                actions.push(( new Action("runtimeExtensionsEditor.action.disableWorkspace", ( localize(9019, "Disable (Workspace)")), undefined, true, () => this._extensionsWorkbenchService.setEnablement(e.element.marketplaceInfo, EnablementState.DisabledWorkspace))));
                actions.push(( new Action("runtimeExtensionsEditor.action.disable", ( localize(9020, "Disable")), undefined, true, () => this._extensionsWorkbenchService.setEnablement(e.element.marketplaceInfo, EnablementState.DisabledGlobally))));
            }
            actions.push(( new Separator()));
...
AbstractRuntimeExtensionsEditor = AbstractRuntimeExtensionsEditor_1 = ( __decorate([( __param(1, ITelemetryService)), ( __param(2, IThemeService)), ( __param(3, IContextKeyService)), ( __param(4, IExtensionsWorkbenchService)), ( __param(5, IExtensionService)), ( __param(6, INotificationService)), ( __param(7, IContextMenuService)), ( __param(8, IInstantiationService)), ( __param(9, IStorageService)), ( __param(10, ILabelService)), ( __param(11, IWorkbenchEnvironmentService)), ( __param(12, IClipboardService)), ( __param(13, IExtensionFeaturesManagementService)), ( __param(14, IHoverService)), ( __param(15, IMenuService))], AbstractRuntimeExtensionsEditor));
class ShowRuntimeExtensionsAction extends Action2 {
    constructor() {
        super({
            id: "workbench.action.showRuntimeExtensions",
            title: ( localize2(9021, "Show Running Extensions")),
    ...
    async run(accessor) {
        await accessor.get(IEditorService).openEditor(RuntimeExtensionsInput.instance, {
            pinned: true
        });
    }
}
