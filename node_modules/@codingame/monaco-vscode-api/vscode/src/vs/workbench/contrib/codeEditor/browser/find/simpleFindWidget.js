...
const NLS_FIND_INPUT_LABEL = ( localize(7869, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(7870, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(7871, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(7872, "Next Match"));
const NLS_CLOSE_BTN_LABEL = ( localize(7873, "Close"));
...
class SimpleFindWidget extends Widget {
    ...
    _updateFindInputAriaLabel() {
        ...
        if (!this._accessibilityHelpHintAnnounced && this._configurationService.getValue("accessibility.verbosity.find") && this._accessibilityService.isScreenReaderOptimized()) {
            ...
            if (keybinding) {
                findLabel += ", " + ( localize(7874, "Press {0} for accessibility help", keybinding));
    ...
    _announceSearchResults(label, searchString) {
        if (!searchString) {
            return localize(7875, "Enter search input");
        }
        if (label === NLS_NO_RESULTS) {
            return searchString === "" ? ( localize(7876, "{0} found", label)) : ( localize(7877, "{0} found for '{1}'", label, searchString));
        }
        return localize(7878, "{0} found for '{1}'", label, searchString);
    }
}
const simpleFindWidgetSashBorder = registerColor("simpleFindWidget.sashBorder", {
    ...
    hcDark: "#6FC3DF",
    hcLight: "#0F4A85"
}, ( localize(7879, "Border color of the sash border.")));
