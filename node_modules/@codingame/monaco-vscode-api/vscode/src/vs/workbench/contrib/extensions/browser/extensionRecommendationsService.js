...
let ExtensionRecommendationsService = class ExtensionRecommendationsService extends Disposable {
    ...
    async getWorkspaceRecommendations() {
        ...
        for (const {
            extension
        } of this.workspaceRecommendations.recommendations) {
    ...
    async getExeBasedRecommendations(exe) {
        ...
        const {
            important,
            others
        } = exe ? this.exeBasedRecommendations.getRecommendations(exe) : {
    ...
    async promptWorkspaceRecommendations() {
        ...
        const allowedRecommendations = ( [
            ...
            ...this.configBasedRecommendations.importantRecommendations.filter(
                recommendation => !recommendation.whenNotInstalled || recommendation.whenNotInstalled.every(id => installed.every(local => !areSameExtensions(local.identifier, {
                    id
                })))
            )
        ].map((
...
ExtensionRecommendationsService = ( __decorate([( __param(0, IInstantiationService)), ( __param(1, ILifecycleService)), ( __param(2, IExtensionGalleryService)), ( __param(3, ITelemetryService)), ( __param(4, IEnvironmentService)), ( __param(5, IExtensionManagementService)), ( __param(6, IExtensionIgnoredRecommendationsService)), ( __param(7, IExtensionRecommendationNotificationService)), ( __param(8, IExtensionsWorkbenchService)), ( __param(9, IRemoteExtensionsScannerService)), ( __param(10, IUserDataInitializationService))], ExtensionRecommendationsService));
