...
configurationRegistry.registerConfiguration({
    ...
    "properties": {
        [FILES_EXCLUDE_CONFIG]: {
            ...
            "additionalProperties": {
                "anyOf": [{
                    "type": "boolean",
                    "enum": [true, false],
                    "enumDescriptions": [( localize(9872, "Enable the pattern.")), ( localize(9873, "Disable the pattern."))],
        ...
        "files.eol": {
            "type": "string",
            "enum": ["\n", "\r\n", "auto"],
            "enumDescriptions": [( localize(9880, "LF")), ( localize(9881, "CRLF")), ( localize(9882, "Uses operating system specific end of line character."))],
            "default": "auto",
            "description": ( localize(9883, "The default end of line character.")),
            "scope": ConfigurationScope.LANGUAGE_OVERRIDABLE
        },
        "files.enableTrash": {
            "type": "boolean",
        ...
        "files.trimTrailingWhitespace": {
            "type": "boolean",
            "default": false,
            "description": ( localize(9885, "When enabled, will trim trailing whitespace when saving a file.")),
            "scope": ConfigurationScope.LANGUAGE_OVERRIDABLE
        },
        ...
        "files.autoSave": {
            ...
            "markdownEnumDescriptions": [( localize(9889, "An editor with changes is never automatically saved.")), ( localize(
                9890,
        ...
        "files.restoreUndoStack": {
            "type": "boolean",
            "description": ( localize(9903, "Restore the undo stack when a file is reopened.")),
            "default": true
        },
...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        ...
        "editor.formatOnSaveMode": {
            ...
            "enumDescriptions": [( localize(9912, "Format the whole file.")), ( localize(
                9913,
