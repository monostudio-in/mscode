...
const breakpointHelperDecoration = {
    ...
    glyphMarginHoverMessage: ( new MarkdownString()).appendText(( localize(8157, "Click to add a breakpoint"))),
...
let BreakpointEditorContribution = class BreakpointEditorContribution {
            ...
            if (e.event.rightButton || (isMacintosh && e.event.leftButton && e.event.ctrlKey)) {
                ...
                if (breakpoints.length) {
                    ...
                    if (isAltPressed) {
                        ...
                        const breakpointType = logPoint ? ( localize(8158, "Logpoint")) : ( localize(8159, "Breakpoint"));
                        const disabledBreakpointDialogMessage = ( localize(
                            ...
                            logPoint ? ( localize(8161, "message")) : ( localize(8162, "condition"))
                        ));
                        ...
                        await this.dialogService.prompt({
                            ...
                            buttons: [{
                                label: ( localize(8164, "&&Remove {0}", breakpointType)),
                                run: () => breakpoints.forEach(bp => this.debugService.removeBreakpoints(bp.getId()))
                            }, {
                                label: ( localize(
                                    8165,
                                    "{0} {1}",
                                    enabled ? ( localize(8166, "&&Disable")) : ( localize(8167, "&&Enable")),
                                    breakpointType
                                )),
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            const breakpointType = breakpoints[0].logMessage ? ( localize(8158, "Logpoint")) : ( localize(8159, "Breakpoint"));
            actions.push(toAction({
                id: "debug.removeBreakpoint",
                label: ( localize(8168, "Remove {0}", breakpointType)),
                enabled: true,
                run: async () => {
            ...
            actions.push(toAction({
                ...
                label: ( localize(8169, "Edit {0}...", breakpointType)),
                enabled: true,
                run: () => Promise.resolve(
                    this.showBreakpointWidget(breakpoints[0].lineNumber, breakpoints[0].column)
                )
            ...
            actions.push(toAction({
                ...
                label: breakpoints[0].enabled ? ( localize(8170, "Disable {0}", breakpointType)) : ( localize(8171, "Enable {0}", breakpointType)),
                enabled: true,
            ...
            actions.push(( new SubmenuAction("debug.removeBreakpoints", ( localize(8172, "Remove Breakpoints")), ( sorted.map(bp => toAction({
                id: "removeInlineBreakpoint",
                label: bp.column ? ( localize(8173, "Remove Inline Breakpoint on Column {0}", bp.column)) : ( localize(8174, "Remove Line Breakpoint")),
                enabled: true,
                run: () => this.debugService.removeBreakpoints(bp.getId())
            }))))));
            actions.push(( new SubmenuAction("debug.editBreakpoints", ( localize(8175, "Edit Breakpoints")), ( sorted.map(bp => toAction({
                id: "editBreakpoint",
                label: bp.column ? ( localize(8176, "Edit Inline Breakpoint on Column {0}", bp.column)) : ( localize(8177, "Edit Line Breakpoint")),
                enabled: true,
                run: () => Promise.resolve(this.showBreakpointWidget(bp.lineNumber, bp.column))
            }))))));
            actions.push(( new SubmenuAction("debug.enableDisableBreakpoints", ( localize(8178, "Enable/Disable Breakpoints")), ( sorted.map(bp => toAction({
                id: bp.enabled ? "disableColumnBreakpoint" : "enableColumnBreakpoint",
                label: bp.enabled ? (bp.column ? ( localize(8179, "Disable Inline Breakpoint on Column {0}", bp.column)) : ( localize(8180, "Disable Line Breakpoint"))) : (bp.column ? ( localize(8181, "Enable Inline Breakpoint on Column {0}", bp.column)) : ( localize(8182, "Enable Line Breakpoint"))),
                enabled: true,
            ...
            actions.push(toAction({
                id: "addBreakpoint",
                label: ( localize(8183, "Add Breakpoint")),
                enabled: true,
            ...
            actions.push(toAction({
                ...
                label: ( localize(8184, "Add Conditional Breakpoint...")),
                enabled: true,
                run: () => Promise.resolve(
            ...
            actions.push(toAction({
                id: "addLogPoint",
                label: ( localize(8185, "Add Logpoint...")),
                enabled: true,
                run: () => Promise.resolve(
            ...
            actions.push(toAction({
                ...
                label: ( localize(8186, "Add Triggered Breakpoint...")),
                enabled: true,
                run: () => Promise.resolve(
        ...
        if (this.debugService.state === State.Stopped) {
            ...
            actions.push(toAction({
                id: "runToLine",
                label: ( localize(8187, "Run to Line")),
                enabled: true,
...
const debugIconBreakpointForeground = registerColor("debugIcon.breakpointForeground", "#E51400", ( localize(8188, "Icon color for breakpoints.")));
const debugIconBreakpointDisabledForeground = registerColor("debugIcon.breakpointDisabledForeground", "#848484", ( localize(8189, "Icon color for disabled breakpoints.")));
const debugIconBreakpointUnverifiedForeground = registerColor("debugIcon.breakpointUnverifiedForeground", "#848484", ( localize(8190, "Icon color for unverified breakpoints.")));
const debugIconBreakpointCurrentStackframeForeground = registerColor("debugIcon.breakpointCurrentStackframeForeground", {
    dark: "#FFCC00",
    light: "#BE8700",
    hcDark: "#FFCC00",
    hcLight: "#BE8700"
}, ( localize(8191, "Icon color for the current breakpoint stack frame.")));
const debugIconBreakpointStackframeForeground = registerColor("debugIcon.breakpointStackframeForeground", "#89D185", ( localize(8192, "Icon color for all breakpoint stack frames.")));
