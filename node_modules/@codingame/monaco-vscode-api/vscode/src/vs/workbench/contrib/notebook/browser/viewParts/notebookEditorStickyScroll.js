...
class NotebookStickyLine extends Disposable {
    constructor(element, foldingIcon, header, entry, notebookEditor) {
        ...
        this._register(
            addDisposableListener(this.header, EventType.CLICK, () => {
                this.focusCell();
            })
        );
...
let NotebookStickyScroll = NotebookStickyScroll_1 = class NotebookStickyScroll extends Disposable {
    ...
    constructor(
        ...
        this._register(
            addDisposableListener(this.domNode, EventType.CONTEXT_MENU, async event => {
    ...
    updateConfig(e) {
        if (e.stickyScrollEnabled) {
            ...
            this.updateContent(computeContent(
                this.notebookEditor,
    ...
    async init() {
        ...
        } = this.notebookCellOutlineReference = this.instantiationService.invokeFunction(
...
NotebookStickyScroll = NotebookStickyScroll_1 = ( __decorate([( __param(4, IContextMenuService)), ( __param(5, IInstantiationService))], NotebookStickyScroll));
function computeContent(
    notebookEditor,
    notebookCellList,
    notebookOutlineEntries,
    renderedStickyHeight
) {
