...
let SCMHistoryItemContext = SCMHistoryItemContext_1 = class SCMHistoryItemContext {
    ...
    constructor(_scmViewService) {
        ...
        this.label = ( localize(12492, "Source Control..."));
    ...
    asPicker(_widget) {
        return {
            placeholder: ( localize(12493, "Select a change")),
                    ...
                    return historyProvider.provideHistoryItems({
                        ...
                        return (historyItems.map(historyItem => {
                            ...
                            if (historyItem.statistics) {
                                details.push(`${historyItem.statistics.files} ${( localize(12494, "file(s)"))}`);
                            }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12495, "Add to Chat")),
            f1: false,
            menu: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12496, "Explain Changes")),
            f1: false,
            menu: {
                id: MenuId.SCMHistoryItemContext,
                group: "z_chat",
