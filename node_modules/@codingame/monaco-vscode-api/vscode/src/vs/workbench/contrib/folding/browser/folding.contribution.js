...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(( localize(10032, "All")));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(( localize(10033, "All active folding range providers")));
