...
let SymbolsQuickAccessProvider = class SymbolsQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    constructor(
        ...
        super(SymbolsQuickAccessProvider_1.PREFIX, {
            ...
            noResultsPick: {
                label: ( localize(12878, "No matching workspace symbols"))
            }
        });
        ...
        for (const {
            ...
            symbolPicks.push({
                ...
                buttons: [{
                    ...
                    tooltip: openSideBySideDirection === "right" ? ( localize(12879, "Open to the Side")) : ( localize(12880, "Open to the Bottom"))
                }],
