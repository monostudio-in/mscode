...
let CommentReply = class CommentReply extends Disposable {
    ...
    setCommentEditorDecorations() {
        const hasExistingComments = this._commentThread.comments && this._commentThread.comments.length > 0;
        const placeholder = hasExistingComments ? (this._commentOptions?.placeHolder || ( localize(8016, "Reply..."))) : (this._commentOptions?.placeHolder || ( localize(8017, "Type a new comment")));
    ...
    createReplyButton(commentEditor, commentForm) {
        ...
        this._register(this.hoverService.setupManagedHover(
            ...
            this._commentOptions?.prompt || ( localize(8016, "Reply..."))
        ));
        this._reviewThreadReplyButton.textContent = this._commentOptions?.prompt || ( localize(8016, "Reply..."));
