...
const DisassemblyEditorIcon = registerIcon("disassembly-editor-label-icon", Codicon.debug, ( localize(8913, "Icon of the disassembly editor label.")));
class DisassemblyViewInput extends EditorInput {
    ...
    getName() {
        return localize(8914, "Disassembly");
    }
    getIcon() {
