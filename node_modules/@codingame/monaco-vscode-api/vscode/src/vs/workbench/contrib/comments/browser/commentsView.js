...
let CommentsPanel = class CommentsPanel extends FilterViewPane {
    ...
    constructor(
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: ( localize(8092, "Filter (e.g. text, author)")),
                ariaLabel: ( localize(8093, "Filter comments")),
    ...
    updateFilter() {
        ...
        this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : ( localize(8094, "Showing {0} of {1}", filtered, total)));
    ...
    makeCommentLocationLabel(file, range) {
        ...
        if (!range) {
            return localize(8095, "in {0}", fileLabel);
        }
    ...
    getReplyCountAsString(node, forAriaLabel) {
        return node.replies.length && !forAriaLabel ? ( localize(8103, " {0} replies,", node.replies.length)) : "";
    }
    createTree() {
                ...
                accessibilityProvider: {
                    getAriaLabel: element => {
                        if (element instanceof CommentsModel) {
                            return localize(8104, "Comments for current workspace");
                        }
