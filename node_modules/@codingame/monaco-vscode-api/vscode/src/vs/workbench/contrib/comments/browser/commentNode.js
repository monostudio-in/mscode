                ...
                return this._reactionActions.add(( new Action(
                    ...
                    async () => {
                        try {
                            ...
                            const error = e.message ? ( localize(8014, "Toggling the comment reaction failed: {0}.", e.message)) : ( localize(8015, "Toggling the comment reaction failed"));
