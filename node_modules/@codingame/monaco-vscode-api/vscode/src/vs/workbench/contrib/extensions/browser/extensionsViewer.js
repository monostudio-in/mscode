...
function getAriaLabelForExtension(extension) {
    ...
    const publisher = extension.publisherDomain?.verified ? ( localize(9451, "Verified Publisher {0}", extension.publisherDisplayName)) : ( localize(9452, "Publisher {0}", extension.publisherDisplayName));
    const deprecated = extension?.deprecationInfo ? ( localize(9453, "Deprecated")) : "";
        ...
        this.list = instantiationService.createInstance(
            ...
            [renderer],
            {
                ...
                accessibilityProvider: {
                    ...
                    getWidgetAriaLabel() {
                        return localize(9455, "Extensions");
                    }
                },
...
class UnknownExtensionRenderer {
    ...
    renderTemplate(container) {
        ...
        append(messageContainer, $("span.error-marker")).textContent = ( localize(9456, "Error"));
        append(messageContainer, $("span.message")).textContent = ( localize(9457, "Unknown Extension:"));
