...
const NOTEBOOK_FOLD_COMMAND_LABEL = ( localize(11281, "Fold Cell"));
const NOTEBOOK_UNFOLD_COMMAND_LABEL = ( localize2(11282, "Unfold Cell"));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: "notebook.fold",
            title: ( localize2(11281, "Fold Cell")),
