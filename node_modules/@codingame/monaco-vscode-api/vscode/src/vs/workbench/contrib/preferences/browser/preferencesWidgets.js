...
let SettingsTargetsWidget = class SettingsTargetsWidget extends Widget {
    ...
    resetLabels() {
        ...
        this.userLocalSettings.label = ( localize(11861, "User"));
        this.userRemoteSettings.label = ( localize(11862, "Remote")) + (hostLabel ? ` [${hostLabel}]` : "");
        this.workspaceSettings.label = ( localize(11863, "Workspace"));
        this.folderSettingsAction.label = ( localize(11864, "Folder"));
    }
    create(parent) {
        ...
        this.settingsSwitcherBar = this._register(( new ActionBar(settingsTabsWidget, {
            ...
            ariaLabel: ( localize(11865, "Settings Switcher")),
            ariaRole: "tablist",
        ...
        this.userLocalSettings.tooltip = ( localize(11861, "User"));
        ...
        const remoteAuthority = this.environmentService.remoteAuthority;
        const hostLabel = remoteAuthority && this.labelService.getHostLabel(Schemas.vscodeRemote, remoteAuthority);
        this.userRemoteSettings.tooltip = ( localize(11862, "Remote")) + (hostLabel ? ` [${hostLabel}]` : "");
    ...
    setResultCount(settingsTarget, count) {
        if (settingsTarget === ConfigurationTarget.WORKSPACE) {
            let label = ( localize(11863, "Workspace"));
            if (count) {
                label += ` (${count})`;
            }
            this.workspaceSettings.label = label;
        } else if (settingsTarget === ConfigurationTarget.USER_LOCAL) {
            let label = ( localize(11861, "User"));
            if (count) {
                label += ` (${count})`;
            }
    ...
    async update() {
        ...
        this.workspaceSettings.tooltip = ( localize(11863, "Workspace"));
    }
};
