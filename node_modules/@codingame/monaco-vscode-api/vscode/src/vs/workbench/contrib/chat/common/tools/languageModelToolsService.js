...
(function(ToolDataSource) {
    ...
    function classify(source) {
        if (source.type === "internal") {
            ...
            return {
                ordinal: 0,
                label: ( localize(7814, "User Defined"))
            };
        } else {
            return {
                ordinal: 3,
...
class ToolSetForModel {
    ...
    getTools(r) {
        return Iterable.filter(
            ...
            toolData => toolMatchesModel(toolData, this.model)
        );
    }
}
...
export { SpecedToolAliases, ToolDataSource, ToolInvocationPresentation, ToolSet, ToolSetForModel, VSCodeToolReference, createToolSchemaUri, isToolInvocationContext, isToolResultInputOutputDetails, isToolResultOutputDetails, isToolSet, stringifyPromptTsxPart, toolContentToA11yString, toolMatchesModel, toolResultHasBuffers };
