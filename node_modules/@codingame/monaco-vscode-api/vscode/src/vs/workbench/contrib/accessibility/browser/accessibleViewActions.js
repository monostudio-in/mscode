...
class AccessibleViewNextAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4525, "Show Next in Accessible View"))
        });
    }
    run(accessor) {
...
class AccessibleViewNextCodeBlockAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4526, "Accessible View: Next Code Block"))
        });
    }
    run(accessor) {
...
class AccessibleViewPreviousCodeBlockAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4527, "Accessible View: Previous Code Block"))
        });
    }
    run(accessor) {
...
class AccessibleViewPreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4528, "Show Previous in Accessible View"))
        });
    }
    run(accessor) {
...
class AccessibleViewGoToSymbolAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4529, "Go To Symbol in Accessible View"))
        });
    }
    run(accessor) {
...
const AccessibilityHelpAction = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
        ...
        group: "",
        title: ( localize(4530, "Open Accessibility Help")),
        order: 1
    }]
})));
const AccessibleViewAction = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
        menuId: MenuId.CommandPalette,
        group: "",
        title: ( localize(4531, "Open Accessible View")),
        order: 1
    }]
})));
class AccessibleViewDisableHintAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4532, "Disable Accessible View Hint"))
        });
    }
    run(accessor) {
...
class AccessibilityHelpConfigureKeybindingsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4533, "Accessibility Help Configure Unassigned Keybindings"))
        });
    }
    async run(accessor) {
...
class AccessibilityHelpConfigureAssignedKeybindingsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4534, "Accessibility Help Configure Assigned Keybindings"))
        });
    }
    async run(accessor) {
...
class AccessibilityHelpOpenHelpLinkAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4535, "Accessibility Help Open Help Link"))
        });
    }
    run(accessor) {
...
class AccessibleViewAcceptInlineCompletionAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4536, "Accept Inline Completion"))
        });
    }
    async run(accessor) {
