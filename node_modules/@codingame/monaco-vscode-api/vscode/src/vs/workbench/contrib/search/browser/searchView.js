...
const SEARCH_CANCELLED_MESSAGE = ( localize(12812, "Search was canceled before any results could be found - "));
...
let SearchView = class SearchView extends ViewPane {
    ...
    renderBody(parent) {
        ...
        const toggleQueryDetailsLabel = ( localize(12813, "Toggle Search Details"));
        ...
        const filesToIncludeTitle = ( localize(12814, "files to include"));
        ...
        this.inputPatternIncludes = this._register(
            this.instantiationService.createInstance(IncludePatternInputWidget, folderIncludesList, this.contextViewService, {
                ...
                placeholder: ( localize(12815, "e.g. *.ts, src/**/include")),
        ...
        const excludesTitle = ( localize(12816, "files to exclude"));
        ...
        this.inputPatternExcludes = this._register(
            this.instantiationService.createInstance(ExcludePatternInputWidget, excludesList, this.contextViewService, {
                ...
                placeholder: ( localize(12817, "e.g. *.ts, src/**/exclude")),
                showPlaceholderOnFocus: true,
    ...
    replaceAll() {
        ...
        const confirmation = {
            title: ( localize(12818, "Replace All")),
            message: this.buildReplaceAllConfirmationMessage(occurrences, fileCount, replaceValue),
            primaryButton: ( localize(12819, "&&Replace"))
        };
    ...
    buildAfterReplaceAllMessage(occurrences, fileCount, replaceValue) {
        if (occurrences === 1) {
            if (fileCount === 1) {
                ...
                return localize(12821, "Replaced {0} occurrence across {1} file.", occurrences, fileCount);
            }
            if (replaceValue) {
                return localize(
                    12822,
            ...
            return localize(12823, "Replaced {0} occurrence across {1} files.", occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (replaceValue) {
                return localize(
            ...
            return localize(12825, "Replaced {0} occurrences across {1} file.", occurrences, fileCount);
        }
        if (replaceValue) {
            return localize(
                12826,
    ...
    buildReplaceAllConfirmationMessage(occurrences, fileCount, replaceValue) {
        ...
        if (occurrences === 1) {
            if (fileCount === 1) {
                ...
                return localize(12829, "Replace {0} occurrence across {1} file?", occurrences, fileCount);
            }
            if (displayReplaceValue) {
                return localize(
                    12830,
            ...
            return localize(12831, "Replace {0} occurrence across {1} files?", occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (displayReplaceValue) {
                return localize(
            ...
            return localize(12833, "Replace {0} occurrences across {1} file?", occurrences, fileCount);
        }
        if (displayReplaceValue) {
            return localize(
                12834,
        ...
        return localize(12835, "Replace {0} occurrences across {1} files?", occurrences, fileCount);
    }
    clearMessage() {
    ...
    clearSearchResults(clearInput = true) {
        ...
        this.tree.ariaLabel = ( localize(12836, "Empty Search"));
    ...
    validateQuery(query) {
        ...
        return Promise.all(folderQueriesExistP).then(existResults => {
            ...
            if (!query.folderQueries.length || existingFolderQueries.length) {
                ...
                const searchPathNotFoundError = ( localize(12837, "Search path not found: {0}", nonExistantPath));
    ...
    appendSearchWithAIButton(messageEl) {
        const searchWithAIButtonTooltip = this.keybindingService.appendKeybinding(( localize(12838, "Search with AI.")), SearchCommandIds.SearchWithAIActionId);
        const searchWithAIButtonText = ( localize(12839, "Search with AI"));
        ...
        if (!allResults) {
            ...
            if (!completed) {
                ...
                if (hasIncludes && hasExcludes) {
                    ...
                    message = ( localize(12845, "No results found in '{0}' - ", includePatternText));
                } else if (hasExcludes) {
                    message = ( localize(12846, "No results found excluding '{0}' - ", excludePatternText));
                } else {
                    message = ( localize(
                        12847,
            ...
            if (!completed) {
                const searchAgainButton = this.messageDisposables.add(( new SearchLinkButton(( localize(12848, "Search again")), () => this.triggerQueryChange({
                    preserveFocus: false
                }), this.hoverService)));
                append(messageEl, searchAgainButton.element);
            } else if (hasIncludes || hasExcludes) {
                const searchAgainButton = this.messageDisposables.add(( new SearchLinkButton(( localize(12849, "Search again in all files")), this.onSearchAgain.bind(this), this.hoverService)));
                append(messageEl, searchAgainButton.element);
            } else {
                const openSettingsButton = this.messageDisposables.add(( new SearchLinkButton(( localize(12850, "Open Settings")), this.onOpenSettings.bind(this), this.hoverService)));
    ...
    updateSearchResultCount(disregardExcludesAndIgnores, onlyOpenEditors, clear = false) {
        ...
        if (fileCount > 0) {
            if (disregardExcludesAndIgnores) {
                const excludesDisabledMessage = " - " + ( localize(12854, "exclude settings and ignore files are disabled")) + " ";
                const enableExcludesButton = this.messageDisposables.add(( new SearchLinkButton(( localize(12855, "enable")), this.onEnableExcludes.bind(this), this.hoverService, ( localize(12856, "Use Exclude Settings and Ignore Files")))));
                append(messageEl, $(
                    "span",
                    undefined,
            ...
            if (onlyOpenEditors) {
                const searchingInOpenMessage = " - " + ( localize(12857, "searching only in open files")) + " ";
                const disableOpenEditorsButton = this.messageDisposables.add(( new SearchLinkButton(( localize(12858, "disable")), this.onDisableSearchInOpenEditors.bind(this), this.hoverService, ( localize(12859, "Search in entire workspace")))));
                append(messageEl, $(
                    "span",
                    undefined,
            ...
            append(messageEl, " - ");
            const openInEditorTooltip = this.keybindingService.appendKeybinding(( localize(12860, "Copy current search results to an editor")), SearchCommandIds.OpenInEditorCommandId);
            const openInEditorButton = this.messageDisposables.add(( new SearchLinkButton(( localize(12861, "Open in editor")), () => this.instantiationService.invokeFunction(
    ...
    updateKeywordSuggestionUI(keyword) {
        ...
        if (this._cachedKeywords.length > 0) {
            ...
            const resultMsg = ( localize(12862, "Search instead for: "));
            append(messageEl, resultMsg);
            const button = this.messageDisposables.add(( new SearchLinkButton(
                keyword.keyword,
    ...
    buildResultCountMessage(resultCount, fileCount) {
        if (resultCount === 1 && fileCount === 1) {
            return localize(12863, "{0} result in {1} file", resultCount, fileCount);
        } else if (resultCount === 1) {
            return localize(12864, "{0} result in {1} files", resultCount, fileCount);
        } else if (fileCount === 1) {
            return localize(12865, "{0} results in {1} file", resultCount, fileCount);
        } else {
            return localize(12866, "{0} results in {1} files", resultCount, fileCount);
        }
    }
    showSearchWithoutFolderMessage() {
        ...
        const openFolderButton = this.messageDisposables.add(( new SearchLinkButton(( localize(12868, "Open Folder")), () => {
