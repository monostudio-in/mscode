...
import { IsSandboxWorkspaceContext, IsSessionsWindowContext, IsMainWindowFullscreenContext } from '../../common/contextkeys.js';
...
class BaseOpenRecentAction extends Action2 {
    ...
    async run(accessor) {
        ...
        const workspaceSeparator = {
            type: "separator",
            label: hasWorkspaces ? ( localize(2985, "folders & workspaces")) : ( localize(2986, "folders"))
        };
        const fileSeparator = {
            type: "separator",
            label: ( localize(2987, "files"))
        };
            ...
            onDidTriggerItemButton: async context => {
                if (context.button === this.removeFromRecentlyOpened || context.button === this.windowOpenedRecentlyOpenedFolder || context.button === this.windowOpenedRecentlyOpenedWorkspace) {
                    ...
                    const {
                        ...
                        title: isDirtyWorkspace ? ( localize(2990, "Workspace with Unsaved Files")) : ( localize(2991, "Folder with Unsaved Files")),
                        message: isDirtyWorkspace ? ( localize(2992, "Do you want to open the workspace to review the unsaved files?")) : ( localize(2993, "Do you want to open the folder to review the unsaved files?")),
    ...
    toQuickPick(modelService, languageService, labelService, recent, kind) {
        ...
        return {
            iconClasses,
            label: name,
            ariaLabel: kind.isDirty ? isWorkspace ? ( localize(2996, "{0}, workspace with unsaved changes", name)) : ( localize(2997, "{0}, folder with unsaved changes", name)) : name,
...
class OpenRecentAction extends BaseOpenRecentAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2998, "Open Recent...")),
                mnemonicTitle: ( localize(2999, "&&More..."))
            },
            category: Categories.File,
            f1: true,
            precondition: ( ContextKeyExpr.and(( IsSessionsWindowContext.negate()), ( IsSandboxWorkspaceContext.toNegated()))),
            keybinding: {
...
class QuickPickRecentAction extends BaseOpenRecentAction {
    constructor() {
        super({
            ...
            title: ( localize2(3000, "Quick Open Recent...")),
            category: Categories.File,
            f1: false
        });
    }
...
class ToggleFullScreenAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3001, "Toggle Full Screen")),
                mnemonicTitle: ( localize(3002, "&&Full Screen"))
            },
...
class ReloadWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3003, "Reload Window")),
...
class ShowAboutDialogAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3004, "About")),
                mnemonicTitle: ( localize(3005, "&&About"))
            },
...
class NewWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3006, "New Window")),
                mnemonicTitle: ( localize(3007, "New &&Window"))
            },
            f1: true,
            precondition: ( ContextKeyExpr.and(( IsSessionsWindowContext.negate()), ( IsSandboxWorkspaceContext.toNegated()))),
            keybinding: {
            ...
            menu: {
                ...
                group: "1_new",
                order: 3,
                when: ( ContextKeyExpr.and(( IsSessionsWindowContext.negate()), ( IsSandboxWorkspaceContext.toNegated())))
            }
        });
    }
    run(accessor) {
...
class BlurAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3008, "Remove keyboard focus from focused element"))
        });
    }
    run() {
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(3009, "Confirm Before Close")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    title: ( localize(3010, "Open &&Recent")),
