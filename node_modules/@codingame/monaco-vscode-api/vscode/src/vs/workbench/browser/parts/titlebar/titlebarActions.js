...
registerAction2(class ToggleCommandCenter extends ToggleTitleBarConfigAction {
    constructor() {
        super(LayoutSettings.COMMAND_CENTER, ( localize(3748, "Command Center")), ( localize(3749, "Toggle visibility of the Command Center in title bar")), 1, ( IsCompactTitleBarContext.toNegated()));
    }
});
registerAction2(class ToggleNavigationControl extends ToggleTitleBarConfigAction {
    constructor() {
        super("workbench.navigationControl.enabled", ( localize(3750, "Navigation Controls")), ( localize(3751, "Toggle visibility of the Navigation Controls in title bar")), 2, ( ContextKeyExpr.and(( IsCompactTitleBarContext.toNegated()), ( ContextKeyExpr.has(`config.${LayoutSettings.COMMAND_CENTER}`)))));
    }
});
registerAction2(class ToggleLayoutControl extends ToggleTitleBarConfigAction {
    constructor() {
        super(LayoutSettings.LAYOUT_ACTIONS, ( localize(3752, "Layout Controls")), ( localize(3753, "Toggle visibility of the Layout Controls in title bar")), 4);
    }
});
registerAction2(class ToggleNotificationsButton extends ToggleTitleBarConfigAction {
    constructor() {
        super(NotificationsSettings.NOTIFICATIONS_BUTTON, ( localize(3754, "Notifications")), ( localize(3755, "Toggle visibility of the Notifications button in title bar")), 5, ( ContextKeyExpr.equals(
...
registerAction2(class ToggleCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3756, "Hide Custom Title Bar")),
            menu: [{
                id: MenuId.TitleBarContext,
                order: 0,
...
registerAction2(class ToggleCustomTitleBarWindowed extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3757, "Hide Custom Title Bar In Full Screen")),
            menu: [{
                id: MenuId.TitleBarContext,
                order: 1,
...
class ToggleCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3758, "Custom Title Bar")),
...
registerAction2(class ShowCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3759, "Show Custom Title Bar")),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3760, "Hide Custom Title Bar")),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3761, "Hide Custom Title Bar In Full Screen")),
...
registerAction2(class ToggleEditorActions extends Action2 {
    ...
    constructor() {
        ...
        super({
            ...
            title: ( localize(3762, "Editor Actions")),
...
const ACCOUNTS_ACTIVITY_TILE_ACTION = {
    ...
    label: ( localize(3763, "Accounts")),
    tooltip: ( localize(3763, "Accounts")),
    class: undefined,
    enabled: true,
    run: function() {}
};
const GLOBAL_ACTIVITY_TITLE_ACTION = {
    ...
    label: ( localize(3764, "Manage")),
    tooltip: ( localize(3764, "Manage")),
    class: undefined,
    enabled: true,
    run: function() {}
};
