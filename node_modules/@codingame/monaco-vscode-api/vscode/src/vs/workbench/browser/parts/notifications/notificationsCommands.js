...
function registerNotificationCommands(center, toasts, model) {
    ...
    CommandsRegistry.registerCommand(TOGGLE_DO_NOT_DISTURB_MODE_BY_SOURCE, accessor => {
        ...
        picker.placeholder = ( localize(3629, "Select sources to enable all notifications from"));
    ...
    const category = ( localize2(3630, "Notifications"));
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: SHOW_NOTIFICATIONS_CENTER,
            title: ( localize2(3631, "Show Notifications")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: HIDE_NOTIFICATIONS_CENTER,
            title: ( localize2(3632, "Hide Notifications")),
            category
        },
        when: NotificationsCenterVisibleContext
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3633, "Clear All Notifications")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: ACCEPT_PRIMARY_ACTION_NOTIFICATION,
            title: ( localize2(3634, "Accept Notification Primary Action")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3635, "Toggle Do Not Disturb Mode")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3636, "Toggle Do Not Disturb Mode By Source...")),
            category
        }
    });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            ...
            title: ( localize2(3637, "Focus Notification Toast")),
            category
        },
        when: NotificationsToastsVisibleContext
    });
    MenuRegistry.appendMenuItem(MenuId.TitleBar, {
        command: {
            ...
            title: ( localize(3638, "Toggle Notifications")),
            icon: Codicon.bell
        },
        group: "navigation",
        order: 10000,
...
registerAction2(class SetNotificationsPositionBottomRight extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3639, "Bottom Right")),
...
registerAction2(class SetNotificationsPositionBottomLeft extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3640, "Bottom Left")),
            toggled: ( ContextKeyExpr.equals(
                `config.${NotificationsSettings.NOTIFICATIONS_POSITION}`,
...
registerAction2(class SetNotificationsPositionTopRight extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3641, "Top Right")),
            toggled: ( ContextKeyExpr.equals(
                `config.${NotificationsSettings.NOTIFICATIONS_POSITION}`,
                NotificationsPosition.TOP_RIGHT
            )),
