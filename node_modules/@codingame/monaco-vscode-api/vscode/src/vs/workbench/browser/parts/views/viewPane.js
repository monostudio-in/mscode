...
const viewPaneContainerExpandedIcon = registerIcon("view-pane-container-expanded", Codicon.chevronDown, ( localize(3782, "Icon for an expanded view pane container.")));
const viewPaneContainerCollapsedIcon = registerIcon("view-pane-container-collapsed", Codicon.chevronRight, ( localize(3783, "Icon for a collapsed view pane container.")));
...
let ViewWelcomeController = class ViewWelcomeController {
    ...
    onDidChangeViewWelcomeState() {
        ...
        this.element = $(".welcome-view-content", {
            tabIndex: 0,
            role: "region",
            "aria-label": ( localize(3784, "Welcome"))
        });
        if (this._wide) {
...
let ViewPane = class ViewPane extends Pane {
    ...
    renderHeader(container) {
        ...
        this.toolbar = this.instantiationService.createInstance(WorkbenchToolBar, actions, {
            ...
            ariaLabel: ( localize(3785, "{0} actions", this.title)),
    ...
    _getAriaLabel(title, description) {
        ...
        return localize(3786, "Use Alt+F1 for accessibility help {0}", title);
    }
    updateTitle(title) {
        const calculatedTitle = this.calculateTitle(title);
