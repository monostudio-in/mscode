...
ViewMenuActions = ( __decorate([( __param(3, IContextKeyService)), ( __param(4, IMenuService))], ViewMenuActions));
let ViewContainerMenuActions = class ViewContainerMenuActions extends ViewMenuActions {
    constructor(
        ...
        }, scopedContextKeyService, menuService);
...
ViewContainerMenuActions = ( __decorate([( __param(2, IViewDescriptorService)), ( __param(3, IContextKeyService)), ( __param(4, IMenuService))], ViewContainerMenuActions));
