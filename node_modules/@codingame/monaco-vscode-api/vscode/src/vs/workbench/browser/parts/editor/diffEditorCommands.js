...
function registerDiffEditorCommands() {
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: DIFF_OPEN_SIDE,
            title: ( localize2(3169, "Open Active Diff Side"))
        }
    });
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        id: GOTO_NEXT_CHANGE,
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: GOTO_NEXT_CHANGE,
            title: ( localize2(3170, "Go to Next Change"))
        }
    });
    KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: GOTO_PREVIOUS_CHANGE,
            title: ( localize2(3171, "Go to Previous Change"))
        }
    });
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: TOGGLE_DIFF_SIDE_BY_SIDE,
            title: ( localize2(3172, "Toggle Inline View")),
            category: ( localize(3173, "Compare"))
        },
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: DIFF_SWAP_SIDES,
            title: ( localize2(3174, "Swap Left and Right Editor Side")),
            category: ( localize(3173, "Compare"))
        },
