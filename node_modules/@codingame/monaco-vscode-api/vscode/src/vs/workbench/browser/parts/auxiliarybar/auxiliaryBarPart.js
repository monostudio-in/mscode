...
let AuxiliaryBarPart = class AuxiliaryBarPart extends AbstractPaneCompositePart {
    ...
    fillExtraContextMenuActions(actions) {
        ...
        const toggleShowLabelsAction = toAction({
            ...
            label: this.configuration.showLabels ? ( localize(3083, "Show Icons")) : ( localize(3084, "Show Labels")),
        ...
        actions.push(...[( new Separator()), ( new SubmenuAction("workbench.action.panel.position", ( localize(3085, "Activity Bar Position")), positionActions)), toAction({
            id: ToggleSidebarPositionAction.ID,
            label: currentPositionRight ? ( localize(3086, "Move Secondary Side Bar Left")) : ( localize(3087, "Move Secondary Side Bar Right")),
            run: () => this.commandService.executeCommand(ToggleSidebarPositionAction.ID)
        }), toggleShowLabelsAction, toAction({
            id: ToggleAuxiliaryBarAction.ID,
            label: ( localize(3088, "Hide Secondary Side Bar")),
