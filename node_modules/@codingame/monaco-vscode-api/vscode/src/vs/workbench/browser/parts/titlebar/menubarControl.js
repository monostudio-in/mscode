...
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: "File",
        original: "File",
        mnemonicTitle: ( localize(3730, "&&File"))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: "Edit",
        original: "Edit",
        mnemonicTitle: ( localize(3731, "&&Edit"))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: "Selection",
        original: "Selection",
        mnemonicTitle: ( localize(3732, "&&Selection"))
    },
    order: 3
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: "View",
        original: "View",
        mnemonicTitle: ( localize(3733, "&&View"))
    },
    order: 4
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: "Go",
        original: "Go",
        mnemonicTitle: ( localize(3734, "&&Go"))
    },
    order: 5
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: "Terminal",
        original: "Terminal",
        mnemonicTitle: ( localize(3735, "&&Terminal"))
    },
    order: 7
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: "Help",
        original: "Help",
        mnemonicTitle: ( localize(3736, "&&Help"))
    },
    order: 8
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        ...
        mnemonicTitle: ( localize(3737, "Preferences"))
    },
...
class MenubarControl extends Disposable {
    ...
    notifyUserOfCustomMenubarAccessibility() {
        ...
        this.notificationService.prompt(Severity$1.Info, message, [{
            label: ( localize(3739, "Open Settings")),
            run: () => {
        ...
        registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localize2(3740, "Focus Application Menu")),
                    keybinding: {
...
let CustomMenubarControl = class CustomMenubarControl extends MenubarControl {
    ...
    getUpdateAction() {
        ...
        case StateType.Idle:
            return toAction({
                id: "update.check",
                label: ( localize(3741, "Check for &&Updates...")),
                enabled: true,
        ...
        case StateType.CheckingForUpdates:
            return toAction({
                id: "update.checking",
                label: ( localize(3742, "Checking for Updates...")),
                enabled: false,
                run: () => {}
            });
        case StateType.AvailableForDownload:
            return toAction({
                ...
                label: ( localize(3743, "D&&ownload Update")),
                enabled: true,
        ...
        case StateType.Overwriting:
            return toAction({
                ...
                label: ( localize(3744, "Downloading Update...")),
                enabled: false,
                run: () => {}
            });
        case StateType.Downloaded:
            return isMacintosh ? null : toAction({
                id: "update.install",
                label: ( localize(3745, "Install &&Update...")),
                enabled: true,
        ...
        case StateType.Updating:
            return toAction({
                id: "update.updating",
                label: ( localize(3746, "Installing Update...")),
                enabled: false,
                run: () => {}
            });
        case StateType.Ready:
            return toAction({
                id: "update.restart",
                label: ( localize(3747, "Restart to &&Update")),
                enabled: true,
