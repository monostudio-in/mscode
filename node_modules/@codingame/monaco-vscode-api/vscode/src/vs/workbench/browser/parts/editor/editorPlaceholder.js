...
let WorkspaceTrustRequiredPlaceholderEditor = class WorkspaceTrustRequiredPlaceholderEditor extends EditorPlaceholder {
    ...
    static {
        this.LABEL = ( localize(3495, "Workspace Trust Required"));
    }
    static {
    ...
    async getContents() {
        return {
            ...
            actions: [{
                label: ( localize(3498, "Manage Workspace Trust")),
...
let ErrorPlaceholderEditor = class ErrorPlaceholderEditor extends EditorPlaceholder {
    ...
    static {
        this.LABEL = ( localize(3499, "Error Editor"));
    }
    static {
        this.DESCRIPTOR = EditorPaneDescriptor.create(this, this.ID, this.LABEL);
    }
    ...
    async getContents(input, options, disposables) {
        ...
        let label;
        if (isFileNotFound) {
            label = ( localize(3500, "The editor could not be opened because the file was not found."));
            ...
            label = ( localize(3502, "The editor could not be opened due to an unexpected error."));
        }
        let icon = "$(error)";
        ...
        if (isEditorOpenError(error) && error.actions.length > 0) {
            ...
            actions = [{
                label: ( localize(3503, "Try Again")),
                run: () => this.group.openEditor(input, {
                    ...options,
                    source: EditorOpenSource.USER
                })
            }, {
                label: ( localize(3504, "Show Logs")),
