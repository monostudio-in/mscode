...
let PanelPart = class PanelPart extends AbstractPaneCompositePart {
    ...
    fillExtraContextMenuActions(actions) {
        ...
        const toggleShowLabelsAction = toAction({
            ...
            label: panelShowLabels ? ( localize(3712, "Show Icons")) : ( localize(3713, "Show Labels")),
            run: () => this.configurationService.updateValue("workbench.panel.showLabels", !panelShowLabels)
        });
        actions.push(...[( new Separator()), ( new SubmenuAction("workbench.action.panel.position", ( localize(3714, "Panel Position")), positionActions)), ( new SubmenuAction("workbench.action.panel.align", ( localize(3715, "Align Panel")), alignActions)), toggleShowLabelsAction, toAction({
            id: TogglePanelAction.ID,
            label: ( localize(3716, "Hide Panel")),
