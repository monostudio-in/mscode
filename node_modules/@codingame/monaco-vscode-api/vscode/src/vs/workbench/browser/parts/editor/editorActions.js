...
class SplitEditorAction extends AbstractSplitEditorAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3310, "Split Editor")),
            f1: true,
            keybinding: {
...
class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3311, "Split Editor Orthogonal")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorLeftAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3312, "Split Editor Left")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorRightAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3313, "Split Editor Right")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorUpAction extends ExecuteCommandAction {
    static {
        this.LABEL = ( localize(3314, "Split Editor Up"));
    }
    constructor() {
        super({
            id: SPLIT_EDITOR_UP,
            title: ( localize2(3314, "Split Editor Up")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorDownAction extends ExecuteCommandAction {
    static {
        this.LABEL = ( localize(3315, "Split Editor Down"));
    }
    constructor() {
        super({
            id: SPLIT_EDITOR_DOWN,
            title: ( localize2(3315, "Split Editor Down")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class JoinTwoGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3316, "Join Editor Group with Next Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class JoinAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3317, "Join All Editor Groups")),
            f1: true,
            category: Categories.View
        });
    }
...
class NavigateBetweenGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3318, "Navigate Between Editor Groups")),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusActiveGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3319, "Focus Active Editor Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusFirstGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3320, "Focus First Editor Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusLastGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3321, "Focus Last Editor Group")),
            f1: true,
            category: Categories.View
        }, {
...
class FocusNextGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3322, "Focus Next Editor Group")),
            f1: true,
            category: Categories.View
        }, {
            location: GroupLocation.NEXT
...
class FocusPreviousGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3323, "Focus Previous Editor Group")),
            f1: true,
            category: Categories.View
        }, {
...
class FocusLeftGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3324, "Focus Left Editor Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusRightGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3325, "Focus Right Editor Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusAboveGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3326, "Focus Editor Group Above")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusBelowGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3327, "Focus Editor Group Below")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
let CloseEditorAction = class CloseEditorAction extends Action {
    ...
    static {
        this.LABEL = ( localize(3328, "Close Editor"));
    }
...
let UnpinEditorAction = class UnpinEditorAction extends Action {
    ...
    static {
        this.LABEL = ( localize(3329, "Unpin Editor"));
    }
    constructor(id, label, commandService) {
...
let CloseEditorTabAction = class CloseEditorTabAction extends Action {
    ...
    static {
        this.LABEL = ( localize(3330, "Close"));
    }
...
class RevertAndCloseEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3331, "Revert and Close Editor")),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseLeftEditorsInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3332, "Close Editors to the Left in Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class AbstractCloseAllAction extends Action2 {
    ...
    revertEditors(editorService, logService, progressService, editors) {
        return progressService.withProgress({
            ...
            delay: 800,
            title: ( localize(3333, "Reverting Editors..."))
...
class CloseAllEditorsAction extends AbstractCloseAllAction {
    ...
    static {
        this.LABEL = ( localize2(3334, "Close All Editors"));
    }
    constructor() {
        super({
...
class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
    constructor() {
        super({
            ...
            title: ( localize2(3335, "Close All Editor Groups")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(
...
class CloseEditorsInOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3336, "Close Editors in Other Groups")),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseEditorInAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3337, "Close Editor in All Groups")),
            f1: true,
            category: Categories.View
        });
    }
...
class MoveGroupLeftAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3338, "Move Editor Group Left")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupRightAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3339, "Move Editor Group Right")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupUpAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3340, "Move Editor Group Up")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupDownAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3341, "Move Editor Group Down")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3342, "Duplicate Editor Group Left")),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3343, "Duplicate Editor Group Right")),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3344, "Duplicate Editor Group Up")),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3345, "Duplicate Editor Group Down")),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class MinimizeOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3346, "Expand Editor Group")),
            f1: true,
            category: Categories.View,
...
class MinimizeOtherGroupsHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3347, "Expand Editor Group and Hide Side Bars")),
            f1: true,
            category: Categories.View,
...
class ResetGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3348, "Reset Editor Group Sizes")),
            f1: true,
            category: Categories.View
        });
    }
...
class ToggleGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3349, "Toggle Editor Group Sizes")),
            f1: true,
            category: Categories.View
        });
    }
...
class MaximizeGroupHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3350, "Maximize Editor Group and Hide Side Bars")),
            f1: true,
            category: Categories.View,
...
class ToggleMaximizeEditorGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3351, "Toggle Maximize Editor Group")),
            f1: true,
            category: Categories.View,
            precondition: ( ContextKeyExpr.or(
            ...
            toggled: {
                ...
                title: ( localize(3352, "Unmaximize Group"))
            }
        });
    }
    async run(accessor, ...args) {
...
class OpenNextEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3353, "Open Next Editor")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenPreviousEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3354, "Open Previous Editor")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3355, "Open Next Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3356, "Open Previous Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3357, "Open First Editor in Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3358, "Open Last Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(3359, "Go Forward"));
    }
    constructor() {
        super({
            id: NavigateForwardAction.ID,
            title: {
                ...( localize2(3359, "Go Forward")),
                mnemonicTitle: ( localize(3360, "&&Forward"))
            },
            f1: true,
...
class NavigateBackwardsAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(3361, "Go Back"));
    }
    constructor() {
        super({
            id: NavigateBackwardsAction.ID,
            title: {
                ...( localize2(3361, "Go Back")),
                mnemonicTitle: ( localize(3362, "&&Back"))
            },
            f1: true,
...
class NavigatePreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3363, "Go Previous")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateForwardInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3364, "Go Forward in Edit Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3365, "Go Back in Edit Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3366, "Go Previous in Edit Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastEditLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3367, "Go to Last Edit Location")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3368, "Go Forward in Navigation Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3369, "Go Back in Navigation Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3370, "Go Previous in Navigation Locations")),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastNavigationLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3371, "Go to Last Navigation Location")),
            f1: true
        });
    }
    async run(accessor) {
...
class ReopenClosedEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3372, "Reopen Closed Editor")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ClearRecentFilesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3373, "Clear Recently Opened...")),
            f1: true,
    ...
    async run(accessor) {
        ...
        const {
            ...
            type: "warning",
            message: ( localize(3374, "Do you want to clear all recently opened files and workspaces?")),
            detail: ( localize(3375, "This action is irreversible!")),
            primaryButton: ( localize(3376, "&&Clear"))
        });
        if (!confirmed) {
            return;
        }
...
class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3377, "Show Editors in Active Group By Most Recently Used")),
            f1: true,
            category: Categories.View
        });
    }
...
class ShowAllEditorsByAppearanceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3378, "Show All Editors By Appearance")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3379, "Show All Editors By Most Recently Used")),
            f1: true,
            category: Categories.View
        });
    }
...
class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3380, "Quick Open Previous Recently Used Editor")),
            f1: true,
            category: Categories.View
...
class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3381, "Quick Open Least Recently Used Editor")),
            f1: true,
            category: Categories.View
        }, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
    }
...
class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3382, "Quick Open Previous Recently Used Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3383, "Quick Open Least Recently Used Editor in Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3384, "Quick Open Previous Editor from History")),
            f1: true
        });
    }
    async run(accessor) {
...
class OpenNextRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3385, "Open Next Recently Used Editor")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3386, "Open Previous Recently Used Editor")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3387, "Open Next Recently Used Editor In Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3388, "Open Previous Recently Used Editor In Group")),
            f1: true,
            category: Categories.View
        });
    }
...
class ClearEditorHistoryWithoutConfirmAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3389, "Clear Editor History without Confirmation")),
            f1: true,
...
class ClearEditorHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3390, "Clear Editor History")),
            f1: true
        });
    }
    async run(accessor) {
        ...
        const {
            ...
            type: "warning",
            message: ( localize(3391, "Do you want to clear the history of recently opened editors?")),
            detail: ( localize(3375, "This action is irreversible!")),
            primaryButton: ( localize(3376, "&&Clear"))
        });
        if (!confirmed) {
...
class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3392, "Move Editor Left")),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorRightInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3393, "Move Editor Right")),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorToStartAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3394, "Move Editor to Start")),
            f1: true,
            category: Categories.View
        }, MOVE_ACTIVE_EDITOR_COMMAND_ID, {
            to: "first"
...
class MoveEditorToEndAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3395, "Move Editor to End")),
            f1: true,
            category: Categories.View
        }, MOVE_ACTIVE_EDITOR_COMMAND_ID, {
            to: "last"
...
class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3396, "Move Editor into Previous Group")),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.LeftArrow,
                mac: {
...
class MoveEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3397, "Move Editor into Next Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.RightArrow,
...
class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3398, "Move Editor into Group Above")),
            f1: true,
            category: Categories.View
...
class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3399, "Move Editor into Group Below")),
            f1: true,
            category: Categories.View
...
class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3400, "Move Editor into Left Group")),
            f1: true,
            category: Categories.View
...
class MoveEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3401, "Move Editor into Right Group")),
            f1: true,
            category: Categories.View
...
class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3402, "Move Editor into First Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3403, "Move Editor into Last Group")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3404, "Split Editor into Previous Group")),
            f1: true,
            category: Categories.View
...
class SplitEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3405, "Split Editor into Next Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "next",
...
class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3406, "Split Editor into Group Above")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "up",
...
class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3407, "Split Editor into Group Below")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "down",
...
class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
    ...
    static {
        this.LABEL = ( localize(3408, "Split Editor into Left Group"));
    }
    constructor() {
        super({
            id: "workbench.action.splitEditorToLeftGroup",
            title: ( localize2(3408, "Split Editor into Left Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "left",
...
class SplitEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3409, "Split Editor into Right Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "right",
...
class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3410, "Split Editor into First Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "first",
...
class SplitEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3411, "Split Editor into Last Group")),
            f1: true,
            category: Categories.View
        }, COPY_ACTIVE_EDITOR_COMMAND_ID, {
            to: "last",
...
class EditorLayoutSingleAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3412, "Single Column Editor Layout")),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3413, "Two Columns Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}],
...
class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3414, "Three Columns Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}, {}],
...
class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3415, "Two Rows Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}],
...
class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3416, "Three Rows Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {}, {}],
...
class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3417, "Grid Editor Layout (2x2)")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{
...
class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3418, "Two Columns Bottom Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {
...
class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3419, "Two Rows Right Editor Layout")),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, {
            groups: [{}, {
...
class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3420, "New Editor Group to the Left")),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3421, "New Editor Group to the Right")),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3422, "New Editor Group Above")),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3423, "New Editor Group Below")),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class ToggleEditorTypeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3424, "Toggle Editor Type")),
            f1: true,
            category: Categories.View,
...
class ReOpenInTextEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3425, "Reopen Editor with Text Editor")),
            f1: true,
            category: Categories.View,
            precondition: ActiveEditorAvailableEditorIdsContext
        });
...
class MoveEditorToNewWindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3426, "Move Editor into New Window")),
            mnemonicTitle: ( localize(3427, "&&Move Editor into New Window"))
        }, undefined, true);
    }
}
class CopyEditorToNewindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3428, "Copy Editor into New Window")),
            mnemonicTitle: ( localize(3429, "&&Copy Editor into New Window"))
        }, {
...
class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3430, "Move Editor Group into New Window")),
            mnemonicTitle: ( localize(3431, "&&Move Editor Group into New Window"))
        }, true);
    }
}
class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3432, "Copy Editor Group into New Window")),
            mnemonicTitle: ( localize(3433, "&&Copy Editor Group into New Window"))
        }, false);
    }
}
class RestoreEditorsToMainWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3434, "Restore Editors into Main Window")),
                mnemonicTitle: ( localize(3435, "&&Restore Editors into Main Window"))
            },
            f1: true,
...
class NewEmptyEditorWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3436, "New Empty Editor Window")),
                mnemonicTitle: ( localize(3437, "&&New Empty Editor Window"))
            },
            f1: true,
            category: Categories.View
        });
