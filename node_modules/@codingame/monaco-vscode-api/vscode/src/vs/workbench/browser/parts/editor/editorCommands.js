...
function registerEditorMoveCopyCommand() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3438, "Move the active editor by tabs or groups")),
            args: [{
                name: ( localize(3439, "Active editor move argument")),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3441, "Copy the active editor by groups")),
            args: [{
                name: ( localize(3442, "Active editor copy argument")),
                description: ( localize(
                    3443,
                ...
                schema: {
                    ...
                    "properties": {
                        "orientation": {
                            ...
                            "enum": [0, 1],
                            "enumDescriptions": [( localize(3444, "Horizontal")), ( localize(3445, "Vertical"))]
                        },
                        "groups": {
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3446, "Split Editor in Group")),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3447, "Join Editor in Group")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3448, "Toggle Split Editor in Group")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3449, "Toggle Layout of Split Editor in Group")),
                category: Categories.View,
                precondition: SideBySideEditorActiveContext,
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3450, "Focus First Side in Active Editor")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3451, "Focus Second Side in Active Editor")),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3452, "Focus Other Side in Active Editor")),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3453, "Toggle Editor Group Lock")),
                category: Categories.View,
                f1: true
            });
        }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3454, "Lock Editor Group")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3455, "Unlock Editor Group")),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3456, "Open Modal Editor in Main Window")),
                category: Categories.View,
                f1: true,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3457, "Open Modal Editor in New Window")),
                category: Categories.View,
                f1: true,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3458, "Toggle Modal Editor Sidebar")),
                category: Categories.View,
                f1: true,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3459, "Maximize Modal Editor")),
                category: Categories.View,
                f1: true,
                precondition: EditorPartModalContext,
                ...
                toggled: {
                    ...
                    title: ( localize(3460, "Restore Modal Editor"))
                },
                menu: {
                    id: MenuId.ModalEditorTitle,
                    group: "navigation",
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3461, "Close Modal Editor")),
                category: Categories.View,
                f1: true,
                icon: Codicon.close,
                precondition: EditorPartModalContext,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3462, "Navigate to Previous Item in Modal Editor")),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3463, "Navigate to Next Item in Modal Editor")),
                category: Categories.View,
                precondition: ( ContextKeyExpr.and(EditorPartModalContext, EditorPartModalNavigationContext)),
                keybinding: {
