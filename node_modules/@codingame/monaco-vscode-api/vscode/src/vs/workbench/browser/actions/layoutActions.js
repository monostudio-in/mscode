...
const menubarIcon = registerIcon("menuBar", Codicon.layoutMenubar, ( localize(2828, "Represents the menu bar")));
const activityBarLeftIcon = registerIcon("activity-bar-left", Codicon.layoutActivitybarLeft, ( localize(2829, "Represents the activity bar in the left position")));
const activityBarRightIcon = registerIcon("activity-bar-right", Codicon.layoutActivitybarRight, ( localize(2830, "Represents the activity bar in the right position")));
const panelLeftIcon = registerIcon("panel-left", Codicon.layoutSidebarLeft, ( localize(2831, "Represents a side bar in the left position")));
const panelLeftOffIcon = registerIcon("panel-left-off", Codicon.layoutSidebarLeftOff, ( localize(2832, "Represents a side bar in the left position toggled off")));
const panelRightIcon = registerIcon("panel-right", Codicon.layoutSidebarRight, ( localize(2833, "Represents side bar in the right position")));
const panelRightOffIcon = registerIcon("panel-right-off", Codicon.layoutSidebarRightOff, ( localize(2834, "Represents side bar in the right position toggled off")));
const panelIcon = registerIcon("panel-bottom", Codicon.layoutPanel, ( localize(2835, "Represents the bottom panel")));
const statusBarIcon = registerIcon("statusBar", Codicon.layoutStatusbar, ( localize(2836, "Represents the status bar")));
const panelAlignmentLeftIcon = registerIcon("panel-align-left", Codicon.layoutPanelLeft, ( localize(2837, "Represents the bottom panel alignment set to the left")));
const panelAlignmentRightIcon = registerIcon("panel-align-right", Codicon.layoutPanelRight, ( localize(2838, "Represents the bottom panel alignment set to the right")));
const panelAlignmentCenterIcon = registerIcon("panel-align-center", Codicon.layoutPanelCenter, ( localize(2839, "Represents the bottom panel alignment set to the center")));
const panelAlignmentJustifyIcon = registerIcon("panel-align-justify", Codicon.layoutPanelJustify, ( localize(2840, "Represents the bottom panel alignment set to justified")));
const quickInputAlignmentTopIcon = registerIcon("quickInputAlignmentTop", Codicon.arrowUp, ( localize(2841, "Represents quick input alignment set to the top")));
const quickInputAlignmentCenterIcon = registerIcon("quickInputAlignmentCenter", Codicon.circle, ( localize(2842, "Represents quick input alignment set to the center")));
const fullscreenIcon = registerIcon("fullscreen", Codicon.screenFull, ( localize(2843, "Represents full screen")));
const centerLayoutIcon = registerIcon("centerLayoutIcon", Codicon.layoutCentered, ( localize(2844, "Represents centered layout mode")));
const zenModeIcon = registerIcon("zenMode", Codicon.target, ( localize(2845, "Represents zen mode")));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2846, "Toggle Centered Layout")),
                mnemonicTitle: ( localize(2847, "&&Centered Layout"))
            },
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, ( localize2(2848, "Move Primary Side Bar Right")), Position.RIGHT);
    }
}
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarLeftAction.ID, ( localize2(2849, "Move Primary Side Bar Left")), Position.LEFT);
    }
}
...
class ToggleSidebarPositionAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(2850, "Toggle Primary Side Bar Position"));
    }
    static getLabel(layoutService) {
        return layoutService.getSideBarPosition() === Position.LEFT ? ( localize(2848, "Move Primary Side Bar Right")) : ( localize(2849, "Move Primary Side Bar Left"));
    }
    constructor() {
        super({
            id: ToggleSidebarPositionAction.ID,
            title: ( localize2(2850, "Toggle Primary Side Bar Position")),
            category: Categories.View,
            f1: true,
...
const configureLayoutIcon = registerIcon("configure-layout-icon", Codicon.layout, ( localize(2851, "Icon represents workbench layout configuration.")));
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
    submenu: MenuId.LayoutControlMenuSubmenu,
    title: ( localize(2852, "Configure Layout")),
...
MenuRegistry.appendMenuItems([{
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(2853, "Move Primary Side Bar Right"))
        },
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(2854, "Move Primary Side Bar Left"))
        },
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(2855, "Move Secondary Side Bar Left"))
        },
        when: ( ContextKeyExpr.and(( ContextKeyExpr.notEquals("config.workbench.sideBar.location", "right")), ( ContextKeyExpr.equals(
            "viewContainerLocation",
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarPositionAction.ID,
            title: ( localize(2856, "Move Secondary Side Bar Right"))
        },
        when: ( ContextKeyExpr.and(( ContextKeyExpr.equals("config.workbench.sideBar.location", "right")), ( ContextKeyExpr.equals(
            "viewContainerLocation",
            ViewContainerLocationToString(ViewContainerLocation.AuxiliaryBar)
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(2857, "&&Move Primary Side Bar Right"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(2858, "&&Move Primary Side Bar Left"))
    },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2859, "Toggle Editor Area Visibility")),
                mnemonicTitle: ( localize(2860, "Show &&Editor Area"))
            },
            category: Categories.View,
            f1: true,
...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    group: "2_appearance",
    title: ( localize(2861, "&&Appearance")),
...
class ToggleSidebarVisibilityAction extends Action2 {
    ...
    static {
        this.LABEL = ( localize(2862, "Hide Primary Side Bar"));
    }
    constructor() {
        super({
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize2(2863, "Toggle Primary Side Bar Visibility")),
            toggled: {
                condition: SideBarVisibleContext,
                title: ( localize(2864, "Primary Side Bar")),
                mnemonicTitle: ( localize(2865, "&&Primary Side Bar"))
            },
            metadata: {
                description: ( localize(2866, "Open/Show and Close/Hide Sidebar"))
            },
            category: Categories.View,
            f1: true,
            keybinding: {
    ...
    run(accessor) {
        ...
        const alertMessage = isCurrentlyVisible ? ( localize(2867, "Primary Side Bar hidden")) : ( localize(2868, "Primary Side Bar shown"));
        alert(alertMessage);
    }
}
...
MenuRegistry.appendMenuItems([{
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize(2862, "Hide Primary Side Bar"))
        },
    ...
    item: {
        ...
        command: {
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize(2869, "Toggle Primary Side Bar")),
...
class ToggleStatusbarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2870, "Toggle Status Bar Visibility")),
                mnemonicTitle: ( localize(2871, "S&&tatus Bar"))
            },
            category: Categories.View,
            f1: true,
            precondition: ( IsSessionsWindowContext.negate()),
...
class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2872, "Hide Editor Tabs"));
        super(
...
class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2874, "Hide Editor Tabs in Zen Mode"));
        super(
            ...
            precondition,
            ( localize2(2875, "Hide Tab Bar in Zen Mode"))
        );
    }
}
class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2876, "Show Multiple Editor Tabs"));
        super(
            LayoutSettings.EDITOR_TABS_MODE,
            ...
            precondition,
            ( localize2(2877, "Show Tab Bar with multiple tabs"))
        );
    }
}
class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2878, "Show Multiple Editor Tabs in Zen Mode"));
        super(
            ZenModeSettings.SHOW_TABS,
            EditorTabsMode.MULTIPLE,
            title,
            ...
            precondition,
            ( localize2(2879, "Show Tab Bar in Zen Mode"))
        );
    }
}
class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2880, "Show Single Editor Tab"));
        super(
            LayoutSettings.EDITOR_TABS_MODE,
            ...
            precondition,
            ( localize2(2881, "Show Tab Bar with one Tab"))
        );
    }
}
class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2882, "Show Single Editor Tab in Zen Mode"));
        super(
            ZenModeSettings.SHOW_TABS,
            EditorTabsMode.SINGLE,
            title,
            ...
            precondition,
            ( localize2(2883, "Show Tab Bar in Zen Mode with one Tab"))
        );
    }
}
...
class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2885, "Move Editor Actions to Title Bar")),
            category: Categories.View,
            ...
            metadata: {
                description: ( localize2(2886, "Move Editor Actions from the tab bar to the title bar"))
            },
            f1: true
        });
    }
...
class EditorActionsDefaultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2887, "Move Editor Actions to Tab Bar")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.and(( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
            ...
            metadata: {
                description: ( localize2(2888, "Move Editor Actions from the title bar to the tab bar"))
            },
            f1: true
        });
    }
...
class HideEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2889, "Hide Editor Actions")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.and(( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
            ...
            metadata: {
                description: ( localize2(2890, "Hide Editor Actions in the tab and title bar"))
            },
            f1: true
        });
    }
...
class ShowEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2891, "Show Editor Actions")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.and(( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            ...
            metadata: {
                description: ( localize2(2892, "Make Editor Actions visible."))
            },
            f1: true
        });
    }
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(2893, "Editor Actions Position")),
    group: "3_workbench_layout_move",
    order: 11,
    when: ( IsSessionsWindowContext.negate())
});
class ConfigureEditorTabsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2894, "Configure Tabs")),
            category: Categories.View
        });
    }
    run(accessor) {
...
class ConfigureEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2895, "Configure Editors")),
            category: Categories.View
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2896, "Separate Pinned Editor Tabs")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2898, "Toggle Zen Mode")),
                mnemonicTitle: ( localize(2899, "Zen Mode"))
            },
    ...
    registerAction2(class ToggleMenubarAction extends Action2 {
        constructor() {
            super({
                ...
                title: {
                    ...( localize2(2900, "Toggle Menu Bar")),
                    mnemonicTitle: ( localize(2901, "Menu &&Bar"))
                },
                category: Categories.View,
                f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2903, "Reset View Locations")),
            category: Categories.View,
            f1: true
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2904, "Move View")),
            category: Categories.View,
            f1: true
        });
    }
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: "separator",
                            label: ( localize(2905, "Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: "separator",
                            label: ( localize(2906, "Panel / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: "separator",
                            label: ( localize(2907, "Secondary Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
    ...
    async getView(quickInputService, viewDescriptorService, paneCompositePartService, viewId) {
        ...
        quickPick.placeholder = ( localize(2908, "Select a View to Move"));
...
class MoveFocusedViewAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2909, "Move Focused View")),
            category: Categories.View,
    ...
    run(accessor, viewId) {
        ...
        if (focusedViewId === undefined || focusedViewId.trim() === "") {
            dialogService.error(( localize(2910, "There is no view currently focused.")));
            return;
        }
        const viewDescriptor = viewDescriptorService.getViewDescriptorById(focusedViewId);
        if (!viewDescriptor?.canMoveView) {
            dialogService.error(( localize(2911, "The currently focused view is not movable.")));
            return;
        }
        const disposables = ( new DisposableStore());
        const quickPick = disposables.add(quickInputService.createQuickPick({
        ...
        quickPick.placeholder = ( localize(2912, "Select a Destination for the View"));
        quickPick.title = ( localize(2913, "View: Move {0}", viewDescriptor.name.value));
        const items = [];
        ...
        items.push({
            type: "separator",
            label: ( localize(2919, "Secondary Side Bar"))
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2920, "Reset Focused View Location")),
            category: Categories.View,
            f1: true,
            precondition: ( FocusedViewContext.notEqualsTo(""))
        });
    ...
    run(accessor) {
        ...
        if (!viewDescriptor) {
            dialogService.error(( localize(2921, "There is no view currently focused.")));
            return;
        }
...
class IncreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2922, "Increase Current View Size")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2923, "Increase Editor Width")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class IncreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2924, "Increase Editor Height")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2925, "Decrease Current View Size")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2926, "Decrease Editor Width")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2927, "Decrease Editor Height")),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
registerAction2(class AlignQuickInputTopAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2928, "Align Quick Input Top")),
            f1: false
        });
    }
    run(accessor) {
...
registerAction2(class AlignQuickInputCenterAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2929, "Align Quick Input Center")),
            f1: false
        });
    }
    run(accessor) {
...
const CreateToggleLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(2930, "Select to Hide")),
        inactiveAriaLabel: ( localize(2931, "Select to Show")),
        useButtons: true
    };
};
const CreateOptionLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(2932, "Active")),
        useButtons: false
    };
};
...
if (!isMacintosh || !isNative) {
    ToggleVisibilityActions.push(
        CreateToggleLayoutItem("workbench.action.toggleMenuBar", MenuBarToggledContext, ( localize(2933, "Menu Bar")), menubarIcon)
    );
}
ToggleVisibilityActions.push(
    ...[CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ( ContextKeyExpr.notEquals("config.workbench.activityBar.location", "hidden")), ( localize(2934, "Activity Bar")), {
        whenA: ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")),
        iconA: activityBarLeftIcon,
        iconB: activityBarRightIcon
    }), CreateToggleLayoutItem(ToggleSidebarVisibilityAction.ID, SideBarVisibleContext, ( localize(2935, "Primary Side Bar")), {
        whenA: ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")),
        iconA: panelLeftIcon,
        iconB: panelRightIcon
    }), CreateToggleLayoutItem(ToggleAuxiliaryBarAction.ID, AuxiliaryBarVisibleContext, ( localize(2919, "Secondary Side Bar")), {
        whenA: ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")),
        iconA: panelRightIcon,
        iconB: panelLeftIcon
    }), CreateToggleLayoutItem(TogglePanelAction.ID, PanelVisibleContext, ( localize(2918, "Panel")), panelIcon), CreateToggleLayoutItem(ToggleStatusbarVisibilityAction.ID, ( ContextKeyExpr.equals("config.workbench.statusBar.visible", true)), ( localize(2936, "Status Bar")), statusBarIcon)]
);
const MoveSideBarActions = [CreateOptionLayoutItem(MoveSidebarLeftAction.ID, ( ContextKeyExpr.equals("config.workbench.sideBar.location", "left")), ( localize(2937, "Left")), panelLeftIcon), CreateOptionLayoutItem(MoveSidebarRightAction.ID, ( ContextKeyExpr.equals("config.workbench.sideBar.location", "right")), ( localize(2938, "Right")), panelRightIcon)];
const AlignPanelActions = [CreateOptionLayoutItem("workbench.action.alignPanelLeft", ( PanelAlignmentContext.isEqualTo("left")), ( localize(2939, "Left")), panelAlignmentLeftIcon), CreateOptionLayoutItem("workbench.action.alignPanelRight", ( PanelAlignmentContext.isEqualTo("right")), ( localize(2940, "Right")), panelAlignmentRightIcon), CreateOptionLayoutItem("workbench.action.alignPanelCenter", ( PanelAlignmentContext.isEqualTo("center")), ( localize(2941, "Center")), panelAlignmentCenterIcon), CreateOptionLayoutItem("workbench.action.alignPanelJustify", ( PanelAlignmentContext.isEqualTo("justify")), ( localize(2942, "Justify")), panelAlignmentJustifyIcon)];
const QuickInputActions = [
    CreateOptionLayoutItem("workbench.action.alignQuickInputTop", ( QuickInputAlignmentContextKey.isEqualTo("top")), ( localize(2943, "Top")), quickInputAlignmentTopIcon),
    CreateOptionLayoutItem("workbench.action.alignQuickInputCenter", ( QuickInputAlignmentContextKey.isEqualTo("center")), ( localize(2944, "Center")), quickInputAlignmentCenterIcon)
];
const MiscLayoutOptions = [CreateOptionLayoutItem(
    "workbench.action.toggleFullScreen",
    IsMainWindowFullscreenContext,
    ( localize(2945, "Full Screen")),
    fullscreenIcon
), CreateOptionLayoutItem("workbench.action.toggleZenMode", InEditorZenModeContext, ( localize(2946, "Zen Mode")), zenModeIcon), CreateOptionLayoutItem(
    "workbench.action.toggleCenteredLayout",
    IsMainEditorCenteredLayoutContext,
    ( localize(2947, "Centered Layout")),
    centerLayoutIcon
)];
...
registerAction2(class CustomizeLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2948, "Customize Layout...")),
            f1: true,
            icon: configureLayoutIcon,
            menu: [{
                id: MenuId.LayoutControlMenuSubmenu,
    ...
    getItems(contextKeyService, keybindingService) {
        ...
        return [{
            type: "separator",
            label: ( localize(2949, "Visibility"))
        }, ...( ToggleVisibilityActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(2950, "Primary Side Bar Position"))
        }, ...( MoveSideBarActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(2951, "Panel Alignment"))
        }, ...( AlignPanelActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(2952, "Quick Input Position"))
        }, ...( QuickInputActions.map(toQuickPickItem)), {
            type: "separator",
            label: ( localize(2953, "Modes"))
    ...
    run(accessor) {
        ...
        quickPick.title = ( localize(2954, "Customize Layout"));
        const closeButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.close),
            tooltip: ( localize(2955, "Close"))
        };
        const resetButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.discard),
            tooltip: ( localize(2956, "Restore Defaults"))
        };
