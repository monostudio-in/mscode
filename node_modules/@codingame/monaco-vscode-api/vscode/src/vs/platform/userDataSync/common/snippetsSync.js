...
let SnippetsSynchroniser = class SnippetsSynchroniser extends AbstractSynchroniser {
    constructor(
        ...
        super({
            syncResource: SyncResource.Snippets,
            profile
        ...
        this._register(
            Event.filter(this.fileService.onDidFilesChange, e => e.affects(this.snippetsFolder))(() => this.triggerLocalChange())
        );
    }
...
SnippetsSynchroniser = ( __decorate([( __param(2, IEnvironmentService)), ( __param(3, IFileService)), ( __param(4, IStorageService)), ( __param(5, IUserDataSyncStoreService)), ( __param(6, IUserDataSyncLocalStoreService)), ( __param(7, IUserDataSyncLogService)), ( __param(8, IConfigurationService)), ( __param(9, IUserDataSyncEnablementService)), ( __param(10, ITelemetryService)), ( __param(11, IUriIdentityService))], SnippetsSynchroniser));
...
SnippetsInitializer = ( __decorate([( __param(0, IFileService)), ( __param(1, IUserDataProfilesService)), ( __param(2, IEnvironmentService)), ( __param(3, IUserDataSyncLogService)), ( __param(4, IStorageService)), ( __param(5, IUriIdentityService))], SnippetsInitializer));
