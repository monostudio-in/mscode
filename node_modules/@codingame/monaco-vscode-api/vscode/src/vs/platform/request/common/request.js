    ...
    proxyConfiguration = [{
        ...
        properties: {
            ...
            "http.proxySupport": {
                ...
                enumDescriptions: [( localize(2100, "Disable proxy support for extensions.")), ( localize(2101, "Enable proxy support for extensions.")), ( localize(
                    2102,
                    "Enable proxy support for extensions, fall back to request options, when no proxy found."
                )), ( localize(2103, "Enable proxy support for extensions, override request options."))],
                default: "override",
                markdownDescription: ( localize(
                    2104,
...
export { AbstractRequestService, NO_FETCH_TELEMETRY, USER_LOCAL_AND_REMOTE_SETTINGS, asJson, asText, asTextOrError, hasNoContent, isClientError, isServerError, isSuccess, systemCertificatesNodeDefault };
