...
import { layout2d, AnchorPosition, AnchorAlignment } from '../../../base/common/layout.js';
...
let QuickInputController = class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        const checkAll = this._register(( new TriStateCheckbox(( localize(2078, "Toggle all checkboxes")), false, {
        ...
        const visibleCount = this._register(( new CountBadge(visibleCountContainer, {
            countFormat: ( localize(2079, "{0} Results"))
        ...
        const count = this._register(( new CountBadge(countContainer, {
            countFormat: ( localize(2080, "{0} Selected"))
        }, this.styles.countBadge)));
        ...
        customButton.label = ( localize(2082, "Custom"));
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? ( localize(2083, "Back ({0})", backKeybindingLabel)) : ( localize(2084, "Back"));
    ...
    updateLayout() {
        if (this.ui && this.isVisible()) {
            ...
            if (this.controller?.anchor) {
                const container = this.layoutService.getContainer(getActiveWindow()).getBoundingClientRect();
