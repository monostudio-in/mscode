...
let QuickInputTreeController = class QuickInputTreeController extends Disposable {
    constructor(container, hoverDelegate, styles, instantiationService) {
        ...
        this._tree = this._register(
            this.instantiationService.createInstance(WorkbenchObjectTree, "QuickInputTree", this._container, ( new QuickInputTreeDelegate()), [this._renderer], {
...
QuickInputTreeController = ( __decorate([( __param(3, IInstantiationService))], QuickInputTreeController));
