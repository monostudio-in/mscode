...
class AccessibilitySignal {
    ...
    static {
        this.errorAtPosition = AccessibilitySignal.register({
            name: ( localize(1710, "Error at Position")),
            sound: Sound.error,
            announcementMessage: ( localize(1711, "Error")),
    ...
    static {
        this.warningAtPosition = AccessibilitySignal.register({
            name: ( localize(1712, "Warning at Position")),
            sound: Sound.warning,
            announcementMessage: ( localize(1713, "Warning")),
    ...
    static {
        this.errorOnLine = AccessibilitySignal.register({
            name: ( localize(1714, "Error on Line")),
            sound: Sound.error,
            legacySoundSettingsKey: "audioCues.lineHasError",
            legacyAnnouncementSettingsKey: "accessibility.alert.error",
            announcementMessage: ( localize(1715, "Error on Line")),
            settingsKey: "accessibility.signals.lineHasError"
        });
    }
    static {
        this.warningOnLine = AccessibilitySignal.register({
            name: ( localize(1716, "Warning on Line")),
            sound: Sound.warning,
            legacySoundSettingsKey: "audioCues.lineHasWarning",
            legacyAnnouncementSettingsKey: "accessibility.alert.warning",
            announcementMessage: ( localize(1717, "Warning on Line")),
            settingsKey: "accessibility.signals.lineHasWarning"
        });
    }
    static {
        this.foldedArea = AccessibilitySignal.register({
            name: ( localize(1718, "Folded Area on Line")),
            sound: Sound.foldedArea,
            legacySoundSettingsKey: "audioCues.lineHasFoldedArea",
            legacyAnnouncementSettingsKey: "accessibility.alert.foldedArea",
            announcementMessage: ( localize(1719, "Folded")),
            settingsKey: "accessibility.signals.lineHasFoldedArea"
        });
    }
    static {
        this.break = AccessibilitySignal.register({
            name: ( localize(1720, "Breakpoint on Line")),
            sound: Sound.break,
            legacySoundSettingsKey: "audioCues.lineHasBreakpoint",
            legacyAnnouncementSettingsKey: "accessibility.alert.breakpoint",
            announcementMessage: ( localize(1721, "Breakpoint")),
            settingsKey: "accessibility.signals.lineHasBreakpoint"
        });
    }
    static {
        this.inlineSuggestion = AccessibilitySignal.register({
            name: ( localize(1722, "Inline Suggestion on Line")),
    ...
    static {
        this.nextEditSuggestion = AccessibilitySignal.register({
            name: ( localize(1723, "Next Edit Suggestion on Line")),
            ...
            announcementMessage: ( localize(1724, "Next Edit Suggestion"))
        });
    }
    static {
        this.terminalQuickFix = AccessibilitySignal.register({
            name: ( localize(1725, "Terminal Quick Fix")),
            sound: Sound.quickFixes,
            legacySoundSettingsKey: "audioCues.terminalQuickFix",
            legacyAnnouncementSettingsKey: "accessibility.alert.terminalQuickFix",
            announcementMessage: ( localize(1726, "Quick Fix")),
            settingsKey: "accessibility.signals.terminalQuickFix"
        });
    }
    static {
        this.onDebugBreak = AccessibilitySignal.register({
            name: ( localize(1727, "Debugger Stopped on Breakpoint")),
            sound: Sound.break,
            legacySoundSettingsKey: "audioCues.onDebugBreak",
            legacyAnnouncementSettingsKey: "accessibility.alert.onDebugBreak",
            announcementMessage: ( localize(1728, "Breakpoint")),
            settingsKey: "accessibility.signals.onDebugBreak"
        });
    }
    static {
        this.noInlayHints = AccessibilitySignal.register({
            name: ( localize(1729, "No Inlay Hints on Line")),
            sound: Sound.error,
            legacySoundSettingsKey: "audioCues.noInlayHints",
            legacyAnnouncementSettingsKey: "accessibility.alert.noInlayHints",
            announcementMessage: ( localize(1730, "No Inlay Hints")),
            settingsKey: "accessibility.signals.noInlayHints"
        });
    }
    static {
        this.taskCompleted = AccessibilitySignal.register({
            name: ( localize(1731, "Task Completed")),
            sound: Sound.taskCompleted,
            legacySoundSettingsKey: "audioCues.taskCompleted",
            legacyAnnouncementSettingsKey: "accessibility.alert.taskCompleted",
            announcementMessage: ( localize(1732, "Task Completed")),
            settingsKey: "accessibility.signals.taskCompleted"
        });
    }
    static {
        this.taskFailed = AccessibilitySignal.register({
            name: ( localize(1733, "Task Failed")),
            sound: Sound.taskFailed,
            legacySoundSettingsKey: "audioCues.taskFailed",
            legacyAnnouncementSettingsKey: "accessibility.alert.taskFailed",
            announcementMessage: ( localize(1734, "Task Failed")),
            settingsKey: "accessibility.signals.taskFailed"
        });
    }
    static {
        this.terminalCommandFailed = AccessibilitySignal.register({
            name: ( localize(1735, "Terminal Command Failed")),
            sound: Sound.error,
            legacySoundSettingsKey: "audioCues.terminalCommandFailed",
            legacyAnnouncementSettingsKey: "accessibility.alert.terminalCommandFailed",
            announcementMessage: ( localize(1736, "Command Failed")),
            settingsKey: "accessibility.signals.terminalCommandFailed"
        });
    }
    static {
        this.terminalCommandSucceeded = AccessibilitySignal.register({
            name: ( localize(1737, "Terminal Command Succeeded")),
            sound: Sound.terminalCommandSucceeded,
            announcementMessage: ( localize(1738, "Command Succeeded")),
            settingsKey: "accessibility.signals.terminalCommandSucceeded"
        });
    }
    static {
        this.terminalBell = AccessibilitySignal.register({
            name: ( localize(1739, "Terminal Bell")),
            sound: Sound.terminalBell,
            legacySoundSettingsKey: "audioCues.terminalBell",
            legacyAnnouncementSettingsKey: "accessibility.alert.terminalBell",
            announcementMessage: ( localize(1740, "Terminal Bell")),
            settingsKey: "accessibility.signals.terminalBell"
        });
    }
    static {
        this.notebookCellCompleted = AccessibilitySignal.register({
            name: ( localize(1741, "Notebook Cell Completed")),
            sound: Sound.taskCompleted,
            legacySoundSettingsKey: "audioCues.notebookCellCompleted",
            legacyAnnouncementSettingsKey: "accessibility.alert.notebookCellCompleted",
            announcementMessage: ( localize(1742, "Notebook Cell Completed")),
            settingsKey: "accessibility.signals.notebookCellCompleted"
        });
    }
    static {
        this.notebookCellFailed = AccessibilitySignal.register({
            name: ( localize(1743, "Notebook Cell Failed")),
            sound: Sound.taskFailed,
            legacySoundSettingsKey: "audioCues.notebookCellFailed",
            legacyAnnouncementSettingsKey: "accessibility.alert.notebookCellFailed",
            announcementMessage: ( localize(1744, "Notebook Cell Failed")),
            settingsKey: "accessibility.signals.notebookCellFailed"
        });
    }
    static {
        this.diffLineInserted = AccessibilitySignal.register({
            name: ( localize(1745, "Diff Line Inserted")),
    ...
    static {
        this.diffLineDeleted = AccessibilitySignal.register({
            name: ( localize(1746, "Diff Line Deleted")),
    ...
    static {
        this.diffLineModified = AccessibilitySignal.register({
            name: ( localize(1747, "Diff Line Modified")),
    ...
    static {
        this.codeActionTriggered = AccessibilitySignal.register({
            name: ( localize(1753, "Code Action Request Triggered")),
    ...
    static {
        this.progress = AccessibilitySignal.register({
            name: ( localize(1756, "Progress")),
            sound: Sound.progress,
            legacySoundSettingsKey: "audioCues.chatResponsePending",
            legacyAnnouncementSettingsKey: "accessibility.alert.progress",
            announcementMessage: ( localize(1757, "Progress")),
            settingsKey: "accessibility.signals.progress"
        });
    }
    static {
        this.clear = AccessibilitySignal.register({
            name: ( localize(1758, "Clear")),
            sound: Sound.clear,
            legacySoundSettingsKey: "audioCues.clear",
            legacyAnnouncementSettingsKey: "accessibility.alert.clear",
            announcementMessage: ( localize(1759, "Clear")),
            settingsKey: "accessibility.signals.clear"
        });
    }
    static {
        this.save = AccessibilitySignal.register({
            name: ( localize(1760, "Save")),
            sound: Sound.save,
            legacySoundSettingsKey: "audioCues.save",
            legacyAnnouncementSettingsKey: "accessibility.alert.save",
            announcementMessage: ( localize(1761, "Save")),
            settingsKey: "accessibility.signals.save"
        });
    }
    static {
        this.format = AccessibilitySignal.register({
            name: ( localize(1762, "Format")),
            sound: Sound.format,
            legacySoundSettingsKey: "audioCues.format",
            legacyAnnouncementSettingsKey: "accessibility.alert.format",
            announcementMessage: ( localize(1763, "Format")),
            settingsKey: "accessibility.signals.format"
        });
    }
    static {
        this.voiceRecordingStarted = AccessibilitySignal.register({
            name: ( localize(1764, "Voice Recording Started")),
    ...
    static {
        this.voiceRecordingStopped = AccessibilitySignal.register({
            name: ( localize(1765, "Voice Recording Stopped")),
