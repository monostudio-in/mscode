...
const terminalProfileBaseProperties = {
    args: {
        description: ( localize(2133, "An optional set of arguments to run the shell executable with.")),
        type: "array",
        items: {
            type: "string"
        }
    ...
    icon: {
        description: ( localize(2134, "A codicon ID to associate with the terminal icon.")),
        ...terminalIconSchema
    },
    color: {
        description: ( localize(2135, "A theme color ID to associate with the terminal icon.")),
        ...terminalColorSchema
    },
    env: {
...
const terminalAutomationProfileSchema = {
    ...
    properties: {
        path: {
            description: ( localize(2139, "A path to a shell executable.")),
            type: ["string"],
            items: {
                type: "string"
            }
...
const terminalPlatformConfiguration = {
    id: "terminal",
    order: 100,
    title: ( localize(2141, "Integrated Terminal")),
    type: "object",
    properties: {
        ...
        [TerminalSettingId.ProfilesWindows]: {
            ...
            additionalProperties: {
                "anyOf": [{
                    ...
                    properties: {
                        extensionIdentifier: {
                            description: ( localize(2146, "The extension that contributed this profile.")),
                            type: "string"
                        },
                        id: {
                            description: ( localize(2147, "The id of the extension terminal")),
                            type: "string"
                        },
                        title: {
                            description: ( localize(2148, "The name of the extension terminal")),
                            type: "string"
                        },
                        ...terminalProfileBaseProperties
                    }
        ...
        [TerminalSettingId.ProfilesMacOs]: {
            ...
            additionalProperties: {
                "anyOf": [{
                    ...
                    properties: {
                        extensionIdentifier: {
                            description: ( localize(2149, "The extension that contributed this profile.")),
                            type: "string"
                        },
                        id: {
                            description: ( localize(2150, "The id of the extension terminal")),
                            type: "string"
                        },
                        title: {
                            description: ( localize(2151, "The name of the extension terminal")),
                            type: "string"
                        },
                        ...terminalProfileBaseProperties
                    }
        ...
        [TerminalSettingId.ProfilesLinux]: {
            ...
            additionalProperties: {
                "anyOf": [{
                    ...
                    properties: {
                        extensionIdentifier: {
                            description: ( localize(2152, "The extension that contributed this profile.")),
                            type: "string"
                        },
                        id: {
                            description: ( localize(2153, "The id of the extension terminal")),
                            type: "string"
                        },
                        title: {
                            description: ( localize(2154, "The name of the extension terminal")),
                            type: "string"
                        },
                        ...terminalProfileBaseProperties
                    }
        ...
        [TerminalSettingId.ShowLinkHover]: {
            scope: ConfigurationScope.APPLICATION,
            description: ( localize(2158, "Whether to show hovers for links in the terminal output.")),
            type: "boolean",
            default: true
        },
    ...
    defaultProfilesConfiguration = {
        ...
        properties: {
            [TerminalSettingId.DefaultProfileLinux]: {
                restricted: true,
                markdownDescription: ( localize(2160, "The default terminal profile on Linux.")),
                type: ["string", "null"],
                default: null,
            ...
            [TerminalSettingId.DefaultProfileMacOs]: {
                restricted: true,
                markdownDescription: ( localize(2161, "The default terminal profile on macOS.")),
                type: ["string", "null"],
                default: null,
            ...
            [TerminalSettingId.DefaultProfileWindows]: {
                restricted: true,
                markdownDescription: ( localize(2162, "The default terminal profile on Windows.")),
                type: ["string", "null"],
                default: null,
