    ...
    constructor() {
        ...
        this.tokenStylingSchema = {
            ...
            definitions: {
                style: {
                    type: "object",
                    description: ( localize(2433, "Colors and styles for the token.")),
                    properties: {
                        foreground: {
                            type: "string",
                            description: ( localize(2434, "Foreground color for the token.")),
                            format: "color-hex",
                            default: "#ff0000"
                        },
                        background: {
                            type: "string",
                            deprecationMessage: ( localize(2435, "Token background colors are currently not supported."))
                        },
                        fontStyle: {
                            type: "string",
                            ...
                            defaultSnippets: [{
                                label: ( localize(2438, "None (clear inherited style)")),
                                bodyText: "\"\""
                            }, {
                                body: "italic"
                            }, {
...
function createDefaultTokenClassificationRegistry() {
    ...
    registerTokenType("comment", ( localize(2443, "Style for comments.")), [["comment"]]);
    registerTokenType("string", ( localize(2444, "Style for strings.")), [["string"]]);
    registerTokenType("keyword", ( localize(2445, "Style for keywords.")), [["keyword.control"]]);
    registerTokenType("number", ( localize(2446, "Style for numbers.")), [["constant.numeric"]]);
    registerTokenType("regexp", ( localize(2447, "Style for expressions.")), [["constant.regexp"]]);
    registerTokenType("operator", ( localize(2448, "Style for operators.")), [["keyword.operator"]]);
    registerTokenType("namespace", ( localize(2449, "Style for namespaces.")), [["entity.name.namespace"]]);
    registerTokenType("type", ( localize(2450, "Style for types.")), [["entity.name.type"], ["support.type"]]);
    registerTokenType("struct", ( localize(2451, "Style for structs.")), [["entity.name.type.struct"]]);
    registerTokenType("class", ( localize(2452, "Style for classes.")), [["entity.name.type.class"], ["support.class"]]);
    registerTokenType("interface", ( localize(2453, "Style for interfaces.")), [["entity.name.type.interface"]]);
    registerTokenType("enum", ( localize(2454, "Style for enums.")), [["entity.name.type.enum"]]);
    registerTokenType("typeParameter", ( localize(2455, "Style for type parameters.")), [["entity.name.type.parameter"]]);
    registerTokenType("function", ( localize(2456, "Style for functions")), [["entity.name.function"], ["support.function"]]);
    registerTokenType("member", ( localize(2457, "Style for member functions")), [], "method", "Deprecated use `method` instead");
    registerTokenType("method", ( localize(2458, "Style for method (member functions)")), [["entity.name.function.member"], ["support.function"]]);
    registerTokenType("macro", ( localize(2459, "Style for macros.")), [["entity.name.function.preprocessor"]]);
    registerTokenType("variable", ( localize(2460, "Style for variables.")), [["variable.other.readwrite"], ["entity.name.variable"]]);
    registerTokenType("parameter", ( localize(2461, "Style for parameters.")), [["variable.parameter"]]);
    registerTokenType("property", ( localize(2462, "Style for properties.")), [["variable.other.property"]]);
    registerTokenType("enumMember", ( localize(2463, "Style for enum members.")), [["variable.other.enummember"]]);
    registerTokenType("event", ( localize(2464, "Style for events.")), [["variable.other.event"]]);
    registerTokenType("decorator", ( localize(2465, "Style for decorators & annotations.")), [["entity.name.decorator"], ["entity.name.function"]]);
    registerTokenType("label", ( localize(2466, "Style for labels. ")), undefined);
    registry.registerTokenModifier("declaration", ( localize(2467, "Style for all symbol declarations.")), undefined);
    registry.registerTokenModifier("documentation", ( localize(2468, "Style to use for references in documentation.")), undefined);
    registry.registerTokenModifier("static", ( localize(2469, "Style to use for symbols that are static.")), undefined);
    registry.registerTokenModifier("abstract", ( localize(2470, "Style to use for symbols that are abstract.")), undefined);
    registry.registerTokenModifier("deprecated", ( localize(2471, "Style to use for symbols that are deprecated.")), undefined);
    registry.registerTokenModifier("modification", ( localize(2472, "Style to use for write accesses.")), undefined);
    registry.registerTokenModifier("async", ( localize(2473, "Style to use for symbols that are async.")), undefined);
    registry.registerTokenModifier("readonly", ( localize(2474, "Style to use for symbols that are read-only.")), undefined);
