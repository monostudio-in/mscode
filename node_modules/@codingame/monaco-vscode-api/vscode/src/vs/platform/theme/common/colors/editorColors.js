...
const editorBackground = registerColor("editor.background", {
    ...
    hcDark: Color.black,
    hcLight: Color.white
}, ( localize(2192, "Editor background color.")));
const editorForeground = registerColor("editor.foreground", {
    light: "#333333",
    dark: "#BBBBBB",
    hcDark: Color.white,
    hcLight: foreground
}, ( localize(2193, "Editor default foreground color.")));
registerColor("editorStickyScroll.background", editorBackground, ( localize(2194, "Background color of sticky scroll in the editor")));
registerColor("editorStickyScrollGutter.background", editorBackground, ( localize(2195, "Background color of the gutter part of sticky scroll in the editor")));
registerColor("editorStickyScrollHover.background", {
    dark: "#2A2D2E",
    light: "#F0F0F0",
    hcDark: null,
    hcLight: ( ( Color.fromHex("#0F4A85")).transparent(0.1))
}, ( localize(2196, "Background color of sticky scroll on hover in the editor")));
registerColor("editorStickyScroll.border", {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2197, "Border color of sticky scroll in the editor")));
registerColor("editorStickyScroll.shadow", scrollbarShadow, ( localize(2198, " Shadow color of sticky scroll in the editor")));
const editorWidgetBackground = registerColor("editorWidget.background", {
    dark: "#252526",
    light: "#F3F3F3",
    hcDark: "#0C141F",
    hcLight: Color.white
}, ( localize(2199, "Background color of editor widgets, such as find/replace.")));
const editorWidgetForeground = registerColor("editorWidget.foreground", foreground, ( localize(2200, "Foreground color of editor widgets, such as find/replace.")));
...
const editorErrorForeground = registerColor("editorError.foreground", {
    ...
    hcDark: "#F48771",
    hcLight: "#B5200D"
}, ( localize(2204, "Foreground color of error squigglies in the editor.")));
const editorErrorBorder = registerColor("editorError.border", {
    dark: null,
    light: null,
    hcDark: ( ( Color.fromHex("#E47777")).transparent(0.8)),
    hcLight: "#B5200D"
}, ( localize(2205, "If set, color of double underlines for errors in the editor.")));
...
const editorWarningForeground = registerColor("editorWarning.foreground", {
    ...
    hcDark: "#FFD370",
    hcLight: "#895503"
}, ( localize(2207, "Foreground color of warning squigglies in the editor.")));
...
}, ( localize(2208, "If set, color of double underlines for warnings in the editor.")));
...
}, ( localize(2219, "Border color for regions with the same content as the selection.")));
registerColor("editor.compositionBorder", {
    light: "#000000",
    dark: "#ffffff",
    hcLight: "#000000",
    hcDark: "#ffffff"
}, ( localize(2220, "The border color for an IME composition.")));
const editorFindMatch = registerColor("editor.findMatchBackground", {
    light: "#A8AC94",
    dark: "#515C6A",
    hcDark: null,
    hcLight: null
}, ( localize(2221, "Color of the current search match.")));
const editorFindMatchForeground = registerColor("editor.findMatchForeground", null, ( localize(2222, "Text color of the current search match.")));
...
const editorFindMatchHighlightForeground = registerColor("editor.findMatchHighlightForeground", null, ( localize(2224, "Foreground color of the other search matches.")), true);
...
registerColor("editor.findMatchBorder", {
    ...
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2226, "Border color of the current search match.")));
const editorFindMatchHighlightBorder = registerColor("editor.findMatchHighlightBorder", {
    light: null,
    dark: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2227, "Border color of the other search matches.")));
...
const editorHoverBackground = registerColor("editorHoverWidget.background", editorWidgetBackground, ( localize(2230, "Background color of the editor hover.")));
const editorHoverForeground = registerColor("editorHoverWidget.foreground", editorWidgetForeground, ( localize(2231, "Foreground color of the editor hover.")));
const editorHoverBorder = registerColor("editorHoverWidget.border", editorWidgetBorder, ( localize(2232, "Border color of the editor hover.")));
...
}, ( localize(2233, "Background color of the editor hover status bar.")));
const editorInlayHintForeground = registerColor("editorInlayHint.foreground", {
    dark: "#969696",
    light: "#969696",
    hcDark: Color.white,
    hcLight: Color.black
}, ( localize(2234, "Foreground color of inline hints")));
...
const editorLightBulbForeground = registerColor("editorLightBulb.foreground", {
    ...
    hcDark: "#FFCC00",
    hcLight: "#007ACC"
}, ( localize(2240, "The color used for the lightbulb actions icon.")));
registerColor("editorLightBulbAutoFix.foreground", {
    dark: "#75BEFF",
    light: "#007ACC",
    hcDark: "#75BEFF",
    hcLight: "#007ACC"
}, ( localize(2241, "The color used for the lightbulb auto fix actions icon.")));
registerColor("editorLightBulbAi.foreground", editorLightBulbForeground, ( localize(2242, "The color used for the lightbulb AI icon.")));
...
}, ( localize(2243, "Highlight background color of a snippet tabstop.")));
registerColor("editor.snippetTabstopHighlightBorder", null, ( localize(2244, "Highlight border color of a snippet tabstop.")));
registerColor("editor.snippetFinalTabstopHighlightBackground", null, ( localize(2245, "Highlight background color of the final tabstop of a snippet.")));
registerColor("editor.snippetFinalTabstopHighlightBorder", {
    dark: "#525252",
    light: ( new Color(( new RGBA(10, 50, 100, 0.5)))),
    hcDark: "#525252",
    hcLight: "#292929"
}, ( localize(2246, "Highlight border color of the final tabstop of a snippet.")));
...
registerColor("diffEditorGutter.insertedLineBackground", null, ( localize(2251, "Background color for the margin where lines got inserted.")));
registerColor("diffEditorGutter.removedLineBackground", null, ( localize(2252, "Background color for the margin where lines got removed.")));
const diffOverviewRulerInserted = registerColor("diffEditorOverview.insertedForeground", null, ( localize(2253, "Diff overview ruler foreground for inserted content.")));
const diffOverviewRulerRemoved = registerColor("diffEditorOverview.removedForeground", null, ( localize(2254, "Diff overview ruler foreground for removed content.")));
registerColor("diffEditor.insertedTextBorder", {
    dark: null,
    light: null,
    hcDark: "#33ff2eff",
    hcLight: "#374E06"
}, ( localize(2255, "Outline color for the text that got inserted.")));
registerColor("diffEditor.removedTextBorder", {
    dark: null,
    light: null,
    hcDark: "#FF008F",
    hcLight: "#AD0707"
}, ( localize(2256, "Outline color for text that got removed.")));
registerColor("diffEditor.border", {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2257, "Border color between the two text editors.")));
...
registerColor(
    ...
    "sideBar.background",
    ( localize(2259, "The background color of unchanged blocks in the diff editor."))
);
registerColor("diffEditor.unchangedRegionForeground", "foreground", ( localize(2260, "The foreground color of unchanged blocks in the diff editor.")));
registerColor("diffEditor.unchangedCodeBackground", {
    dark: "#74747429",
    light: "#b8b8b829",
    hcDark: null,
    hcLight: null
}, ( localize(2261, "The background color of unchanged code in the diff editor.")));
const widgetShadow = registerColor("widget.shadow", {
    dark: ( transparent(Color.black, .36)),
    light: ( transparent(Color.black, .16)),
    hcDark: null,
    hcLight: null
}, ( localize(2262, "Shadow color of widgets such as find/replace inside the editor.")));
const widgetBorder = registerColor("widget.border", {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2263, "Border color of widgets such as find/replace inside the editor.")));
const toolbarHoverBackground = registerColor("toolbar.hoverBackground", {
    dark: "#5a5d5e50",
    light: "#b8b8b850",
    hcDark: null,
    hcLight: null
}, ( localize(2264, "Toolbar background when hovering over actions using the mouse")));
registerColor("toolbar.hoverOutline", {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2265, "Toolbar outline when hovering over actions using the mouse")));
registerColor("toolbar.activeBackground", {
    dark: ( lighten(toolbarHoverBackground, 0.1)),
    light: ( darken(toolbarHoverBackground, 0.1)),
    hcDark: null,
    hcLight: null
}, ( localize(2266, "Toolbar background when holding the mouse over actions")));
const breadcrumbsForeground = registerColor("breadcrumb.foreground", ( transparent(foreground, 0.8)), ( localize(2267, "Color of focused breadcrumb items.")));
const breadcrumbsBackground = registerColor("breadcrumb.background", editorBackground, ( localize(2268, "Background color of breadcrumb items.")));
...
}, ( localize(2267, "Color of focused breadcrumb items.")));
const breadcrumbsActiveSelectionForeground = registerColor("breadcrumb.activeSelectionForeground", {
    light: ( darken(foreground, 0.2)),
    dark: ( lighten(foreground, 0.1)),
    hcDark: ( lighten(foreground, 0.1)),
    hcLight: ( lighten(foreground, 0.1))
}, ( localize(2269, "Color of selected breadcrumb items.")));
const breadcrumbsPickerBackground = registerColor("breadcrumbPicker.background", editorWidgetBackground, ( localize(2270, "Background color of breadcrumb item picker.")));
...
registerColor("editorOverviewRuler.currentContentForeground", {
    ...
    hcDark: mergeBorder,
    hcLight: mergeBorder
}, ( localize(2278, "Current overview ruler foreground for inline merge-conflicts.")));
registerColor("editorOverviewRuler.incomingContentForeground", {
    ...
    hcDark: mergeBorder,
    hcLight: mergeBorder
}, ( localize(2279, "Incoming overview ruler foreground for inline merge-conflicts.")));
...
const problemsErrorIconForeground = registerColor("problemsErrorIcon.foreground", editorErrorForeground, ( localize(2283, "The color used for the problems error icon.")));
const problemsWarningIconForeground = registerColor("problemsWarningIcon.foreground", editorWarningForeground, ( localize(2284, "The color used for the problems warning icon.")));
const problemsInfoIconForeground = registerColor("problemsInfoIcon.foreground", editorInfoForeground, ( localize(2285, "The color used for the problems info icon.")));
