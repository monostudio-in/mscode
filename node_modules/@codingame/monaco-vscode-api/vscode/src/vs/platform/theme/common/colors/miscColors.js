...
registerColor("sash.hoverBorder", focusBorder, ( localize(2388, "Border color of active sashes.")));
...
const activityWarningBadgeForeground = registerColor("activityWarningBadge.foreground", {
    ...
    hcDark: Color.white,
    hcLight: Color.white
}, ( localize(2391, "Foreground color of the warning activity badge")));
const activityWarningBadgeBackground = registerColor("activityWarningBadge.background", {
    dark: "#B27C00",
    light: "#B27C00",
    hcDark: null,
    hcLight: "#B27C00"
}, ( localize(2392, "Background color of the warning activity badge")));
...
}, ( localize(2393, "Foreground color of the error activity badge")));
const activityErrorBadgeBackground = registerColor("activityErrorBadge.background", {
    dark: "#F14C4C",
    light: "#E51400",
    hcDark: null,
    hcLight: "#F14C4C"
}, ( localize(2394, "Background color of the error activity badge")));
const scrollbarShadow = registerColor("scrollbar.shadow", {
    dark: "#000000",
    light: "#DDDDDD",
    hcDark: null,
    hcLight: null
}, ( localize(2395, "Scrollbar shadow to indicate that the view is scrolled.")));
...
}, ( localize(2396, "Scrollbar slider background color.")));
...
}, ( localize(2397, "Scrollbar slider background color when hovering.")));
...
}, ( localize(2398, "Scrollbar slider background color when clicked on.")));
registerColor("scrollbar.background", null, ( localize(2399, "Scrollbar track background color.")));
...
const chartLine = registerColor("chart.line", {
    ...
    hcDark: "#236B8E",
    hcLight: "#236B8E"
}, ( localize(2401, "Line color for the chart.")));
const chartAxis = registerColor("chart.axis", {
    dark: ( ( Color.fromHex("#BFBFBF")).transparent(0.4)),
    light: ( ( Color.fromHex("#000000")).transparent(0.6)),
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2402, "Axis color for the chart.")));
const chartGuide = registerColor("chart.guide", {
    ...
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(2403, "Guide line for the chart.")));
