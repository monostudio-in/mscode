            ...
            definitions: {
                icons: {
                    ...
                    properties: {
                        ...
                        fontCharacter: {
                            type: "string",
                            description: ( localize(2418, "The font character associated with the icon definition."))
                        }
                    },
...
const widgetClose = registerIcon("widget-close", Codicon.close, ( localize(2419, "Icon for the close action in widgets.")));
const gotoPreviousLocation = registerIcon("goto-previous-location", Codicon.arrowUp, ( localize(2420, "Icon for goto previous editor location.")));
const gotoNextLocation = registerIcon("goto-next-location", Codicon.arrowDown, ( localize(2421, "Icon for goto next editor location.")));
