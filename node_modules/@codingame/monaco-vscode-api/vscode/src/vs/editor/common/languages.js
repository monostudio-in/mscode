...
(function(CompletionItemKinds) {
    ...
    function toLabel(kind) {
        ...
        case CompletionItemKind.Method:
            return localize(823, "Method");
        case CompletionItemKind.Function:
            return localize(824, "Function");
        case CompletionItemKind.Constructor:
            return localize(825, "Constructor");
        case CompletionItemKind.Field:
            return localize(826, "Field");
        case CompletionItemKind.Variable:
            return localize(827, "Variable");
        case CompletionItemKind.Class:
            return localize(828, "Class");
        case CompletionItemKind.Struct:
            return localize(829, "Struct");
        case CompletionItemKind.Interface:
            return localize(830, "Interface");
        case CompletionItemKind.Module:
            return localize(831, "Module");
        case CompletionItemKind.Property:
            return localize(832, "Property");
        case CompletionItemKind.Event:
            return localize(833, "Event");
        case CompletionItemKind.Operator:
            return localize(834, "Operator");
        case CompletionItemKind.Unit:
            return localize(835, "Unit");
        case CompletionItemKind.Value:
            return localize(836, "Value");
        case CompletionItemKind.Constant:
            return localize(837, "Constant");
        case CompletionItemKind.Enum:
            return localize(838, "Enum");
        case CompletionItemKind.EnumMember:
            return localize(839, "Enum Member");
        case CompletionItemKind.Keyword:
            return localize(840, "Keyword");
        case CompletionItemKind.Text:
            return localize(841, "Text");
        case CompletionItemKind.Color:
            return localize(842, "Color");
        case CompletionItemKind.File:
            return localize(843, "File");
        case CompletionItemKind.Reference:
            return localize(844, "Reference");
        case CompletionItemKind.Customcolor:
            return localize(845, "Custom Color");
        case CompletionItemKind.Folder:
            return localize(846, "Folder");
        case CompletionItemKind.TypeParameter:
            return localize(847, "Type Parameter");
        case CompletionItemKind.User:
            return localize(848, "User");
        case CompletionItemKind.Issue:
            return localize(849, "Issue");
        case CompletionItemKind.Tool:
            return localize(850, "Tool");
        case CompletionItemKind.Snippet:
            return localize(851, "Snippet");
        default:
            return "";
        }
    }
...
const symbolKindNames = {
    [SymbolKind.Array]: ( localize(852, "array")),
    [SymbolKind.Boolean]: ( localize(853, "boolean")),
    [SymbolKind.Class]: ( localize(854, "class")),
    [SymbolKind.Constant]: ( localize(855, "constant")),
    [SymbolKind.Constructor]: ( localize(856, "constructor")),
    [SymbolKind.Enum]: ( localize(857, "enumeration")),
    [SymbolKind.EnumMember]: ( localize(858, "enumeration member")),
    [SymbolKind.Event]: ( localize(859, "event")),
    [SymbolKind.Field]: ( localize(860, "field")),
    [SymbolKind.File]: ( localize(861, "file")),
    [SymbolKind.Function]: ( localize(862, "function")),
    [SymbolKind.Interface]: ( localize(863, "interface")),
    [SymbolKind.Key]: ( localize(864, "key")),
    [SymbolKind.Method]: ( localize(865, "method")),
    [SymbolKind.Module]: ( localize(866, "module")),
    [SymbolKind.Namespace]: ( localize(867, "namespace")),
    [SymbolKind.Null]: ( localize(868, "null")),
    [SymbolKind.Number]: ( localize(869, "number")),
    [SymbolKind.Object]: ( localize(870, "object")),
    [SymbolKind.Operator]: ( localize(871, "operator")),
    [SymbolKind.Package]: ( localize(872, "package")),
    [SymbolKind.Property]: ( localize(873, "property")),
    [SymbolKind.String]: ( localize(874, "string")),
    [SymbolKind.Struct]: ( localize(875, "struct")),
    [SymbolKind.TypeParameter]: ( localize(876, "type parameter")),
    [SymbolKind.Variable]: ( localize(877, "variable"))
};
function getAriaLabelForSymbol(symbolName, kind) {
    return localize(878, "{0} ({1})", symbolName, symbolKindNames[kind]);
}
var SymbolTag;
(function(SymbolTag) {
