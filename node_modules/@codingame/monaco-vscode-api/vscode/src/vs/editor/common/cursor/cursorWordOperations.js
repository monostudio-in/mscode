...
class WordOperations {
    ...
    static moveWordLeft(wordSeparators, model, position, wordNavigationType, hasMulticursor) {
        ...
        if (wordNavigationType === WordNavigationType.WordStartFast) {
            if (
            !hasMulticursor && prevWordOnLine && prevWordOnLine.wordType === WordType.Separator && prevWordOnLine.end - prevWordOnLine.start === 1 && prevWordOnLine.nextCharClass === WordCharacterClass.Regular) {
...
class WordPartOperations extends WordOperations {
    ...
    static moveWordPartLeft(wordSeparators, model, position, hasMulticursor) {
        const candidates = enforceDefined([WordOperations.moveWordLeft(
            wordSeparators,
            model,
            position,
