...
const editorLineHighlight = registerColor("editor.lineHighlightBackground", null, ( localize(702, "Background color for the highlight of line at the cursor position.")));
...
}, ( localize(706, "Background color of the border around highlighted ranges.")));
...
registerColor("editor.symbolHighlightBorder", {
    ...
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(708, "Background color of the border around highlighted symbols.")));
const editorCursorForeground = registerColor("editorCursor.foreground", {
    dark: "#AEAFAD",
    light: Color.black,
    hcDark: Color.white,
    hcLight: "#0F4A85"
}, ( localize(709, "Color of the editor cursor.")));
...
const editorWhitespaces = registerColor("editorWhitespace.foreground", {
    ...
    hcDark: "#e3e4e229",
    hcLight: "#CCCCCC"
}, ( localize(715, "Color of whitespace characters in the editor.")));
const editorLineNumbers = registerColor("editorLineNumber.foreground", {
    dark: "#858585",
    light: "#237893",
    hcDark: Color.white,
    hcLight: "#292929"
}, ( localize(716, "Color of editor line numbers.")));
const deprecatedEditorIndentGuides = registerColor("editorIndentGuide.background", editorWhitespaces, ( localize(717, "Color of the editor indentation guides.")), false, ( localize(
    718,
    "'editorIndentGuide.background' is deprecated. Use 'editorIndentGuide.background1' instead."
)));
const deprecatedEditorActiveIndentGuides = registerColor("editorIndentGuide.activeBackground", editorWhitespaces, ( localize(719, "Color of the active editor indentation guides.")), false, ( localize(
    720,
...
const editorIndentGuide1 = registerColor(
    ...
    ( localize(721, "Color of the editor indentation guides (1)."))
);
const editorIndentGuide2 = registerColor("editorIndentGuide.background2", "#00000000", ( localize(722, "Color of the editor indentation guides (2).")));
const editorIndentGuide3 = registerColor("editorIndentGuide.background3", "#00000000", ( localize(723, "Color of the editor indentation guides (3).")));
const editorIndentGuide4 = registerColor("editorIndentGuide.background4", "#00000000", ( localize(724, "Color of the editor indentation guides (4).")));
const editorIndentGuide5 = registerColor("editorIndentGuide.background5", "#00000000", ( localize(725, "Color of the editor indentation guides (5).")));
const editorIndentGuide6 = registerColor("editorIndentGuide.background6", "#00000000", ( localize(726, "Color of the editor indentation guides (6).")));
const editorActiveIndentGuide1 = registerColor(
    "editorIndentGuide.activeBackground1",
    deprecatedEditorActiveIndentGuides,
    ( localize(727, "Color of the active editor indentation guides (1)."))
);
const editorActiveIndentGuide2 = registerColor("editorIndentGuide.activeBackground2", "#00000000", ( localize(728, "Color of the active editor indentation guides (2).")));
const editorActiveIndentGuide3 = registerColor("editorIndentGuide.activeBackground3", "#00000000", ( localize(729, "Color of the active editor indentation guides (3).")));
const editorActiveIndentGuide4 = registerColor("editorIndentGuide.activeBackground4", "#00000000", ( localize(730, "Color of the active editor indentation guides (4).")));
const editorActiveIndentGuide5 = registerColor("editorIndentGuide.activeBackground5", "#00000000", ( localize(731, "Color of the active editor indentation guides (5).")));
const editorActiveIndentGuide6 = registerColor("editorIndentGuide.activeBackground6", "#00000000", ( localize(732, "Color of the active editor indentation guides (6).")));
const deprecatedEditorActiveLineNumber = registerColor("editorActiveLineNumber.foreground", {
    dark: "#c6c6c6",
    light: "#0B216F",
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder
}, ( localize(733, "Color of editor active line number")), false, ( localize(734, "Id is deprecated. Use 'editorLineNumber.activeForeground' instead.")));
registerColor(
    "editorLineNumber.activeForeground",
    deprecatedEditorActiveLineNumber,
    ( localize(733, "Color of editor active line number"))
);
...
const editorRuler = registerColor("editorRuler.foreground", {
    ...
    hcDark: Color.white,
    hcLight: "#292929"
}, ( localize(736, "Color of the editor rulers.")));
registerColor("editorCodeLens.foreground", {
    dark: "#999999",
    light: "#919191",
    hcDark: "#999999",
    hcLight: "#292929"
}, ( localize(737, "Foreground color of editor CodeLens")));
registerColor("editorBracketMatch.background", {
    dark: "#0064001a",
    light: "#0064001a",
    hcDark: "#0064001a",
    hcLight: "#0000"
}, ( localize(738, "Background color behind matching brackets")));
registerColor("editorBracketMatch.border", {
    dark: "#888",
    light: "#B9B9B9",
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(739, "Color for matching brackets boxes")));
const editorBracketMatchForeground = registerColor("editorBracketMatch.foreground", null, ( localize(740, "Foreground color for matching brackets")));
const editorOverviewRulerBorder = registerColor("editorOverviewRuler.border", {
    dark: "#7f7f7f4d",
    light: "#7f7f7f4d",
    hcDark: "#7f7f7f4d",
    hcLight: "#666666"
}, ( localize(741, "Color of the overview ruler border.")));
const editorOverviewRulerBackground = registerColor("editorOverviewRuler.background", null, ( localize(742, "Background color of the editor overview ruler.")));
...
registerColor("editorUnnecessaryCode.border", {
    ...
    hcLight: contrastBorder
}, ( localize(744, "Border color of unnecessary (unused) source code in the editor.")));
...
}, ( localize(746, "Border color of ghost text in the editor.")));
const ghostTextForeground = registerColor("editorGhostText.foreground", {
    dark: ( Color.fromHex("#ffffff56")),
    light: ( Color.fromHex("#0007")),
    hcDark: null,
    hcLight: null
}, ( localize(747, "Foreground color of the ghost text in the editor.")));
registerColor("editorGhostText.background", null, ( localize(748, "Background color of the ghost text in the editor.")));
...
const overviewRulerError = registerColor("editorOverviewRuler.errorForeground", {
    ...
    hcLight: "#B5200D"
}, ( localize(750, "Overview ruler marker color for errors.")));
...
}, ( localize(751, "Overview ruler marker color for warnings.")));
...
}, ( localize(752, "Overview ruler marker color for infos.")));
...
const editorBracketHighlightingUnexpectedBracketForeground = registerColor("editorBracketHighlight.unexpectedBracket.foreground", {
    ...
    hcDark: ( new Color(( new RGBA(255, 50, 50, 1)))),
    hcLight: "#B5200D"
}, ( localize(759, "Foreground color of unexpected brackets.")));
...
registerColor("editorUnicodeHighlight.border", editorWarningForeground, ( localize(772, "Border color used to highlight unicode characters.")));
registerColor(
    "editorUnicodeHighlight.background",
    editorWarningBackground,
    ( localize(773, "Background color used to highlight unicode characters."))
);
