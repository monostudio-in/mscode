...
import { InternalModelContentChangeEvent, ModelRawContentChangedEvent, ModelRawFlush, ModelRawEOLChanged, ModelRawLineChanged, ModelRawLinesDeleted, ModelRawLinesInserted, ModelInjectedTextChangedEvent, ModelLineHeightChanged, ModelLineHeightChangedEvent, ModelFontChanged, ModelFontChangedEvent, LineInjectedText } from '../textModelEvents.js';
...
let TextModel = class TextModel extends Disposable {
    ...
    _setValueFromTextBuffer(textBuffer, textBufferDisposable, reason) {
        ...
        this._trimAutoWhitespaceLines = null;
        this._emitContentChangedEvent(( new ModelRawContentChangedEvent([( new ModelRawFlush())], this._versionId, false, false)), this._createContentChanged2(( new Range(1, 1, endLineNumber, endColumn)), 0, oldModelValueLength, ( new Position(endLineNumber, endColumn)), this.getValue(), false, false, true, false, reason));
    }
    setEOL(eol) {
        this._assertNotDisposed();
        ...
        this._emitContentChangedEvent(( new ModelRawContentChangedEvent([( new ModelRawEOLChanged())], this._versionId, false, false)), this._createContentChanged2(( new Range(1, 1, endLineNumber, endColumn)), 0, oldModelValueLength, ( new Position(endLineNumber, endColumn)), this.getValue(), false, false, false, true, EditSources.eolChange()));
    }
    _onBeforeEOLChange() {
    ...
    edit(edit, options) {
        this.pushEditOperations(null, ( edit.replacements.map(r => ({
            range: r.range,
            text: r.text
        }))), null);
    }
            ...
            if (editsAreNearCursors) {
                for (let i = 0, len = this._trimAutoWhitespaceLines.length; i < len; i++) {
                    ...
                    if (allowTrimLine) {
                        ...
                        editOperations.push(
                            new ValidAnnotatedEditOperation(null, trimRange, null, false, false, false)
                        );
                    }
                }
            }
    ...
    getLinesDecorations(
        ...
        pushMany(
            decorations,
            this._fontTokenDecorationsProvider.getDecorationsInRange(range, ownerId, filterOutValidation, filterFontDecorations)
        );
        return decorations;
    }
    getDecorationsInRange(
        ...
        pushMany(decorations, this._decorationProvider.getDecorationsInRange(
            validatedRange,
            ownerId,
            filterOutValidation,
            filterFontDecorations,
        ...
        pushMany(decorations, this._fontTokenDecorationsProvider.getDecorationsInRange(
            validatedRange,
            ownerId,
            filterOutValidation,
            filterFontDecorations,
    ...
    getAllDecorations(ownerId = 0, filterOutValidation = false, filterFontDecorations = false) {
        ...
        result = result.concat(
            this._fontTokenDecorationsProvider.getAllDecorations(ownerId, filterOutValidation)
        );
        return result;
    }
...
export { ModelDecorationGlyphMarginOptions, ModelDecorationInjectedTextOptions, ModelDecorationMinimapOptions, ModelDecorationOptions, ModelDecorationOverviewRulerOptions, TextModel, createTextBuffer, createTextBufferFactory, createTextBufferFactoryFromSnapshot, createTextBufferFactoryFromStream, getLineTokensWithInjections, indentOfLine };
