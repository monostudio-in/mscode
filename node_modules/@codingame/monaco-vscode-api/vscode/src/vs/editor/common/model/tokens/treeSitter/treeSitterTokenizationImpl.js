...
let TreeSitterTokenizationImpl = class TreeSitterTokenizationImpl extends Disposable {
    ...
    constructor(
        _tree,
        _highlightingQueries,
        _languageIdCodec,
        _visibleLineRanges,
        _treeSitterThemeService
    ) {
        super();
        this._tree = _tree;
...
TreeSitterTokenizationImpl = ( __decorate([( __param(4, ITreeSitterThemeService))], TreeSitterTokenizationImpl));
