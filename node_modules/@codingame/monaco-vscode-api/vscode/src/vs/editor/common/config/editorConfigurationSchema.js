...
const editorConfiguration = {
    ...
    properties: {
        ...
        "editor.trimAutoWhitespace": {
            ...
            description: ( localize(233, "Remove trailing auto inserted whitespace."))
        },
        ...
        "editor.wordBasedSuggestions": {
            ...
            enumDescriptions: [( localize(235, "Turn off Word Based Suggestions.")), ( localize(
                236,
                "Turn off Word Based Suggestions when Inline Suggestions are present."
            )), ( localize(237, "Only suggest words from the active document.")), ( localize(238, "Suggest words from all open documents of the same language.")), ( localize(239, "Suggest words from all open documents."))],
            description: ( localize(
                240,
        ...
        "editor.semanticHighlighting.enabled": {
            ...
            enumDescriptions: [( localize(241, "Semantic highlighting enabled for all color themes.")), ( localize(242, "Semantic highlighting disabled for all color themes.")), ( localize(
                243,
        ...
        "editor.language.brackets": {
            ...
            items: {
                ...
                items: [{
                    type: "string",
                    description: ( localize(256, "The opening bracket character or string sequence."))
                }, {
                    type: "string",
                    description: ( localize(257, "The closing bracket character or string sequence."))
                }]
            }
        },
        ...
        "diffEditor.codeLens": {
            ...
            description: ( localize(268, "Controls whether the editor shows CodeLens."))
        },
        "diffEditor.wordWrap": {
            type: "string",
            enum: ["off", "on", "inherit"],
            default: diffEditorDefaultOptions.diffWordWrap,
            markdownEnumDescriptions: [( localize(269, "Lines will never wrap.")), ( localize(270, "Lines will wrap at the viewport width.")), ( localize(
                271,
        ...
        "diffEditor.diffAlgorithm": {
            ...
            markdownEnumDescriptions: [( localize(272, "Uses the legacy diffing algorithm.")), ( localize(273, "Uses the advanced diffing algorithm."))]
        },
        "diffEditor.hideUnchangedRegions.enabled": {
            type: "boolean",
            default: diffEditorDefaultOptions.hideUnchangedRegions.enabled,
            markdownDescription: ( localize(274, "Controls whether the diff editor shows unchanged regions."))
        },
        "diffEditor.hideUnchangedRegions.revealLineCount": {
            type: "integer",
            default: diffEditorDefaultOptions.hideUnchangedRegions.revealLineCount,
            markdownDescription: ( localize(275, "Controls how many lines are used for unchanged regions.")),
            minimum: 1
        },
        ...
        "diffEditor.experimental.showMoves": {
            ...
            markdownDescription: ( localize(278, "Controls whether the diff editor should show detected code moves."))
        },
