...
let NativeEditContext = class NativeEditContext extends AbstractEditContext {
    constructor(
        ...
        this._register(addDisposableListener(this.domNode.domNode, "copy", e => {
            ...
            const copyEvent = createClipboardCopyEvent(e,  false, this._context, this.logService, isFirefox);
        ...
        this._register(addDisposableListener(this.domNode.domNode, "cut", e => {
            ...
            const cutEvent = createClipboardCopyEvent(e,  true, this._context, this.logService, isFirefox);
        ...
        this._register(
            addDisposableListener(this.domNode.domNode, "keyup", e => this._onKeyUp(e))
        );
        this._register(
...
NativeEditContext = ( __decorate([( __param(5, IInstantiationService)), ( __param(6, ILogService))], NativeEditContext));
