...
class PointerEventHandler extends MouseHandler {
    constructor(context, viewController, viewHelper) {
        ...
        this._register(
            addDisposableListener(this.viewHelper.linesContentDomNode, EventType.Tap, e => this.onTap(e))
        );
        ...
        this._register(addDisposableListener(
            ...
            e => this._onContextMenu(( new EditorMouseEvent(e, false, this.viewHelper.viewDomNode)), false)
        ));
        this._lastPointerType = "mouse";
        this._register(
            addDisposableListener(this.viewHelper.linesContentDomNode, "pointerdown", e => {
        ...
        this._register(pointerEvents.onPointerDown(
...
class TouchHandler extends MouseHandler {
    ...
    onTap(event) {
        ...
        const target = this._createMouseTarget(( new EditorMouseEvent(event, false, this.viewHelper.viewDomNode)), false);
        if (target.position) {
            const event = mainWindow.document.createEvent("CustomEvent");
