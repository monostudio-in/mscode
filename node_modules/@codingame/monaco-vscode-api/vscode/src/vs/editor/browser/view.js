...
import { createElement, getWindow, runAtThisOrScheduleAtNextAnimationFrame } from '../../base/browser/dom.js';
...
View = ( __decorate([( __param(8, IInstantiationService)), ( __param(9, IUserInteractionService))], View));
