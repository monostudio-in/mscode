...
class DecorationCSSRules {
    ...
    getCSSTextForModelDecorationContentClassName(opts) {
        ...
        if (typeof opts !== "undefined") {
            ...
            if (typeof opts.contentIconPath !== "undefined") {
                cssTextArr.push(
                    format(_CSS_MAP.contentIconPath, asCSSUrl(URI.revive(opts.contentIconPath)))
                );
            }
    ...
    getCSSTextForModelDecorationGlyphMarginClassName(opts) {
        ...
        if (typeof opts.gutterIconPath !== "undefined") {
            cssTextArr.push(
                format(_CSS_MAP.gutterIconPath, asCSSUrl(URI.revive(opts.gutterIconPath)))
            );
