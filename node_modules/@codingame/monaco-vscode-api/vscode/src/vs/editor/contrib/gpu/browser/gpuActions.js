...
class DebugEditorGpuRendererAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1227, "Developer: Debug Editor GPU Renderer")),
    ...
    async run(accessor, editor) {
        ...
        const choice = await quickInputService.pick([{
            label: ( localize(1228, "Log Texture Atlas Stats")),
            id: "logTextureAtlasStats"
        }, {
            label: ( localize(1229, "Save Texture Atlas")),
            id: "saveTextureAtlas"
        }, {
            label: ( localize(1230, "Draw Glyph")),
            id: "drawGlyph"
        }], {
            canPickMany: false
        });
