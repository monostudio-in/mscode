...
const suggestMoreInfoIcon = registerIcon("suggest-more-info", Codicon.chevronRight, ( localize(1624, "Icon for more information in the suggest widget.")));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = ( localize(1625, "Read More"));
        const configureFont = () => {
