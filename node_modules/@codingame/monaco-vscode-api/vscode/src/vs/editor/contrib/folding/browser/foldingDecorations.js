...
registerColor("editorGutter.foldingControlForeground", iconForeground, ( localize(1137, "Color of the folding control in the editor gutter.")));
const foldingExpandedIcon = registerIcon("folding-expanded", Codicon.chevronDown, ( localize(1138, "Icon for expanded ranges in the editor glyph margin.")));
const foldingCollapsedIcon = registerIcon("folding-collapsed", Codicon.chevronRight, ( localize(1139, "Icon for collapsed ranges in the editor glyph margin.")));
const foldingManualCollapsedIcon = registerIcon("folding-manual-collapsed", foldingCollapsedIcon, ( localize(1140, "Icon for manually collapsed ranges in the editor glyph margin.")));
const foldingManualExpandedIcon = registerIcon("folding-manual-expanded", foldingExpandedIcon, ( localize(1141, "Icon for manually expanded ranges in the editor glyph margin.")));
const foldedBackgroundMinimap = {
    color: themeColorFromId(foldBackground),
    position: MinimapPosition.Inline
};
const collapsed = ( localize(1142, "Click to expand the range."));
const expanded = ( localize(1143, "Click to collapse the range."));
