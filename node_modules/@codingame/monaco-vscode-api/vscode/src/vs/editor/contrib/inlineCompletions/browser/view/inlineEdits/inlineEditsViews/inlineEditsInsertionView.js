...
let InlineEditsInsertionView = class InlineEditsInsertionView extends Disposable {
    constructor(_editor, _input, _tabAction, instantiationService, _languageService) {
        ...
        this.originalLines = ( this._state.map(s => s ? ( new LineRange(
            s.lineNumber,
        ...
        this._ghostTextView = this._register(
            instantiationService.createInstance(GhostTextView, this._editor, derived(reader => {
...
InlineEditsInsertionView = ( __decorate([( __param(3, IInstantiationService)), ( __param(4, ILanguageService))], InlineEditsInsertionView));
