...
class ShowNextInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1305, "Show Next Inline Suggestion")),
...
class ShowPreviousInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1306, "Show Previous Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
...
class TriggerInlineSuggestionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1307, "Trigger Inline Suggestion")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize(1308, "Triggers an inline suggestion in the editor.")),
                args: [{
                    name: "args",
                    description: ( localize(1309, "Options for triggering inline suggestions.")),
                    isOptional: true,
        ...
        if (validatedArgs?.showNoResultNotification) {
            if (!controller?.model.get()?.state.get()) {
                notificationService.notify({
                    ...
                    message: ( localize(1310, "No inline suggestion is available."))
                });
            }
        }
    }
...
class AcceptNextWordOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1311, "Accept Next Word Of Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
            ...
            menuOpts: [{
                ...
                title: ( localize(1312, "Accept Word")),
                group: "primary",
                order: 2
            }]
        });
...
class AcceptNextLineOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1313, "Accept Next Line Of Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
            ...
            menuOpts: [{
                menuId: MenuId.InlineSuggestionToolbar,
                title: ( localize(1314, "Accept Line")),
                group: "secondary",
                order: 2
            }]
        });
...
class AcceptInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1315, "Accept Inline Suggestion")),
...
class AcceptInlineCompletionAlternativeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1317, "Accept Inline Suggestion Alternative Action")),
            precondition: ( ContextKeyExpr.and(
...
class JumpToNextInlineEdit extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1318, "Jump to next inline edit")),
            precondition: InlineCompletionContextKeys.inlineEditVisible,
            menuOpts: [{
                menuId: MenuId.InlineEditsActions,
                title: ( localize(1319, "Jump")),
                group: "primary",
                order: 1,
...
class HideInlineCompletion extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1320, "Hide Inline Suggestion")),
            precondition: ( ContextKeyExpr.or(
                InlineCompletionContextKeys.inlineSuggestionVisible,
                InlineCompletionContextKeys.inlineEditVisible
            )),
...
class ToggleInlineCompletionShowCollapsed extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1322, "Toggle Inline Suggestions Show Collapsed")),
...
class ToggleAlwaysShowInlineSuggestionToolbar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize(1323, "Always Show Toolbar")),
            f1: false,
...
class DevExtractReproSample extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1324, "Developer: Extract Inline Suggest State")),
