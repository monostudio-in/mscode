        ...
        if (this.editor.hasModel()) {
            ...
            this.editor.changeDecorations(accessor => {
                ...
                this.decorationId = accessor.addDecoration(Selection.fromPositions(position, position), {
                    ...
                    hoverMessage: ( new MarkdownString()).appendText(( localize(933, "Selection Anchor"))),
                    className: "selection-anchor"
                });
            });
            this.selectionAnchorSetContextKey.set(!!this.decorationId);
            alert(( localize(934, "Anchor set at {0}:{1}", position.lineNumber, position.column)));
        }
    }
    goToSelectionAnchor() {
...
class SetSelectionAnchor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(935, "Set Selection Anchor")),
...
class GoToSelectionAnchor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(936, "Go to Selection Anchor")),
...
class SelectFromAnchorToCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(937, "Select from Anchor to Cursor")),
            precondition: SelectionAnchorSet,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class CancelSelectionAnchor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(938, "Cancel Selection Anchor")),
            precondition: SelectionAnchorSet,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
