...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1378, "Copy Line Up")),
            ...
            menuOpts: {
                ...
                group: "2_line",
                title: ( localize(1379, "&&Copy Line Up")),
                order: 1
            },
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1380, "Copy Line Down")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1381, "Co&&py Line Down")),
                order: 2
            },
            canTriggerInlineEdits: true
        });
...
class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1382, "Duplicate Selection")),
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1383, "&&Duplicate Selection")),
                order: 5
            },
            canTriggerInlineEdits: true
        });
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1384, "Move Line Up")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1385, "Mo&&ve Line Up")),
                order: 3
            },
            canTriggerInlineEdits: true
        });
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1386, "Move Line Down")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: "2_line",
                title: ( localize(1387, "Move &&Line Down")),
                order: 4
            },
            canTriggerInlineEdits: true
        });
...
class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1388, "Sort Lines Ascending")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1389, "Sort Lines Descending")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1390, "Delete Duplicate Lines")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class ReverseLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1391, "Reverse lines")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1392, "Trim Trailing Whitespace")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1393, "Delete Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
...
class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1394, "Indent Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1395, "Outdent Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineBeforeAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1396, "Insert Line Above")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineAfterAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1397, "Insert Line Below")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: "deleteAllLeft",
            label: ( localize2(1398, "Delete All Left")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: "deleteAllRight",
            label: ( localize2(1399, "Delete All Right")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1400, "Join Lines")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
...
class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1401, "Transpose Characters around the Cursor")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize2(1402, "Transform to Uppercase")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize2(1403, "Transform to Lowercase")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1404, "Transform to Title Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1405, "Transform to Snake Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1406, "Transform to Camel Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1407, "Transform to Pascal Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1408, "Transform to Kebab Case")),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
