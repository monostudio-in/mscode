...
const Context = {
    ...
    HasFocusedSuggestion: ( new RawContextKey("suggestWidgetHasFocusedSuggestion", false, ( localize(1588, "Whether any suggestion is focused")))),
    DetailsVisible: ( new RawContextKey("suggestWidgetDetailsVisible", false, ( localize(1589, "Whether suggestion details are visible")))),
    DetailsFocused: ( new RawContextKey("suggestWidgetDetailsFocused", false, ( localize(1590, "Whether the details pane of the suggest widget has focus")))),
    MultipleSuggestions: ( new RawContextKey("suggestWidgetMultipleSuggestions", false, ( localize(1591, "Whether there are multiple suggestions to pick from")))),
    ...
    AcceptSuggestionsOnEnter: ( new RawContextKey("acceptSuggestionOnEnter", true, ( localize(1593, "Whether suggestions are inserted when pressing Enter")))),
    HasInsertAndReplaceRange: ( new RawContextKey("suggestionHasInsertAndReplaceRange", false, ( localize(1594, "Whether the current suggestion has insert and replace behaviour")))),
    InsertMode: ( new RawContextKey("suggestionInsertMode", undefined, {
        type: "string",
        description: ( localize(1595, "Whether the default behaviour is to insert or replace"))
    })),
    CanResolve: ( new RawContextKey("suggestionCanResolve", false, ( localize(1596, "Whether the current suggestion supports to resolve further details"))))
};
