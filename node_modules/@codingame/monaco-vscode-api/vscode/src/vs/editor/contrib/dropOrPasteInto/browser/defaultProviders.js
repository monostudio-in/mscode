...
class DefaultTextPasteOrDropEditProvider extends SimplePasteAndDropProvider {
    ...
    async getEdit(dataTransfer, _token) {
        ...
        return {
            ...
            title: ( localize(1056, "Insert Plain Text")),
            insertText,
            kind: this.kind
        };
    }
...
class PathProvider extends SimplePasteAndDropProvider {
    ...
    async getEdit(dataTransfer, token) {
        ...
        let label;
        if (uriCount > 0) {
            label = entries.length > 1 ? ( localize(1057, "Insert Uris")) : ( localize(1058, "Insert Uri"));
        } else {
            label = entries.length > 1 ? ( localize(1059, "Insert Paths")) : ( localize(1060, "Insert Path"));
        }
        return {
...
let RelativePathProvider = class RelativePathProvider extends SimplePasteAndDropProvider {
    ...
    async getEdit(dataTransfer, token) {
        ...
        return {
            ...
            title: entries.length > 1 ? ( localize(1061, "Insert Relative Paths")) : ( localize(1062, "Insert Relative Path")),
            kind: this.kind
        };
    }
};
    ...
    async provideDocumentPasteEdits(_model, _ranges, dataTransfer, context, token) {
        ...
        return {
            ...
            edits: [{
                ...
                title: ( localize(1063, "Insert HTML")),
                kind: this.kind
            }]
        };
    }
