...
let InlineEditsCollapsedView = class InlineEditsCollapsedView extends Disposable {
    constructor(_editor, _edit, _accessibilityService) {
        ...
        }, [[this.getCollapsedIndicator(startPoint)]]).keepUpdated(this._store).element;
...
InlineEditsCollapsedView = ( __decorate([( __param(2, IAccessibilityService))], InlineEditsCollapsedView));
