...
const dropWidgetVisibleCtx = ( new RawContextKey("dropWidgetVisible", false, ( localize(1064, "Whether the drop widget is showing"))));
let DropIntoEditorController = class DropIntoEditorController extends Disposable {
    ...
    constructor(
        ...
        this._postDropWidgetManager = this._register(
            instantiationService.createInstance(PostEditWidgetManager, "dropIntoEditor", editor, dropWidgetVisibleCtx, {
                ...
                label: ( localize(1065, "Show drop options..."))
    ...
    async onDropIntoEditor(editor, position, dragEvent) {
        ...
        this._dropProgressManager.showWhile(position, ( localize(1066, "Running drop handlers. Click to cancel")), p, {
            cancel: () => p.cancel()
        });
