    ...
    openLinkOccurrence(occurrence, openToSide, fromUserGesture = false) {
        ...
        link.resolve(CancellationToken.None).then(uri => {
            ...
            if (messageOrError === "invalid") {
                ...
                this.notificationService.warn(( localize(1412, "Failed to open this link because its target is missing.")));
            } else {
                onUnexpectedError(err);
            }
        });
...
function getHoverMessage(link, useMetaKey) {
    ...
    const label = link.tooltip ? link.tooltip : executeCmd ? ( localize(1413, "Execute command")) : ( localize(1414, "Follow link"));
    const kb = useMetaKey ? isMacintosh ? ( localize(1415, "cmd + click")) : ( localize(1416, "ctrl + click")) : isMacintosh ? ( localize(1417, "option + click")) : ( localize(1418, "alt + click"));
    if (link.url) {
        let nativeLabel = "";
        if (/^command:/i.test(( link.url.toString()))) {
            ...
            if (match) {
                ...
                nativeLabel = ( localize(1419, "Execute command {0}", commandId));
            }
        }
...
class OpenLinkAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1420, "Open Link")),
