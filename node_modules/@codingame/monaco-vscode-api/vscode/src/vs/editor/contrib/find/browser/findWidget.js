...
const findCollapsedIcon = registerIcon("find-collapsed", Codicon.chevronRight, ( localize(1086, "Icon to indicate that the editor find widget is collapsed.")));
const findExpandedIcon = registerIcon("find-expanded", Codicon.chevronDown, ( localize(1087, "Icon to indicate that the editor find widget is expanded.")));
const findSelectionIcon = registerIcon("find-selection", Codicon.selection, ( localize(1088, "Icon for 'Find in Selection' in the editor find widget.")));
const findReplaceIcon = registerIcon("find-replace", Codicon.replace, ( localize(1089, "Icon for 'Replace' in the editor find widget.")));
const findReplaceAllIcon = registerIcon("find-replace-all", Codicon.replaceAll, ( localize(1090, "Icon for 'Replace All' in the editor find widget.")));
const findPreviousMatchIcon = registerIcon("find-previous-match", Codicon.arrowUp, ( localize(1091, "Icon for 'Find Previous' in the editor find widget.")));
const findNextMatchIcon = registerIcon("find-next-match", Codicon.arrowDown, ( localize(1092, "Icon for 'Find Next' in the editor find widget.")));
const NLS_FIND_DIALOG_LABEL = ( localize(1093, "Find / Replace"));
const NLS_FIND_INPUT_LABEL = ( localize(1094, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(1095, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(1096, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(1097, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(1098, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(1099, "Close"));
const NLS_REPLACE_INPUT_LABEL = ( localize(1100, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(1101, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(1102, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(1103, "Replace All"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(1104, "Toggle Replace"));
...
const NLS_MATCHES_LOCATION = ( localize(1106, "{0} of {1}"));
const NLS_NO_RESULTS = ( localize(1107, "No results"));
...
class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        ...
        if (label === NLS_NO_RESULTS) {
            result = searchString === "" ? ( localize(1108, "{0} found", label)) : ( localize(1109, "{0} found for '{1}'", label, searchString));
            ...
            result = ( localize(1111, "{0} found for '{1}'", label, searchString));
        }
        return result;
    }
    ...
    _updateFindInputAriaLabel() {
        ...
        if (!this._accessibilityHelpHintAnnounced && this._configurationService.getValue("accessibility.verbosity.find") && this._accessibilityService.isScreenReaderOptimized()) {
            ...
            if (accessibilityHelpKeybinding) {
                const hint = ( localize(1112, "Press {0} for accessibility help", accessibilityHelpKeybinding));
                findLabel = ( localize(1113, "{0}, {1}", findLabel, hint));
                replaceLabel = ( localize(1114, "{0}, {1}", replaceLabel, hint));
            }
