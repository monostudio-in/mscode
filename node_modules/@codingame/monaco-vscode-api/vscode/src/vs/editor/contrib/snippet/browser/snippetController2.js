...
let SnippetController2 = class SnippetController2 {
    ...
    static {
        this.InSnippetMode = ( new RawContextKey("inSnippetMode", false, ( localize(1535, "Whether the editor in current in snippet mode"))));
    }
    static {
        this.HasNextTabstop = ( new RawContextKey("hasNextTabstop", false, ( localize(1536, "Whether there is a next tab stop when in snippet mode"))));
    }
    static {
        this.HasPrevTabstop = ( new RawContextKey("hasPrevTabstop", false, ( localize(1537, "Whether there is a previous tab stop when in snippet mode"))));
    }
    constructor(
        _editor,
        _logService,
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: {
                                ...
                                title: ( localize(1538, "Go to next placeholder..."))
                            }
                        });
                    }
                    return {
