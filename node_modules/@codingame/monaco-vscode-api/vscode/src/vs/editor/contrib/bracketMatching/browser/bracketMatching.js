...
const overviewRulerBracketMatchForeground = registerColor("editorOverviewRuler.bracketMatchForeground", "#A0A0A0", ( localize(939, "Overview ruler marker color for matching brackets.")));
class JumpToBracketAction extends EditorAction {
    constructor() {
        super({
            id: "editor.action.jumpToBracket",
            label: ( localize2(940, "Go to Bracket")),
...
class SelectToBracketAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(941, "Select to Bracket")),
            precondition: undefined,
            metadata: {
                description: ( localize2(942, "Select the text inside and including the brackets or curly braces")),
                args: [{
                    name: "args",
                    schema: {
                        type: "object",
...
class RemoveBracketsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(943, "Remove Brackets")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: "editor.action.jumpToBracket",
        title: ( localize(944, "Go to &&Bracket"))
    },
    order: 2
});
