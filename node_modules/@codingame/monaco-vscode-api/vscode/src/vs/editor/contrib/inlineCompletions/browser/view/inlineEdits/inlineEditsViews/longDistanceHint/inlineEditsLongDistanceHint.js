...
import { observeColor, inlineEditIndicatorSuccessfulBackground, inlineEditIndicatorPrimaryBackground, inlineEditIndicatorSecondaryBackground, getEditorBlendedColor, getEditorBackgroundColor } from '../../theme.js';
import { asCssVariable } from '../../../../../../../../platform/theme/common/colorUtils.js';
import { descriptionForeground } from '../../../../../../../../platform/theme/common/colors/baseColors.js';
import '../../../../../../../../platform/theme/common/colors/chartsColors.js';
import { editorWidgetBackground, editorWidgetBorder } from '../../../../../../../../platform/theme/common/colors/editorColors.js';
    ...
    constructor(
        ...
        this._view = n.div({
            ...
            style: {
                ...
                display: derived(
                    this,
                    reader => !!this._previewEditorLayoutInfo.read(reader) ? "block" : "none"
                )
            }
        ...
        this._widgetContent = derived(
            ...
            reader => n.div({
                ...
                style: {
                    ...
                    border: derived(
                        reader => `${this._previewEditorLayoutInfo.read(reader)?.widgetBorder}px solid ${this._styles.read(reader).border}`
                    ),
                    display: "flex",
            ...
            derived(this, r => this._previewEditor.element)]), n.div({
                class: "bar",
                style: {
        ...
        this._previewEditor = this._register(
            this._instantiationService.createInstance(LongDistancePreviewEditor, this._previewTextModel, derived(reader => {
                const viewState = this._viewState.read(reader);
                if (!viewState) {
                    return undefined;
                }
...
InlineEditsLongDistanceHint = ( __decorate([( __param(4, IInstantiationService)), ( __param(5, IThemeService)), ( __param(6, IKeybindingService)), ( __param(7, IModelService)), ( __param(8, ILanguageService))], InlineEditsLongDistanceHint));
...
function scrollToReveal(currentScrollPosition, windowWidth, contentRangeToReveal) {
    ...
    if (contentRangeToReveal.length > windowWidth) {
        return {
            newScrollPosition: contentRangeToReveal.start
        };
    }
