    ...
    replaceAll() {
        if (this._model) {
            if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
                this._notificationService.warn(( localize(1070, "The file is too large to perform a replace all operation.")));
                return false;
            }
...
class StartFindWithArgsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1073, "Find with Arguments")),
...
class StartFindWithSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1074, "Find with Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: null,
                primary: 0,
    ...
    if (!runMatch()) {
        ...
        if (!runMatch()) {
            ...
            if (wasFindWidgetVisible && state.matchesCount === 0 && state.searchString) {
                alert(( localize(1075, "{0} found for '{1}'", NLS_NO_RESULTS, state.searchString)));
            }
        }
    }
}
const NextMatchFindAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localize2(1076, "Find Next")),
    precondition: undefined,
    kbOpts: [{
...
const PreviousMatchFindAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localize2(1077, "Find Previous")),
    precondition: undefined,
    kbOpts: [{
        kbExpr: EditorContextKeys.focus,
...
class MoveToMatchFindAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1078, "Go to Match...")),
    ...
    run(accessor, editor) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: ( localize(1079, "No matches. Try searching for something else."))
            });
            return;
        }
...
class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize2(1082, "Find Next Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize2(1083, "Find Previous Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
