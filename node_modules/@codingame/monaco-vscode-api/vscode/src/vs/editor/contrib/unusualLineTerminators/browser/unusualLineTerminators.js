    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: ( localize(1690, "Unusual Line Terminators")),
                message: ( localize(1691, "Detected unusual line terminators")),
                detail: ( localize(
                    1692,
                ...
                primaryButton: ( localize(1693, "&&Remove Unusual Line Terminators")),
                cancelButton: ( localize(1694, "Ignore"))
            });
        } finally {
            this._isPresentingDialog = false;
        }
