...
import { IChatToolOutputStateCache } from './vscode/src/vs/workbench/contrib/chat/browser/widget/chatContentParts/toolInvocationParts/chatToolOutputStateCache.service.js';
...
import { CustomizationHarness } from './vscode/src/vs/workbench/contrib/chat/common/customizationHarnessService.js';
...
import { IInlineChatHistoryService } from './vscode/src/vs/workbench/contrib/inlineChat/browser/inlineChatHistoryService.service.js';
...
class LanguageModelsService {
    constructor() {
        ...
        this.onDidChangeLanguageModelVendors = () => Disposable.None;
...
class LanguageModelToolsService {
    constructor() {
        ...
        this.vscodeToolSet = new ToolSet('vscode', VSCodeToolReference.vscode, Codicon.tools, ToolDataSource.Internal, undefined, undefined, new FakeContextKeyService());
        this.executeToolSet = new ToolSet('execute', VSCodeToolReference.vscode, Codicon.terminal, ToolDataSource.Internal, undefined, undefined, new FakeContextKeyService());
        this.readToolSet = new ToolSet('read', VSCodeToolReference.vscode, Codicon.eye, ToolDataSource.Internal, undefined, undefined, new FakeContextKeyService());
        this.agentToolSet = new ToolSet('read', VSCodeToolReference.vscode, Codicon.eye, ToolDataSource.Internal, undefined, undefined, new FakeContextKeyService());
...
class ChatEntitlementsService {
    constructor() {
        ...
        this.previewFeaturesDisabled = true;
...
class ChatSessionsService {
    constructor() {
        ...
        this.registerSessionResourceAlias = async () => { };
...
class ChatToolOutputStateCache {
    constructor() {
        this.get = () => undefined;
        this.set = () => { };
    }
...
class PluginInstallService {
    constructor() {
        ...
        this.installPluginFromValidatedSource = unsupported;
...
__decorate([
    Unsupported
], PluginInstallService.prototype, "installPluginFromValidatedSource", void 0);
__decorate([
    Unsupported
...
class CustomizationHarnessService {
    constructor() {
        this.activeHarness = constObservable(CustomizationHarness.VSCode);
        this.availableHarnesses = constObservable([]);
        this.setActiveHarness = unsupported;
        this.getStorageSourceFilter = unsupported;
...
__decorate([
    Unsupported
], CustomizationHarnessService.prototype, "setActiveHarness", void 0);
__decorate([
    Unsupported
], CustomizationHarnessService.prototype, "getStorageSourceFilter", void 0);
__decorate([
    Unsupported
...
class InlineChatHistoryService {
    constructor() {
        ...
        this.isAtEnd = () => true;
        this.replaceLast = unsupported;
        this.resetCursor = unsupported;
    }
}
__decorate([
    Unsupported
], InlineChatHistoryService.prototype, "addToHistory", void 0);
__decorate([
    Unsupported
], InlineChatHistoryService.prototype, "replaceLast", void 0);
__decorate([
    Unsupported
], InlineChatHistoryService.prototype, "resetCursor", void 0);
...
class BrowserViewWorkbenchService {
    constructor() {
        this.getOrCreateBrowserViewModel = unsupported;
        this.getBrowserViewModel = unsupported;
...
__decorate([
    Unsupported
], BrowserViewWorkbenchService.prototype, "getOrCreateBrowserViewModel", void 0);
__decorate([
    Unsupported
], BrowserViewWorkbenchService.prototype, "getBrowserViewModel", void 0);
__decorate([
    Unsupported
