...
import { $ as $$1, getWindow, addDisposableListener, isHTMLElement, prepend, append, getActiveElement, getDomNodeZoomLevel, EventType } from '../../../base/browser/dom.js';
...
let HoverWidget = class HoverWidget extends Widget {
    ...
    constructor(
        ...
        if (options.appearance?.showHoverHint) {
            ...
            infoElement.textContent = ( localize(1988, "Hold {0} key to mouse over", isMacintosh ? "Option" : "Alt"));
