...
configurationRegistry.registerConfiguration({
    id: "workbench",
    order: 7,
    title: ( localize(2001, "Workbench")),
    type: "object",
    properties: {
        [multiSelectModifierSettingKey]: {
            type: "string",
            enum: ["ctrlCmd", "alt"],
            markdownEnumDescriptions: [( localize(2002, "Maps to `Control` on Windows and Linux and to `Command` on macOS.")), ( localize(2003, "Maps to `Alt` on Windows and Linux and to `Option` on macOS."))],
            default: "ctrlCmd",
        ...
        [scrollByPageKey]: {
            type: "boolean",
            default: false,
            description: ( localize(2007, "Controls whether clicks in the scrollbar scroll page by page."))
        },
        [treeIndentKey]: {
            type: "number",
            default: 8,
            minimum: 4,
            maximum: 40,
            description: ( localize(2008, "Controls tree indentation in pixels."))
        },
        [treeRenderIndentGuidesKey]: {
            type: "string",
            enum: ["none", "onHover", "always"],
            default: "onHover",
            description: ( localize(2009, "Controls whether the tree should render indent guides."))
        },
        [listSmoothScrolling]: {
            type: "boolean",
            default: false,
            description: ( localize(2010, "Controls whether lists and trees have smooth scrolling."))
        },
        ...
        [fastScrollSensitivityKey]: {
            type: "number",
            default: 5,
            markdownDescription: ( localize(2012, "Scrolling speed multiplier when pressing `Alt`."))
        },
        [defaultFindModeSettingKey]: {
            ...
            )), ( localize(2014, "Filter elements when searching."))],
            default: "highlight",
            description: ( localize(
                2015,
        ...
        [defaultFindMatchTypeSettingKey]: {
            ...
            enumDescriptions: [( localize(2021, "Use fuzzy matching when searching.")), ( localize(2022, "Use contiguous matching when searching."))],
            default: "fuzzy",
            description: ( localize(
                2023,
        ...
        [treeStickyScroll]: {
            type: "boolean",
            default: true,
            description: ( localize(2025, "Controls whether sticky scrolling is enabled in trees."))
        },
