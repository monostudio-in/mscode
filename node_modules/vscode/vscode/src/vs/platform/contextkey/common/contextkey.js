...
const errorEmptyString = ( localize(1816, "Empty context key expression"));
...
const errorNoInAfterNot = ( localize(1818, "'in' after 'not'."));
const errorClosingParenthesis = ( localize(1819, "closing parenthesis ')'"));
const errorUnexpectedToken = ( localize(1820, "Unexpected token"));
const hintUnexpectedToken = ( localize(1821, "Did you forget to put && or || before the token?"));
const errorUnexpectedEOF = ( localize(1822, "Unexpected end of expression"));
const hintUnexpectedEOF = ( localize(1823, "Did you forget to put a context key?"));
class Parser {
    static {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = ( localize(1824, "Expected: {0}\nReceived: '{1}'.", expected, Scanner.getLexeme(got)));
    ...
    return (whenClauses.map(whenClause => {
        ...
        if (parser.lexingErrors.length > 0) {
            return (parser.lexingErrors.map(se => ({
                errorMessage: se.additionalInfo ? ( localize(1825, "Unexpected token. Hint: {0}", se.additionalInfo)) : ( localize(1826, "Unexpected token.")),
                offset: se.offset,
