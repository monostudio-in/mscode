...
const listHoverBackground = registerColor("list.hoverBackground", {
    ...
    hcLight: ( ( Color.fromHex("#0F4A85")).transparent(0.1))
}, ( localize(2346, "List/Tree background when hovering over items using the mouse.")));
const listHoverForeground = registerColor("list.hoverForeground", null, ( localize(2347, "List/Tree foreground when hovering over items using the mouse.")));
...
const listErrorForeground = registerColor("list.errorForeground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(2353, "Foreground color of list items containing errors.")));
const listWarningForeground = registerColor("list.warningForeground", {
    dark: "#CCA700",
    light: "#855F00",
    hcDark: null,
    hcLight: null
}, ( localize(2354, "Foreground color of list items containing warnings.")));
...
}, ( localize(2355, "Background color of the type filter widget in lists and trees.")));
const listFilterWidgetOutline = registerColor("listFilterWidget.outline", {
    dark: Color.transparent,
    light: Color.transparent,
    hcDark: "#f38518",
    hcLight: "#007ACC"
}, ( localize(2356, "Outline color of the type filter widget in lists and trees.")));
...
const listFilterWidgetShadow = registerColor("listFilterWidget.shadow", widgetShadow, ( localize(2358, "Shadow color of the type filter widget in lists and trees.")));
const listFilterMatchHighlight = registerColor("list.filterMatchBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(2359, "Background color of the filtered match.")));
const listFilterMatchHighlightBorder = registerColor("list.filterMatchBorder", {
    ...
    hcDark: contrastBorder,
    hcLight: activeContrastBorder
}, ( localize(2360, "Border color of the filtered match.")));
const listDeemphasizedForeground = registerColor("list.deemphasizedForeground", {
    dark: "#8C8C8C",
    light: "#8E8E90",
    hcDark: "#A7A8A9",
    hcLight: "#666666"
}, ( localize(2361, "List/Tree foreground color for items that are deemphasized.")));
const treeIndentGuidesStroke = registerColor("tree.indentGuidesStroke", {
    dark: "#585858",
    light: "#a9a9a9",
    hcDark: "#a9a9a9",
    hcLight: "#a5a5a5"
}, ( localize(2362, "Tree stroke color for the indentation guides.")));
const treeInactiveIndentGuidesStroke = registerColor("tree.inactiveIndentGuidesStroke", ( transparent(treeIndentGuidesStroke, 0.4)), ( localize(2363, "Tree stroke color for the indentation guides that are not active.")));
const tableColumnsBorder = registerColor("tree.tableColumnsBorder", {
    dark: "#CCCCCC20",
    light: "#61616120",
    hcDark: null,
    hcLight: null
}, ( localize(2364, "Table border color between columns.")));
const tableOddRowsBackgroundColor = registerColor("tree.tableOddRowsBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(2365, "Background color for odd table rows.")));
registerColor("editorActionList.background", editorWidgetBackground, ( localize(2366, "Action List background color.")));
const editorActionListForeground = registerColor("editorActionList.foreground", editorWidgetForeground, ( localize(2367, "Action List foreground color.")));
registerColor(
    "editorActionList.focusForeground",
    listActiveSelectionForeground,
    ( localize(2368, "Action List foreground color for the focused item."))
);
registerColor(
    "editorActionList.focusBackground",
    listActiveSelectionBackground,
    ( localize(2369, "Action List background color for the focused item."))
);
