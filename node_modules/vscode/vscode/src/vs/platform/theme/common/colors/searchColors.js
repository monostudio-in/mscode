...
registerColor("search.resultsInfoForeground", {
    ...
    hcDark: foreground,
    hcLight: foreground
}, ( localize(2413, "Color of the text in the search viewlet's completion message.")));
...
}, ( localize(2414, "Color of the Search Editor query matches.")));
...
}, ( localize(2415, "Border color of the Search Editor query matches.")));
