...
const pickerGroupForeground = registerColor("pickerGroup.foreground", {
    ...
    hcDark: Color.white,
    hcLight: "#0F4A85"
}, ( localize(2407, "Quick picker color for grouping labels.")));
const pickerGroupBorder = registerColor("pickerGroup.border", {
    dark: "#3F3F46",
    light: "#CCCEDB",
    hcDark: Color.white,
    hcLight: "#0F4A85"
}, ( localize(2408, "Quick picker color for grouping borders.")));
const _deprecatedQuickInputListFocusBackground = registerColor("quickInput.list.focusBackground", null, "", undefined, ( localize(2409, "Please use quickInputList.focusBackground instead")));
const quickInputListFocusForeground = registerColor(
    "quickInputList.focusForeground",
    listActiveSelectionForeground,
    ( localize(2410, "Quick picker foreground color for the focused item."))
);
const quickInputListFocusIconForeground = registerColor(
    "quickInputList.focusIconForeground",
    listActiveSelectionIconForeground,
    ( localize(2411, "Quick picker icon foreground color for the focused item."))
);
const quickInputListFocusBackground = registerColor("quickInputList.focusBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(2412, "Quick picker background color for the focused item.")));
