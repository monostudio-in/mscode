...
const ExtensionsLocalizedLabel = ( localize2(1867, "Extensions"));
const PreferencesLocalizedLabel = ( localize2(1868, "Preferences"));
...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    id: "extensions",
    order: 30,
    title: ( localize(1869, "Extensions")),
    type: "object",
    properties: {
        [AllowedExtensionsConfigKey]: {
            ...
            defaultSnippets: [{
                body: {},
                description: ( localize(1871, "No extensions are allowed."))
            }, {
                body: {
                    "*": true
                },
                description: ( localize(1872, "All extensions are allowed."))
            }],
            ...
            patternProperties: {
                "([a-z0-9A-Z][a-z0-9-A-Z]*)\\.([a-z0-9A-Z][a-z0-9-A-Z]*)$": {
                    anyOf: [{
                        ...
                        description: ( localize(1874, "Allow or disallow the extension.")),
                        enumDescriptions: [( localize(1875, "Extension is allowed.")), ( localize(1876, "Extension is not allowed.")), ( localize(1877, "Allow only stable versions of the extension."))]
                    }, {
                        type: "array",
                        items: {
                            type: "string"
                ...
                "([a-z0-9A-Z][a-z0-9-A-Z]*)$": {
                    type: ["boolean", "string"],
                    enum: [true, false, "stable"],
                    description: ( localize(1879, "Allow or disallow all extensions from the publisher.")),
                    enumDescriptions: [( localize(1880, "All extensions from the publisher are allowed.")), ( localize(1881, "All extensions from the publisher are not allowed.")), ( localize(1882, "Allow only stable versions of the extensions from the publisher."))]
                },
                "\\*": {
                    type: "boolean",
                    enum: [true, false],
                    description: ( localize(1883, "Allow or disallow all extensions.")),
                    enumDescriptions: [( localize(1884, "Allow all extensions.")), ( localize(1885, "Disallow all extensions."))]
                }
            }
        }
    }
