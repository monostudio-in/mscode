...
const grammarsExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(16595, "Contributes textmate tokenizers.")),
        type: "array",
        defaultSnippets: [{
            body: [{
                language: "${1:id}",
        ...
        items: {
            ...
            properties: {
                language: {
                    description: ( localize(16596, "Language identifier for which this syntax is contributed to.")),
                    type: "string"
                },
                scopeName: {
                    description: ( localize(16597, "Textmate scope name used by the tmLanguage file.")),
                    type: "string"
                },
                path: {
                ...
                tokenTypes: {
                    description: ( localize(16600, "A map of scope name to token types.")),
                    type: "object",
                ...
                balancedBracketScopes: {
                    description: ( localize(16602, "Defines which scope names contain balanced brackets.")),
                    type: "array",
                    items: {
                        type: "string"
                    },
                ...
                unbalancedBracketScopes: {
                    description: ( localize(16603, "Defines which scope names do not contain balanced brackets.")),
                    type: "array",
                    items: {
                        type: "string"
                    },
