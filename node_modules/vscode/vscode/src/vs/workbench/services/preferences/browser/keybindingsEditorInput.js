...
const KeybindingsEditorIcon = registerIcon("keybindings-editor-label-icon", Codicon.keyboard, ( localize(16496, "Icon of the keybindings editor label.")));
let KeybindingsEditorInput = class KeybindingsEditorInput extends EditorInput {
    ...
    getName() {
        return localize(16497, "Keyboard Shortcuts");
    }
    getIcon() {
