...
const SOURCE_SYSTEM = ( localize(16498, "System"));
const SOURCE_EXTENSION = ( localize(16499, "Extension"));
const SOURCE_USER = ( localize(16500, "User"));
    ...
    static getCommandDefaultLabel(menuCommand) {
        if (!Language.isDefaultVariant()) {
            if (menuCommand && menuCommand.title && menuCommand.title.original) {
                ...
                return category ? ( localize(16501, "{0}: {1}", category, title)) : title;
            }
        }
        return null;
    }
...
class KeybindingItemMatches {
    ...
    wordMatchesAltModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(16502, "option")), word)) {
            return true;
        }
        return false;
    }
    ...
    wordMatchesMetaModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(16503, "meta")), word)) {
            return true;
        }
        return false;
    }
