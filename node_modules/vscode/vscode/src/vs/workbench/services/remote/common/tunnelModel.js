...
const forwardedPortsFeaturesEnabled = ( new RawContextKey("forwardedPortsViewEnabled", false, ( localize(16561, "Whether the Ports view is enabled."))));
const forwardedPortsViewEnabled = ( new RawContextKey("forwardedPortsViewOnlyEnabled", false, ( localize(16561, "Whether the Ports view is enabled."))));
...
const UserTunnelSource = {
    ...
    description: ( localize(16562, "User Forwarded"))
};
const AutoTunnelSource = {
    source: TunnelSource.Auto,
    description: ( localize(16563, "Auto Forwarded"))
};
            ...
            for (const tunnel of tunnels) {
                ...
                this.detected.set(makeAddress(tunnel.remoteAddress.host, tunnel.remoteAddress.port), {
                    ...
                    source: {
                        ...
                        description: ( localize(16565, "Statically Forwarded"))
                    }
                });
