...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: ( localize(16553, "The ID of a Get Started walkthrough to open.")),
            type: "string"
        }
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(16554, "Contributes help information for Remote")),
        type: "object",
        properties: {
            "getStarted": {
            ...
            "feedback": {
                ...
                type: "string",
                markdownDeprecationMessage: ( localize(16558, "Use {0} instead", "`reportIssue`"))
            },
            "reportIssue": {
                description: ( localize(
                    16559,
