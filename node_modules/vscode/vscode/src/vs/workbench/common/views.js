...
const VIEWS_LOG_NAME = ( localize(4326, "Views"));
const defaultViewIcon = registerIcon("default-view-icon", Codicon.window, ( localize(4327, "Default view icon.")));
var Extensions;
(function(Extensions) {
    ...
    addViews(viewDescriptors, viewContainer) {
        ...
        for (const viewDescriptor of viewDescriptors) {
            if (this.getView(viewDescriptor.id) !== null) {
                throw ( new Error(( localize(4328, "A view with id '{0}' is already registered", viewDescriptor.id))));
            }
...
class NoTreeViewError extends Error {
    constructor(treeViewId) {
        super(( localize(4329, "No tree view with id '{0}' registered.", treeViewId)));
...
export { Extensions, NoTreeViewError, ResolvableTreeItem, TreeItemCollapsibleState, VIEWS_LOG_ID, VIEWS_LOG_NAME, ViewContainerLocation, ViewContainerLocationToString, ViewContentGroups, ViewVisibilityState, WindowVisibility, defaultViewIcon };
