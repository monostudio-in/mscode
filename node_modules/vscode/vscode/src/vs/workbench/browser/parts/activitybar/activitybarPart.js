...
let ActivityBarCompositeBar = class ActivityBarCompositeBar extends PaneCompositeBar {
    ...
    getActivityBarContextMenuActions() {
        ...
        const actions = [( new SubmenuAction("workbench.action.activityBar.position", ( localize(3041, "Activity Bar Position")), positionActions))];
        ...
        if (activityBarPosition === ActivityBarPosition.DEFAULT) {
            ...
            const sizeActions = [toAction({
                ...
                label: ( localize(3043, "Compact")),
                checked: isCompact,
                run: () => this.configurationService.updateValue(LayoutSettings.ACTIVITY_BAR_COMPACT, true)
            })];
            actions.push(( new SubmenuAction("workbench.action.activityBar.size", ( localize(3044, "Activity Bar Size")), sizeActions)));
        }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3045, "Move Activity Bar to Side")),
                mnemonicTitle: ( localize(3046, "&&Default"))
            },
            shortTitle: ( localize(3047, "Default")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3048, "Move Activity Bar to Top")),
                mnemonicTitle: ( localize(3049, "&&Top"))
            },
            shortTitle: ( localize(3050, "Top")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3051, "Move Activity Bar to Bottom")),
                mnemonicTitle: ( localize(3052, "&&Bottom"))
            },
            shortTitle: ( localize(3053, "Bottom")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3054, "Hide Activity Bar")),
                mnemonicTitle: ( localize(3055, "&&Hidden"))
            },
            shortTitle: ( localize(3056, "Hidden")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(3057, "Activity Bar Position")),
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3058, "Previous Primary Side Bar View")),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3059, "Next Primary Side Bar View")),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.Sidebar, 1);
    }
...
registerAction2(class FocusActivityBarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3060, "Focus Activity Bar")),
            category: Categories.View,
            f1: true
        });
    }
