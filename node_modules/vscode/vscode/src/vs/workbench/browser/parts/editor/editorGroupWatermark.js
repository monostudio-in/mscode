...
const showCommands = {
    text: ( localize(3481, "Show All Commands")),
    id: "workbench.action.showCommands"
};
const gotoFile = {
    text: ( localize(3482, "Go to File")),
    id: "workbench.action.quickOpen"
};
const openFile = {
    text: ( localize(3483, "Open File")),
    id: "workbench.action.files.openFile"
};
const openFolder = {
    text: ( localize(3484, "Open Folder")),
    id: "workbench.action.files.openFolder"
};
const openFileOrFolder = {
    text: ( localize(3485, "Open File or Folder")),
    id: "workbench.action.files.openFileFolder"
};
const openRecent = {
    text: ( localize(3486, "Open Recent")),
    id: "workbench.action.openRecent"
};
const newUntitledFile = {
    text: ( localize(3487, "New Untitled Text File")),
    id: "workbench.action.files.newUntitledFile"
};
const findInFiles = {
    text: ( localize(3488, "Find in Files")),
    id: "workbench.action.findInFiles"
};
const toggleTerminal = {
    text: ( localize(3489, "Toggle Terminal")),
...
const startDebugging = {
    text: ( localize(3490, "Start Debugging")),
...
const openSettings = {
    text: ( localize(3491, "Open Settings")),
...
EditorGroupWatermark = EditorGroupWatermark_1 = ( __decorate([( __param(1, IKeybindingService)), ( __param(2, IWorkspaceContextService)), ( __param(3, IContextKeyService)), ( __param(4, IConfigurationService)), ( __param(5, IStorageService))], EditorGroupWatermark));
