...
let NotificationsCenter = class NotificationsCenter extends Themable {
    ...
    updateTitle() {
        ...
        if (this.model.notifications.length === 0) {
            notificationsCenterTitle.textContent = ( localize(3622, "No new notifications"));
            clearAllAction.enabled = false;
        } else {
            notificationsCenterTitle.textContent = ( localize(3623, "Notifications"));
    ...
    create() {
        ...
        const notificationsToolBar = this._register(( new ActionBar(toolbarContainer, {
            ariaLabel: ( localize(3624, "Notification Center Actions")),
            actionRunner,
                        ...
                        this.instantiationService.createInstance(DropdownMenuActionViewItem, action, {
                            getActions() {
                                const actions = [toAction({
                                    ...
                                    label: that.notificationService.getFilter() === NotificationsFilter.OFF ? ( localize(3625, "Enable Do Not Disturb Mode")) : ( localize(3626, "Disable Do Not Disturb Mode")),
        ...
        this.notificationsList = this.instantiationService.createInstance(NotificationsList, this.notificationsCenterContainer, {
            widgetAriaLabel: ( localize(3628, "Notifications Center"))
        });
