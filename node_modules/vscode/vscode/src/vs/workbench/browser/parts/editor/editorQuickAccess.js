...
let BaseEditorQuickAccessProvider = class BaseEditorQuickAccessProvider extends PickerQuickAccessProvider {
    constructor(prefix, editorGroupService, editorService, modelService, languageService) {
        super(prefix, {
            ...
            noResultsPick: {
                label: ( localize(3505, "No matching editors")),
                groupId: -1
            }
        });
        ...
        return (this.doGetEditors().map((
            ...
            return {
                ...
                ariaLabel: (() => {
                    ...
                    return isDirty ? ( localize(3508, "{0}, unsaved changes", nameAndDescription)) : nameAndDescription;
                })(),
                description,
                ...
                buttons: (() => {
                    return [{
                        ...
                        tooltip: ( localize(3509, "Close Editor")),
