...
const maximizeIcon = registerIcon("panel-maximize", Codicon.screenFull, ( localize(3676, "Icon to maximize a panel.")));
const closeIcon = registerIcon("panel-close", Codicon.close, ( localize(3677, "Icon to close a panel.")));
const panelIcon = registerIcon("panel-layout-icon", Codicon.layoutPanel, ( localize(3678, "Icon to toggle the panel off when it is on.")));
const panelOffIcon = registerIcon("panel-layout-icon-off", Codicon.layoutPanelOff, ( localize(3679, "Icon to toggle the panel on when it is off.")));
class TogglePanelAction extends Action2 {
    static {
        this.ID = "workbench.action.togglePanel";
    }
    static {
        this.LABEL = ( localize2(3680, "Toggle Panel Visibility"));
    }
    constructor() {
        super({
            ...
            toggled: {
                ...
                title: ( localize(3681, "Hide Panel")),
                icon: closeIcon,
                mnemonicTitle: ( localize(3682, "&&Panel"))
            },
            icon: closeIcon,
            f1: true,
            category: Categories.View,
            metadata: {
                description: ( localize(3683, "Open/Show and Close/Hide Panel"))
            },
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3681, "Hide Panel")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    ...
    static {
        this.LABEL = ( localize(3684, "Focus into Panel"));
    }
    constructor() {
        super({
            id: "workbench.action.focusPanel",
            title: ( localize2(3684, "Focus into Panel")),
            category: Categories.View,
            f1: true
        });
    }
...
const PositionPanelActionConfigs = [createPositionPanelActionConfig(PositionPanelActionId.TOP, ( localize2(3685, "Move Panel To Top")), ( localize(3686, "Top")), Position.TOP), createPositionPanelActionConfig(PositionPanelActionId.LEFT, ( localize2(3687, "Move Panel Left")), ( localize(3688, "Left")), Position.LEFT), createPositionPanelActionConfig(PositionPanelActionId.RIGHT, ( localize2(3689, "Move Panel Right")), ( localize(3690, "Right")), Position.RIGHT), createPositionPanelActionConfig(PositionPanelActionId.BOTTOM, ( localize2(3691, "Move Panel To Bottom")), ( localize(3692, "Bottom")), Position.BOTTOM)];
const AlignPanelActionConfigs = [createAlignmentPanelActionConfig(AlignPanelActionId.LEFT, ( localize2(3693, "Set Panel Alignment to Left")), ( localize(3694, "Left")), "left"), createAlignmentPanelActionConfig(AlignPanelActionId.RIGHT, ( localize2(3695, "Set Panel Alignment to Right")), ( localize(3696, "Right")), "right"), createAlignmentPanelActionConfig(AlignPanelActionId.CENTER, ( localize2(3697, "Set Panel Alignment to Center")), ( localize(3698, "Center")), "center"), createAlignmentPanelActionConfig(AlignPanelActionId.JUSTIFY, ( localize2(3699, "Set Panel Alignment to Justify")), ( localize(3700, "Justify")), "justify")];
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    submenu: MenuId.PanelPositionMenu,
    title: ( localize(3701, "Panel Position")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(3702, "Align Panel")),
    group: "3_workbench_layout_move",
    order: 5
});
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3703, "Previous Panel View")),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3704, "Next Panel View")),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.Panel, 1);
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3705, "Toggle Maximized Panel")),
            tooltip: ( localize(3706, "Maximize Panel")),
            category: Categories.View,
            f1: true,
            icon: maximizeIcon,
            ...
            toggled: {
                ...
                tooltip: ( localize(3707, "Restore Panel"))
            },
            menu: [{
    ...
    run(accessor) {
        ...
        if (layoutService.getPanelAlignment() !== "center" && isHorizontal(layoutService.getPanelPosition())) {
            notificationService.warn(( localize(3708, "Maximizing the panel is only supported when it is center aligned.")));
            return;
        }
        if (!layoutService.isVisible(Parts.PANEL_PART)) {
            layoutService.setPartHidden(false, Parts.PANEL_PART);
...
MenuRegistry.appendMenuItems([{
    ...
    item: {
        ...
        command: {
            id: TogglePanelAction.ID,
            title: ( localize(3709, "Toggle Panel")),
            icon: panelOffIcon,
            toggled: {
                condition: PanelVisibleContext,
                icon: panelIcon
...
class MovePanelToSidePanelAction extends MoveViewsBetweenPanelsAction {
    ...
    constructor() {
        super(ViewContainerLocation.Panel, ViewContainerLocation.AuxiliaryBar, {
            ...
            title: ( localize2(3710, "Move Panel Views To Secondary Side Bar")),
            category: Categories.View,
            f1: false
        });
    }
...
class MoveSidePanelToPanelAction extends MoveViewsBetweenPanelsAction {
    ...
    constructor() {
        super(ViewContainerLocation.AuxiliaryBar, ViewContainerLocation.Panel, {
            ...
            title: ( localize2(3711, "Move Secondary Side Bar Views To Panel")),
            category: Categories.View,
            f1: false
        });
    }
