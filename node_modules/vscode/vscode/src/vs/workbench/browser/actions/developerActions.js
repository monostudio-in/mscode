...
class InspectContextKeysAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2771, "Inspect Context Keys")),
...
class ToggleScreencastModeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2772, "Toggle Screencast Mode")),
            category: Categories.Developer,
            f1: true
        });
    }
...
class LogStorageAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2773, "Log Storage Database Contents")),
            category: Categories.Developer,
            f1: true
        });
    }
    run(accessor) {
        ...
        )), ( localize(2775, "Open developer tools from the menu and select the Console tab.")));
    }
}
class LogWorkingCopiesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2776, "Log Working Copies")),
            category: Categories.Developer,
            f1: true
        });
    }
...
class RemoveLargeStorageEntriesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2777, "Remove Large Storage Database Entries...")),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
                    ...
                    if (value && (!environmentService.isBuilt  || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: ( localize(
                                2778,
                                "Scope: {0}, Target: {1}",
                                scope === StorageScope.APPLICATION ? ( localize(2779, "Global")) : scope === StorageScope.PROFILE ? ( localize(2780, "Profile")) : ( localize(2781, "Workspace")),
                                target === StorageTarget.MACHINE ? ( localize(2782, "Machine")) : ( localize(2783, "User"))
                            ))
                        });
                    }
                }
        ...
        const selectedItems = await ( new Promise(resolve => {
            ...
            picker.customLabel = ( localize(2784, "Remove"));
            picker.placeholder = ( localize(2785, "Select large entries to remove from storage"));
            if (items.length === 0) {
                picker.description = ( localize(2786, "There are no large storage entries to remove."));
            }
            picker.show();
        ...
        const {
            ...
            primaryButton: ( localize(2789, "&&Remove"))
        });
        if (!confirmed) {
            return;
        }
...
class StartTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2790, "Start Tracking Disposables")),
            category: Categories.Developer,
            f1: true,
...
class SnapshotTrackedDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2791, "Snapshot Tracked Disposables")),
            category: Categories.Developer,
            f1: true,
...
class StopTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2792, "Stop Tracking Disposables")),
            category: Categories.Developer,
            f1: true,
...
class PolicyDiagnosticsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2793, "Policy Diagnostics")),
            category: Categories.Developer,
            f1: true
        });
    }
...
class SyncAccountPolicyAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2794, "Sync Account Policy")),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
        ...
        try {
            ...
            await dialogService.info(( localize(2795, "Account policy has been synced.")));
        } catch (error) {
            logService.error("[DefaultAccount] Failed to sync account policy", error);
            await dialogService.error(( localize(2796, "Failed to sync account policy.")), error instanceof Error ? error.message : String(error));
        }
    }
}
...
configurationRegistry.registerConfiguration({
    id: "screencastMode",
    order: 9,
    title: ( localize(2797, "Screencast Mode")),
    type: "object",
    properties: {
        ...
        "screencastMode.keyboardOptions": {
            type: "object",
            description: ( localize(2800, "Options for customizing the keyboard overlay in screencast mode.")),
            properties: {
                "showKeys": {
                    type: "boolean",
                    default: true,
                    description: ( localize(2801, "Show raw keys."))
                },
                "showKeybindings": {
                    type: "boolean",
                    default: true,
                    description: ( localize(2802, "Show keyboard shortcuts."))
                },
                "showCommands": {
                    type: "boolean",
                    default: true,
                    description: ( localize(2803, "Show command names."))
                },
                "showCommandGroups": {
                    type: "boolean",
                    default: false,
                    description: ( localize(2804, "Show command group names, when commands are also shown."))
                },
                "showSingleEditorCursorMoves": {
                    type: "boolean",
                    default: true,
                    description: ( localize(2805, "Show single editor cursor move commands."))
                }
            },
            default: {
                "showKeys": true,
