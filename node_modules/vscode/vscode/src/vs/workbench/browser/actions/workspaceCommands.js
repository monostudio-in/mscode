...
const ADD_ROOT_FOLDER_LABEL = ( localize2(3030, "Add Folder to Workspace..."));
...
async function selectWorkspaceFolders(accessor) {
    ...
    const folders = await dialogsService.showOpenDialog({
        openLabel: mnemonicButtonLabel(( localize(3031, "&&Add"))),
        title: ( localize(3032, "Add Folder to Workspace")),
...
CommandsRegistry.registerCommand(PICK_WORKSPACE_FOLDER_COMMAND_ID, async function(accessor, args) {
    ...
    if (!options.placeHolder) {
        options.placeHolder = ( localize(3033, "Select workspace folder"));
    }
