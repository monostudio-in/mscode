...
class ToggleMultiCursorModifierAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(7907, "Toggle Multi-Cursor Modifier")),
            f1: true
        });
    }
    run(accessor) {
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
    ...
    command: {
        id: ToggleMultiCursorModifierAction.ID,
        title: ( localize(7908, "Switch to Alt+Click for Multi-Cursor"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarSelectionMenu, {
    ...
    command: {
        id: ToggleMultiCursorModifierAction.ID,
        title: (isMacintosh ? ( localize(7909, "Switch to Cmd+Click for Multi-Cursor")) : ( localize(7910, "Switch to Ctrl+Click for Multi-Cursor")))
    },
