        ...
        this.outlineService.createOutline(pane, OutlineTarget.QuickPick, cts.token).then(outline => {
            ...
            const updatePickerItems = () => {
                ...
                if (filteredItems.length === 0) {
                    const label = ( localize(7895, "No matching entries"));
                    picker.items = [{
                        label,
                        index: -1,
...
class GotoSymbolAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(7896, "Go to Symbol in Editor...")),
                mnemonicTitle: ( localize(7897, "Go to &&Symbol in Editor..."))
            },
            f1: true,
            keybinding: {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    placeholder: ( localize(7898, "Type the name of a symbol to go to.")),
    helpEntries: [{
        description: ( localize(7899, "Go to Symbol in Editor")),
        prefix: AbstractGotoSymbolQuickAccessProvider.PREFIX,
        commandId: GotoSymbolAction.ID,
        commandCenterOrder: 40
    }, {
        description: ( localize(7900, "Go to Symbol in Editor by Category")),
