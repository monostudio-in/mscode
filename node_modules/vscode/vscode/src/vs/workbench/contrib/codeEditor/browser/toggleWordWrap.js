...
const EDITOR_WORD_WRAP = ( new RawContextKey("editorWordWrap", false, ( localize(7925, "Whether the editor is currently using word wrapping."))));
...
class ToggleWordWrapAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(7926, "View: Toggle Word Wrap")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(7927, "Disable wrapping for this file")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(7928, "Enable wrapping for this file")),
        icon: Codicon.wordWrap
    },
    group: "navigation",
    order: 1,
