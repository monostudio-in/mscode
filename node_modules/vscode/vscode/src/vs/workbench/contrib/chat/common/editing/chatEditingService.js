...
const chatEditingWidgetFileStateContextKey = ( new RawContextKey("chatEditingWidgetFileState", undefined, ( localize(7383, "The current state of the file in the chat editing widget"))));
