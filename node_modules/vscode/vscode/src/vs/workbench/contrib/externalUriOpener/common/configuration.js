...
const externalUriOpenersConfigurationNode = {
    ...
    properties: {
        [externalUriOpenersSettingId]: {
            type: "object",
            markdownDescription: ( localize(9641, "Configure the opener to use for external URIs (http, https).")),
            defaultSnippets: [{
                body: {
                    "example.com": "$1"
                }
            ...
            additionalProperties: {
                anyOf: [{
                    ...
                    enumDescriptions: [( localize(9643, "Open using VS Code's standard opener."))]
