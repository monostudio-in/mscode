...
(function(TerminalContextKeys) {
    ...
    TerminalContextKeys.focus = ( new RawContextKey(TerminalContextKeyStrings.Focus, false, ( localize(13879, "Whether the terminal is focused."))));
    ...
    TerminalContextKeys.editorFocus = ( new RawContextKey(TerminalContextKeyStrings.EditorFocus, false, ( localize(13881, "Whether a terminal in the editor area is focused."))));
    TerminalContextKeys.count = ( new RawContextKey(TerminalContextKeyStrings.Count, 0, ( localize(13882, "The current number of terminals."))));
    ...
    TerminalContextKeys.tabsFocus = ( new RawContextKey(TerminalContextKeyStrings.TabsFocus, false, ( localize(13883, "Whether the terminal tabs widget is focused."))));
    ...
    TerminalContextKeys.altBufferActive = ( new RawContextKey(TerminalContextKeyStrings.AltBufferActive, false, ( localize(13885, "Whether the terminal's alt buffer is active."))));
    TerminalContextKeys.suggestWidgetVisible = ( new RawContextKey(TerminalContextKeyStrings.SuggestWidgetVisible, false, ( localize(13886, "Whether the terminal's suggest widget is visible."))));
    TerminalContextKeys.notFocus = ( TerminalContextKeys.focus.toNegated());
    TerminalContextKeys.viewShowing = ( new RawContextKey(TerminalContextKeyStrings.ViewShowing, false, ( localize(13887, "Whether the terminal view is showing"))));
    TerminalContextKeys.textSelected = ( new RawContextKey(TerminalContextKeyStrings.TextSelected, false, ( localize(13888, "Whether text is selected in the active terminal."))));
    TerminalContextKeys.textSelectedInFocused = ( new RawContextKey(TerminalContextKeyStrings.TextSelectedInFocused, false, ( localize(13889, "Whether text is selected in a focused terminal."))));
    ...
    TerminalContextKeys.tabsSingularSelection = ( new RawContextKey(TerminalContextKeyStrings.TabsSingularSelection, false, ( localize(13891, "Whether one terminal is selected in the terminal tabs list."))));
    TerminalContextKeys.splitTerminalTabFocused = ( new RawContextKey(TerminalContextKeyStrings.SplitTerminal, false, ( localize(13892, "Whether the focused tab's terminal is a split terminal."))));
    TerminalContextKeys.splitTerminalActive = ( new RawContextKey(TerminalContextKeyStrings.SplitPaneActive, false, ( localize(13893, "Whether the active terminal is a split pane."))));
    TerminalContextKeys.inTerminalRunCommandPicker = ( new RawContextKey(
        TerminalContextKeyStrings.InTerminalRunCommandPicker,
        false,
        ( localize(13894, "Whether the terminal run command picker is currently open."))
    ));
    TerminalContextKeys.terminalShellIntegrationEnabled = ( new RawContextKey(
        ...
        false,
        ( localize(13895, "Whether shell integration is enabled in the active terminal"))
    ));
