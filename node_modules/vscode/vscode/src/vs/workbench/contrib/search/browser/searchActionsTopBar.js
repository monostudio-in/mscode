...
registerAction2(class ClearSearchHistoryCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12760, "Clear Search History")),
            category,
            f1: true
        });
    }
...
registerAction2(class CancelSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12761, "Cancel Search")),
            icon: searchStopIcon,
            category,
            f1: true,
...
registerAction2(class CollapseDeepestExpandedLevelAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12763, "Collapse All")),
            category,
...
registerAction2(class ExpandAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12764, "Expand All")),
            category,
...
registerAction2(class ClearSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12765, "Clear Search Results")),
            category,
...
registerAction2(class ViewAsTreeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12766, "View as Tree")),
            category,
...
registerAction2(class ViewAsListAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12767, "View as List")),
            category,
...
registerAction2(class SearchWithAIAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12768, "Search with AI")),
            category,
            f1: true,
