            ...
            const link = instantiationService.createInstance(Link, div, node, {
                opener: async href => {
                    ...
                    if (parsed.scheme === Schemas.command && message.trusted) {
                        ...
                        if (parsed.scheme === Schemas.command && !message.trusted) {
                            notificationService.error(( localize(12795, "Unable to open command link from untrusted source: {0}", href)));
                        } else {
                            notificationService.error(( localize(12796, "Unable to open unknown link: {0}", href)));
                        }
                    }
                }
            });
