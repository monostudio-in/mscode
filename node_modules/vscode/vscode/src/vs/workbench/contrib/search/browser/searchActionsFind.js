...
registerAction2(class RestrictSearchToFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12725, "Restrict Search to Folder")),
            category,
            keybinding: {
...
registerAction2(class ExpandSelectedTreeCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(12726, "Expand Recursively")),
            category,
            menu: [{
                id: MenuId.SearchContext,
                when: ( ContextKeyExpr.and(
...
registerAction2(class ExcludeFolderFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12727, "Exclude Folder from Search")),
            category,
            menu: [{
                id: MenuId.SearchContext,
                group: "search",
...
registerAction2(class ExcludeFileTypeFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12728, "Exclude File Type from Search")),
            category,
            menu: [{
                id: MenuId.SearchContext,
                group: "search",
...
registerAction2(class IncludeFileTypeInSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12729, "Include File Type from Search")),
            category,
            menu: [{
                id: MenuId.SearchContext,
                group: "search",
...
registerAction2(class RevealInSideBarForSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12730, "Reveal in Explorer View")),
            category,
            menu: [{
                id: MenuId.SearchContext,
                when: ( ContextKeyExpr.and(
...
registerAction2(class FindInFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(12731, "Find in Files")),
                mnemonicTitle: ( localize(12732, "Find &&in Files"))
            },
            metadata: {
                description: ( localize(12733, "Open a workspace search")),
                args: [{
                    name: ( localize(12734, "A set of options for the search")),
                    schema: {
                        type: "object",
                        properties: {
                            query: {
...
registerAction2(class FindInFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12735, "Find in Folder...")),
            category,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class FindInWorkspaceAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(12736, "Find in Workspace...")),
            category,
            menu: [{
                id: MenuId.ExplorerContext,
                group: "4_search",
