...
const manageTrustedDomainSettingsCommand = {
    ...
    description: {
        description: ( localize2(15069, "Manage Trusted Domains")),
        args: []
    },
...
async function configureOpenerTrustedDomainsHandler(
    ...
    options.push({
        type: "item",
        label: ( localize(15070, "Trust {0}", domainToConfigure)),
        id: "trust",
    ...
    if (isIP) {
        if (parsedDomainToConfigure.authority.includes(":")) {
            ...
            options.push({
                type: "item",
                label: ( localize(15071, "Trust {0} on all ports", base)),
                toTrust: base + ":*",
                id: "trust"
            });
        }
        ...
        options.push({
            type: "item",
            label: ( localize(15072, "Trust {0} and all its subdomains", domainEnd)),
    ...
    options.push({
        type: "item",
        label: ( localize(15073, "Trust all domains (disables link protection)")),
        toTrust: "*",
        id: "trust"
    });
    options.push({
        type: "item",
        label: ( localize(15074, "Manage Trusted Domains")),
        id: "manage"
    });
