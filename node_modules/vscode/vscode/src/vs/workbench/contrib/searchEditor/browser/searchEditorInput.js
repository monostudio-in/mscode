...
const SearchEditorIcon = registerIcon("search-editor-label-icon", Codicon.search, ( localize(12910, "Icon of the search editor label.")));
let SearchEditorInput = class SearchEditorInput extends EditorInput {
    ...
    getName(maxLength = 12) {
        ...
        if (query) {
            return localize(12911, "Search: {0}", trimToMax(query));
        }
        return localize(12912, "Search");
    }
    setDirty(dirty) {
