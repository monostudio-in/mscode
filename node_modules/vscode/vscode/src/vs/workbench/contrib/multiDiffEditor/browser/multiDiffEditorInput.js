...
let MultiDiffEditorInput = class MultiDiffEditorInput extends EditorInput {
    ...
    constructor(
        ...
        this._register(autorun(reader => {
            ...
            const label = this.label ?? ( localize(11082, "Multi Diff Editor"));
            if (resources && resources.length === 1) {
                this._name = ( localize(11083, "{0} (1 file)", label));
            } else if (resources) {
                this._name = ( localize(11084, "{0} ({1} files)", label, resources.length));
            } else {
                this._name = label;
            }
