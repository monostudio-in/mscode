...
let ExtensionRecommendationNotificationService = class ExtensionRecommendationNotificationService extends Disposable {
    ...
    async promptImportantExtensionsInstallNotification(extensionRecommendations) {
        ...
        return this.promptRecommendationsNotification({
            ...
            onDidNeverShowRecommendedExtensionsAgain: extensions => {
                ...
                this.notificationService.prompt(Severity$1.Info, ( localize(9084, "Do you want to ignore all extension recommendations?")), [{
                    label: ( localize(9085, "Yes, Ignore All")),
                    run: () => this.setIgnoreRecommendationsConfig(true)
                }, {
                    label: ( localize(9086, "No")),
    ...
    async promptWorkspaceRecommendations(recommendations) {
        ...
        await this.promptRecommendationsNotification({
            ...
            name: ( localize(9087, "this repository"))
        }, {
    ...
    async promptRecommendationsNotification(
        ...
        if (extensions.length === 1) {
            ...
            if (publishers.length > 2) {
                extensionsMessage = ( localize(9089, "extensions from {0}, {1} and others", publishers[0], publishers[1]));
            } else if (publishers.length === 2) {
                extensionsMessage = ( localize(9090, "extensions from {0} and {1}", publishers[0], publishers[1]));
            } else {
                extensionsMessage = ( localize(9091, "extensions from {0}", publishers[0]));
            }
        }
        ...
        const donotShowAgainLabel = source === RecommendationSource.WORKSPACE ? ( localize(9094, "Don't Show Again for this Repository")) : extensions.length > 1 ? ( localize(9095, "Don't Show Again for these Extensions")) : ( localize(9096, "Don't Show Again for this Extension"));
        ...
        return createCancelablePromise(async token => {
            ...
            choices.push({
                ...
                menu: this.userDataSyncEnablementService.isEnabled() && this.userDataSyncEnablementService.isResourceEnabled(SyncResource.Extensions) ? [{
                    label: ( localize(9098, "Install (Do not sync)")),
                    run: () => installExtensions(true)
                }] : undefined
            });
            choices.push(...[{
                label: ( localize(9099, "Show Recommendations")),
                run: async () => {
