...
const ExtensionEditorIcon = registerIcon("extensions-editor-label-icon", Codicon.extensions, ( localize(9627, "Icon of the extensions editor label.")));
class ExtensionsInput extends EditorInput {
    ...
    getName() {
        return localize(9628, "Extension: {0}", this._extension.displayName);
    }
    getIcon() {
