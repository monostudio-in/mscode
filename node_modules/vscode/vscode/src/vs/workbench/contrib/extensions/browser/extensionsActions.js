...
import { buttonSecondaryBackground, buttonSecondaryForeground, buttonSecondaryHoverBackground, buttonBorder, buttonSeparator, buttonBackground, buttonForeground, buttonHoverBackground } from '../../../../platform/theme/common/colors/inputColors.js';
...
let PromptExtensionInstallFailureAction = class PromptExtensionInstallFailureAction extends Action {
    ...
    async run() {
        ...
        if (this.error.name === ExtensionManagementErrorCode.Unsupported) {
            const productName = isWeb ? ( localize(9251, "{0} for the Web", this.productService.nameLong)) : this.productService.nameLong;
            ...
            const {
                ...
                message,
                primaryButton: ( localize(9253, "&&More Information")),
                cancelButton: ( localize(9254, "Close"))
            });
            if (confirmed) {
        ...
        if (ExtensionManagementErrorCode.ReleaseVersionNotFound === this.error.name) {
            await this.dialogService.prompt({
                ...
                buttons: [{
                    label: ( localize(9255, "Install Pre-Release")),
                    run: () => {
                ...
                cancelButton: ( localize(9256, "Cancel"))
            });
            return;
        }
        if ([
        ...
        if (ExtensionManagementErrorCode.PackageNotSigned === this.error.name) {
            await this.dialogService.prompt({
                ...
                buttons: [{
                    label: ( localize(9258, "Install Anyway")),
                    run: () => {
                        const installAction = this.instantiationService.createInstance(InstallAction, {
                            ...this.options,
        ...
        if (ExtensionManagementErrorCode.SignatureVerificationFailed === this.error.name) {
            await this.dialogService.prompt({
                ...
                detail: getErrorMessage(this.error),
                buttons: [{
                    label: ( localize(9260, "Learn More")),
                    ...
                    label: ( localize(9261, "Install Anyway (Don't Verify Signature)")),
                    run: () => {
                        const installAction = this.instantiationService.createInstance(InstallAction, {
                            ...this.options,
                            donotVerifySignature: true
        ...
        if (ExtensionManagementErrorCode.SignatureVerificationInternal === this.error.name) {
            await this.dialogService.prompt({
                ...
                buttons: [{
                    ...
                    label: ( localize(9262, "Report Issue")),
        ...
        if (downloadUrl) {
            ...
            promptChoices.push({
                label: ( localize(9268, "Try Downloading Manually...")),
                run: () => this.openerService.open(downloadUrl).then(() => {
                    this.notificationService.prompt(Severity$1.Info, ( localize(
                        ...
                        label: ( localize(9270, "Install from VSIX...")),
...
let InstallAction = class InstallAction extends ExtensionAction {
    ...
    constructor(
        ...
        super("extensions.install", ( localize(9271, "Install")), InstallAction_1.CLASS, false);
    ...
    async run() {
        ...
        if (this.extension.gallery && !this.extension.gallery.isSigned && shouldRequireRepositorySignatureFor(
            ...
            const {
                ...
                detail: ( localize(9272, "Extension is not signed.")),
                buttons: [{
                    label: ( localize(9258, "Install Anyway")),
                    run: () => {
        ...
        if (this.extension.deprecationInfo) {
            let detail = ( localize(9273, "This extension is deprecated as it is no longer being maintained."));
            ...
            if (this.extension.deprecationInfo.extension) {
                ...
                buttons.push({
                    label: ( localize(9275, "&&Open {0}", this.extension.deprecationInfo.extension.displayName)),
                    run: async () => {
                ...
                buttons.push({
                    label: ( localize(9277, "&&Configure Settings")),
                    run: async () => {
        ...
        if (extension?.local) {
            alert(( localize(9280, "Installing extension {0} is completed.", this.extension.displayName)));
    ...
    getLabel(primary) {
        if (this.extension?.isWorkspaceScoped && this.extension.resourceExtension && this.contextService.isInsideWorkspace(this.extension.resourceExtension.location)) {
            return localize(9281, "Install Workspace Extension");
        }
        if (this.options.installPreReleaseVersion && this.extension?.hasPreReleaseVersion) {
            return primary ? ( localize(9282, "Install Pre-Release")) : ( localize(9283, "Install Pre-Release Version"));
        }
        if (this.extension?.hasPreReleaseVersion) {
            return primary ? ( localize(9271, "Install")) : ( localize(9284, "Install Release Version"));
        }
        return localize(9271, "Install");
    }
};
...
class InstallingLabelAction extends ExtensionAction {
    static {
        this.LABEL = ( localize(9285, "Installing"));
    }
    static {
...
let InstallInOtherServerAction = class InstallInOtherServerAction extends ExtensionAction {
    ...
    static {
        this.INSTALL_LABEL = ( localize(9271, "Install"));
    }
    static {
        this.INSTALLING_LABEL = ( localize(9285, "Installing"));
    }
    static {
...
let LocalInstallAction = class LocalInstallAction extends InstallInOtherServerAction {
    ...
    getInstallLabel() {
        return localize(9287, "Install Locally");
    }
};
...
let WebInstallAction = class WebInstallAction extends InstallInOtherServerAction {
    ...
    getInstallLabel() {
        return localize(9288, "Install in Browser");
    }
};
...
let UninstallAction = class UninstallAction extends ExtensionAction {
    ...
    static {
        this.UninstallLabel = ( localize(9289, "Uninstall"));
    }
    static {
        this.UninstallingLabel = ( localize(9290, "Uninstalling"));
    }
    static {
    ...
    update() {
        ...
        this.label = this.extension.local?.isApplicationScoped && this.userDataProfilesService.profiles.length > 1 ? ( localize(9291, "Uninstall (All Profiles)")) : UninstallAction_1.UninstallLabel;
    ...
    async run() {
        ...
        alert(( localize(9292, "Uninstalling extension {0} started.", this.extension.displayName)));
        try {
...
let UpdateAction = class UpdateAction extends ExtensionAction {
    ...
    constructor(
        ...
        super(`extensions.update`, ( localize(9294, "Update")), UpdateAction_1.DisabledClass, false);
    ...
    update() {
        this.updateThrottler.queue(() => this.computeAndUpdateEnablement());
        if (this.extension) {
            this.label = this.verbose ? ( localize(9295, "Update to v{0}", this.extension.latestVersion)) : ( localize(9294, "Update"));
        }
    }
    async computeAndUpdateEnablement() {
        this.enabled = false;
    ...
    async run() {
        ...
        if (consent) {
            const {
                ...
                type: "warning",
                title: ( localize(9296, "Update {0} Extension", this.extension.displayName)),
                message: ( localize(9297, "{0}\n\nWould you like to update the extension?", consent)),
                buttons: [{
                    label: ( localize(9294, "Update")),
                    run: () => "update"
                }, {
                    label: ( localize(9298, "Review")),
                    run: () => "review"
                }, {
                    label: ( localize(9256, "Cancel")),
                    run: () => "cancel"
                }]
            });
            if (result === "cancel") {
...
let ToggleAutoUpdateForExtensionAction = class ToggleAutoUpdateForExtensionAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize2(9301, "Auto Update"));
    }
    static {
    ...
    async run() {
        ...
        if (enableAutoUpdate) {
            alert(( localize(9302, "Enabled auto updates for", this.extension.displayName)));
        } else {
            alert(( localize(9303, "Disabled auto updates for", this.extension.displayName)));
        }
    }
};
...
let ToggleAutoUpdatesForPublisherAction = class ToggleAutoUpdatesForPublisherAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9304, "Auto Update All (From Publisher)"));
    }
...
let MigrateDeprecatedExtensionAction = class MigrateDeprecatedExtensionAction extends ExtensionAction {
    ...
    constructor(small, extensionsWorkbenchService) {
        super("extensionsAction.migrateDeprecatedExtension", ( localize(9306, "Migrate")), MigrateDeprecatedExtensionAction_1.DisabledClass, false);
        this.small = small;
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.update();
    }
    update() {
        ...
        this.label = this.small ? ( localize(9308, "Migrate")) : this.tooltip;
    }
    async run() {
        if (!this.extension?.deprecationInfo?.extension) {
            return;
...
let ManageExtensionAction = class ManageExtensionAction extends DropDownExtensionAction {
    ...
    constructor(instantiationService, extensionService, contextKeyService, productService) {
        ...
        this.productService = productService;
        this.tooltip = ( localize(9309, "Manage"));
        this.update();
    }
...
let TogglePreReleaseExtensionAction = class TogglePreReleaseExtensionAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9310, "Pre-Release"));
    }
    static {
    ...
    update() {
        ...
        if (this.extension.preRelease) {
            this.label = ( localize(9311, "Switch to Release Version"));
            this.tooltip = ( localize(9312, "This will switch and enable updates to release versions"));
        } else {
            this.label = ( localize(9313, "Switch to Pre-Release Version"));
            this.tooltip = ( localize(
                9314,
...
let InstallAnotherVersionAction = class InstallAnotherVersionAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9315, "Install Specific Version..."));
    }
    constructor(
        extension,
        whenInstalled,
    ...
    async run() {
        ...
        if (!allVersions.length) {
            await this.dialogService.info(( localize(9316, "This extension has no other versions.")));
            return;
        }
        const picks = ( allVersions.map((v, i) => {
            return {
                id: v.version,
                label: v.version,
                description: `${fromNow(( new Date(Date.parse(v.date))), true)}${v.isPreReleaseVersion ? ` (${( localize(9317, "pre-release"))})` : ""}${v.version === this.extension?.local?.manifest.version ? ` (${( localize(9318, "current"))})` : ""}`,
                ariaLabel: `${v.isPreReleaseVersion ? "Pre-Release version" : "Release version"} ${v.version}`,
                isPreReleaseVersion: v.isPreReleaseVersion
            };
        }));
        const pick = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(9319, "Select Version to Install")),
            matchOnDetail: true
        });
        if (pick) {
...
let EnableForWorkspaceAction = class EnableForWorkspaceAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9320, "Enable (Workspace)"));
    }
    constructor(extensionsWorkbenchService, extensionEnablementService, productService) {
        ...
        this.extensionEnablementService = extensionEnablementService;
        this.productService = productService;
        this.tooltip = ( localize(9321, "Enable this extension only in this workspace"));
        this.update();
    }
    update() {
        this.enabled = false;
...
let EnableGloballyAction = class EnableGloballyAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9322, "Enable"));
    }
    constructor(extensionsWorkbenchService, extensionEnablementService, productService) {
        super(
        ...
        this.extensionEnablementService = extensionEnablementService;
        this.productService = productService;
        this.tooltip = ( localize(9323, "Enable this extension"));
        this.update();
    }
    update() {
        this.enabled = false;
...
let DisableForWorkspaceAction = class DisableForWorkspaceAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9324, "Disable (Workspace)"));
    }
    constructor(
        ...
        this.extensionService = extensionService;
        this.productService = productService;
        this.tooltip = ( localize(9325, "Disable this extension only in this workspace"));
        this.update();
...
let DisableGloballyAction = class DisableGloballyAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9326, "Disable"));
    }
    constructor(
        extensionsWorkbenchService,
        extensionEnablementService,
        ...
        this.extensionService = extensionService;
        this.productService = productService;
        this.tooltip = ( localize(9327, "Disable this extension"));
        this.update();
        this._register(this.extensionService.onDidChangeExtensions(() => this.update()));
    }
    update() {
...
let EnableAIFeaturesGloballyAction = class EnableAIFeaturesGloballyAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9328, "Enable AI Features"));
    }
    constructor(productService, configurationService) {
        ...
        this.tooltip = ( localize(9329, "Enable AI features"));
        this.update();
...
let EnableAIFeaturesInWorkspaceAction = class EnableAIFeaturesInWorkspaceAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9330, "Enable AI Features (Workspace)"));
    }
    constructor(
        productService,
        extensionsWorkbenchService,
        ...
        this.configurationService = configurationService;
        this.extensionEnablementService = extensionEnablementService;
        this.tooltip = ( localize(9331, "Enable AI features in this workspace"));
        this.update();
        this._register(this.configurationService.onDidChangeConfiguration(e => {
            if (e.affectsConfiguration(CHAT_AI_DISABLED_SETTING)) {
                this.update();
...
let DisableAIFeaturesGloballyAction = class DisableAIFeaturesGloballyAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9332, "Disable AI Features"));
    }
    constructor(productService, configurationService) {
        super(
        ...
        this.productService = productService;
        this.configurationService = configurationService;
        this.tooltip = ( localize(9333, "Disable AI features"));
        this.update();
        this._register(this.configurationService.onDidChangeConfiguration(e => {
            if (e.affectsConfiguration(CHAT_AI_DISABLED_SETTING)) {
                this.update();
...
let DisableAIFeaturesInWorkspaceAction = class DisableAIFeaturesInWorkspaceAction extends ExtensionAction {
    ...
    static {
        this.LABEL = ( localize(9334, "Disable AI Features (Workspace)"));
    }
    constructor(
        productService,
        extensionsWorkbenchService,
        ...
        this.extensionEnablementService = extensionEnablementService;
        this.extensionService = extensionService;
        this.tooltip = ( localize(9335, "Disable AI features in this workspace"));
        this.update();
        this._register(this.extensionService.onDidChangeExtensions(() => this.update()));
    }
    update() {
    ...
    async run() {
        ...
        await this.extensionsWorkbenchService.updateRunningExtensions(( localize(9336, "Disabling AI features")));
    }
};
...
let ExtensionRuntimeStateAction = class ExtensionRuntimeStateAction extends ExtensionAction {
    ...
    update() {
        ...
        this.label = runtimeState.action === ExtensionRuntimeActionType.ReloadWindow ? ( localize(9337, "Reload Window")) : runtimeState.action === ExtensionRuntimeActionType.RestartExtensions ? ( localize(9338, "Restart Extensions")) : runtimeState.action === ExtensionRuntimeActionType.QuitAndInstall ? ( localize(9339, "Restart to Update")) : runtimeState.action === ExtensionRuntimeActionType.ApplyUpdate || runtimeState.action === ExtensionRuntimeActionType.DownloadUpdate ? ( localize(9340, "Update {0}", this.productService.nameShort)) : "";
    }
    async run() {
        const runtimeState = this.extension?.runtimeState;
...
let SetColorThemeAction = class SetColorThemeAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(9341, "Set Color Theme"));
    }
    static {
    ...
    async run(
        ...
        const pickedTheme = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(9342, "Select Color Theme")),
...
let SetFileIconThemeAction = class SetFileIconThemeAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(9343, "Set File Icon Theme"));
    }
    static {
        this.EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
    }
    ...
    async run(
        ...
        const pickedTheme = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(9344, "Select File Icon Theme")),
...
let SetProductIconThemeAction = class SetProductIconThemeAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(9345, "Set Product Icon Theme"));
    }
    static {
        this.EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
    }
    ...
    async run(
        ...
        const pickedTheme = await this.quickInputService.pick(picks, {
            placeHolder: ( localize(9346, "Select Product Icon Theme")),
...
let SetLanguageAction = class SetLanguageAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(9347, "Set Display Language"));
    }
    static {
...
let ClearLanguageAction = class ClearLanguageAction extends ExtensionAction {
    ...
    static {
        this.TITLE = ( localize2(9348, "Clear Display Language"));
    }
    static {
        this.EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} language`;
    }
...
let ShowRecommendedExtensionAction = class ShowRecommendedExtensionAction extends Action {
    ...
    static {
        this.LABEL = ( localize(9349, "Show Recommended Extension"));
    }
...
let InstallRecommendedExtensionAction = class InstallRecommendedExtensionAction extends Action {
    ...
    static {
        this.LABEL = ( localize(9350, "Install Recommended Extension"));
    }
...
let IgnoreExtensionRecommendationAction = class IgnoreExtensionRecommendationAction extends Action {
    ...
    constructor(extension, extensionRecommendationsManagementService) {
        ...
        this.tooltip = ( localize(9351, "Do not recommend this extension again"));
        this.enabled = true;
    }
    run() {
...
let UndoIgnoreExtensionRecommendationAction = class UndoIgnoreExtensionRecommendationAction extends Action {
    ...
    constructor(extension, extensionRecommendationsManagementService) {
        ...
        this.tooltip = ( localize(9352, "Undo"));
        this.enabled = true;
    }
    run() {
...
let ConfigureWorkspaceRecommendedExtensionsAction = class ConfigureWorkspaceRecommendedExtensionsAction extends AbstractConfigureRecommendedExtensionsAction {
    ...
    static {
        this.LABEL = ( localize(9354, "Configure Recommended Extensions (Workspace)"));
    }
    constructor(
        id,
        label,
...
let ConfigureWorkspaceFolderRecommendedExtensionsAction = class ConfigureWorkspaceFolderRecommendedExtensionsAction extends AbstractConfigureRecommendedExtensionsAction {
    ...
    static {
        this.LABEL = ( localize(9355, "Configure Recommended Extensions (Workspace Folder)"));
    }
    constructor(
        id,
        label,
    ...
    computeLabel() {
        ...
        if (currentEnablementState !== null) {
            ...
            if (!currentlyEnabled && enabled) {
                return canAddExtension() ? ( localize(9359, "Enabled")) : null;
            }
            if (currentlyEnabled && !enabled) {
                return canRemoveExtension() ? ( localize(9360, "Disabled")) : null;
            }
        }
        return null;
    }
...
let ToggleSyncExtensionAction = class ToggleSyncExtensionAction extends DropDownExtensionAction {
    ...
    update() {
        ...
        if (this.extension) {
            ...
            this.tooltip = isIgnored ? ( localize(9361, "This extension is ignored during sync")) : ( localize(9362, "This extension is synced"));
        }
    }
    async run() {
        return super.run([[( new Action(
            "extensions.syncignore",
            this.extensionsWorkbenchService.isExtensionIgnoredToSync(this.extension) ? ( localize(9363, "Sync this extension")) : ( localize(9364, "Do not sync this extension")),
            undefined,
            true,
...
let ExtensionStatusAction = class ExtensionStatusAction extends ExtensionAction {
    ...
    async computeAndUpdateStatus() {
        ...
        if (this.extension.isMalicious) {
            this.updateStatus({
                icon: warningIcon,
                message: ( new MarkdownString(( localize(9365, "This extension was reported to be problematic."))))
            }, true);
            return;
        }
        if (this.extension.state === ExtensionState.Uninstalled && this.extension.gallery && !this.extension.gallery.isSigned && shouldRequireRepositorySignatureFor(
            ...
            this.updateStatus({
                icon: warningIcon,
                message: ( new MarkdownString(( localize(9366, "This extension is not signed by the Extension Marketplace."))))
            }, true);
            return;
        }
        if (this.extension.deprecationInfo) {
            if (this.extension.deprecationInfo.extension) {
                ...
                this.updateStatus({
                    icon: warningIcon,
                    message: ( new MarkdownString(( localize(9367, "This extension is deprecated. Use the {0} extension instead.", link))))
                }, true);
            } else if (this.extension.deprecationInfo.settings) {
                const link = `[${( localize(9368, "settings"))}](${createCommandUri("workbench.action.openSettings", ( this.extension.deprecationInfo.settings.map(setting => `@id:${setting}`)).join(" "))}})`;
                this.updateStatus({
                    icon: warningIcon,
                ...
                const message = ( new MarkdownString(( localize(9370, "This extension is deprecated as it is no longer being maintained."))));
        ...
        if (this.extension.enablementState === EnablementState.DisabledByAllowlist) {
            ...
            if (result !== true) {
                this.updateStatus({
                    icon: warningIcon,
                    message: ( new MarkdownString(( localize(9373, "This extension is disabled because {0}", result.value))))
                }, true);
                return;
            }
        }
        if (this.extension.enablementState === EnablementState.DisabledByEnvironment) {
            this.updateStatus({
                message: ( new MarkdownString(( localize(9374, "This extension is disabled by the environment."))))
            }, true);
            return;
        }
                    ...
                    if (this.extensionManifestPropertiesService.prefersExecuteOnWorkspace(this.extension.local.manifest)) {
                        if (this.extensionManagementServerService.remoteExtensionManagementServer) {
                            message = ( new MarkdownString(`${( localize(
                                ...
                                this.extensionManagementServerService.remoteExtensionManagementServer.label
                            ))} [${( localize(9260, "Learn More"))}](https://code.visualstudio.com/api/advanced-topics/remote-extensions#architecture-and-extension-kinds)`));
                        }
                    }
                }
        ...
        for (const feature of features) {
            ...
            const manageAccessLink = `[${( localize(9385, "Manage Access"))}](${createCommandUri(
    "extension.open",
    this.extension.identifier.id,
    ...
    feature.id
        ...
        if (this.extension.enablementState === EnablementState.DisabledByExtensionDependency) {
            this.updateStatus({
                icon: warningIcon,
                message: ( new MarkdownString(( localize(9391, "This extension depends on an extension that is disabled.")))).appendMarkdown(`&nbsp;[${( localize(9392, "Show Dependencies"))}](${createCommandUri(
    "extension.open",
    this.extension.identifier.id,
    ExtensionEditorTab.Dependencies
        ...
        if (!this.extension.isWorkspaceScoped && isEnabled && isRunning) {
            if (this.extension.enablementState === EnablementState.EnabledWorkspace) {
                this.updateStatus({
                    message: ( new MarkdownString(( localize(9393, "This extension is enabled for this workspace by the user."))))
                }, true);
                return;
            }
            if (this.extensionManagementServerService.localExtensionManagementServer && this.extensionManagementServerService.remoteExtensionManagementServer) {
                if (this.extension.server === this.extensionManagementServerService.remoteExtensionManagementServer) {
                    this.updateStatus({
                        message: ( new MarkdownString(( localize(9394, "Extension is enabled on '{0}'", this.extension.server.label))))
                    }, true);
                    return;
                }
            }
        ...
        if (!isEnabled && !isRunning) {
            if (this.extension.enablementState === EnablementState.DisabledGlobally) {
                this.updateStatus({
                    message: ( new MarkdownString(( localize(9395, "This extension is disabled globally by the user."))))
                }, true);
                return;
            }
            if (this.extension.enablementState === EnablementState.DisabledWorkspace) {
                this.updateStatus({
                    message: ( new MarkdownString(( localize(9396, "This extension is disabled for this workspace by the user."))))
                }, true);
                return;
            }
        }
...
let InstallSpecificVersionOfExtensionAction = class InstallSpecificVersionOfExtensionAction extends Action {
    ...
    static {
        this.LABEL = ( localize(9397, "Install Specific Version of Extension..."));
    }
    constructor(
    ...
    async run() {
        const extensionPick = await this.quickInputService.pick(this.getExtensionEntries(), {
            placeHolder: ( localize(9398, "Select Extension")),
            matchOnDetail: true
        });
...
let AbstractInstallExtensionsInServerAction = class AbstractInstallExtensionsInServerAction extends Action {
    ...
    async selectAndInstallExtensions() {
        ...
        if (localExtensionsToInstall.length) {
            ...
            quickPick.placeholder = ( localize(9399, "Select extensions to install"));
            ...
            this.notificationService.notify({
                ...
                message: ( localize(9400, "There are no extensions to install."))
            });
        }
    }
        ...
        if (selectedItems.length) {
            ...
            if (localExtensionsToInstall.length) {
                await this.progressService.withProgress({
                    ...
                    title: ( localize(9401, "Installing Extensions..."))
                }, () => this.installExtensions(localExtensionsToInstall));
                this.notificationService.info(( localize(9402, "Successfully installed extensions.")));
            }
        }
    }
};
...
let InstallRemoteExtensionsInLocalAction = class InstallRemoteExtensionsInLocalAction extends AbstractInstallExtensionsInServerAction {
    ...
    get label() {
        return localize(9405, "Install Remote Extensions Locally...");
    }
    getQuickPickTitle() {
        return localize(9406, "Install Remote Extensions Locally");
    }
    getExtensionsToInstall(local) {
        return local.filter(
...
registerColor("extensionButton.background", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(9407, "Button background color for extension actions.")));
registerColor("extensionButton.foreground", {
    dark: buttonSecondaryForeground,
    light: buttonSecondaryForeground,
    hcDark: null,
    hcLight: null
}, ( localize(9408, "Button foreground color for extension actions.")));
registerColor("extensionButton.hoverBackground", {
    dark: buttonSecondaryHoverBackground,
    light: buttonSecondaryHoverBackground,
    hcDark: null,
    hcLight: null
}, ( localize(9409, "Button background hover color for extension actions.")));
registerColor("extensionButton.border", {
    dark: buttonBorder,
    light: buttonBorder,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(9410, "Button border color for extension actions.")));
registerColor("extensionButton.separator", buttonSeparator, ( localize(9411, "Button separator color for extension actions")));
