...
const REMOTE_CATEGORY = ( localize2(9458, "Remote"));
let ExtensionsViewletViewsContribution = class ExtensionsViewletViewsContribution extends Disposable {
    ...
    registerViews() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9459, "Marketplace")),
    ...
    createDefaultExtensionsViewDescriptors() {
        ...
        for (const server of servers) {
            const getInstalledViewName = () => getViewName(( localize(9462, "Installed")), server);
                    ...
                    registerAction2(class InstallLocalExtensionsInRemoteAction2 extends Action2 {
                        constructor() {
                            super({
                                ...
                                get title() {
                                    return localize2(9463, "Install Local Extensions in '{0}'...", server.label);
                                },
                ...
                registerAction2(class InstallRemoteExtensionsInLocalAction2 extends Action2 {
                    constructor() {
                        super({
                            ...
                            title: ( localize2(9464, "Install Remote Extensions Locally...")),
                            category: REMOTE_CATEGORY,
                            f1: true
                        });
                    }
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9466, "Recommended")),
    ...
    createSearchExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9469, "Recently Updated")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9474, "Workspace Unsupported")),
            ctorDescriptor: ( new SyncDescriptor(ExtensionsListView, [{}])),
    ...
    createRecommendedExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9475, "Workspace Recommendations")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9476, "Other Recommendations")),
    ...
    createBuiltinExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9479, "Programming Languages")),
            ctorDescriptor: ( new SyncDescriptor(StaticQueryExtensionsView, [{
    ...
    createUnsupportedWorkspaceExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9480, "Disabled in Restricted Mode")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9481, "Limited in Restricted Mode")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9482, "Disabled in Virtual Workspaces")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9483, "Limited in Virtual Workspaces")),
    ...
    createOtherLocalFilteredExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9484, "Deprecated")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(9485, "Restart Required")),
            ctorDescriptor: ( new SyncDescriptor(ExtensionsListView, [{}])),
...
let ExtensionsViewPaneContainer = class ExtensionsViewPaneContainer extends ViewPaneContainer {
    ...
    create(parent) {
        ...
        const placeholder = ( localize(9486, "Search Extensions in Marketplace"));
    ...
    renderNotificaiton() {
        ...
        if (status && (query === this.searchBox?.getValue() || !this.searchMarketplaceExtensionsContextKey.get())) {
            ...
            const showAction = append(messageText, $("span.message-text-action", {
                "tabindex": "0",
                "role": "button",
                "aria-label": `${status.message}. ${( localize(9487, "Click to Show"))}`
            }, ( localize(9488, "Show"))));
    ...
    alertSearchResult(count, viewId) {
        ...
        case 1:
            if (view) {
                alert(( localize(9489, "1 extension found in the {0} section.", view.name.value)));
            } else {
                alert(( localize(9490, "1 extension found.")));
            }
            break;
        default:
            if (view) {
                alert(( localize(9491, "{0} extensions found in the {1} section.", count, view.name.value)));
            } else {
                alert(( localize(9492, "{0} extensions found.", count)));
            }
            break;
        }
    }
    ...
    onError(err) {
        ...
        if (/ECONNREFUSED/.test(message)) {
            ...
            )), [( new Action("open user settings", ( localize(9494, "Open User Settings")), undefined, true, () => this.preferencesService.openUserSettings()))]);
    ...
    onServiceChange() {
        ...
        if (!badge) {
            ...
            if (newBadgeNumber > 0) {
                let msg = "";
                if (outdated) {
                    msg += outdated === 1 ? ( localize(9495, "{0} requires update", outdated)) : ( localize(9496, "{0} require update", outdated));
                }
                if (outdated > 0 && actionRequired.length > 0) {
                    msg += ", ";
                }
                if (actionRequired.length) {
                    msg += actionRequired.length === 1 ? ( localize(9497, "{0} requires restart", actionRequired.length)) : ( localize(9498, "{0} require restart", actionRequired.length));
                }
            ...
            if (maliciousExtensions.length) {
                ...
                for (const [extension, link] of maliciousExtensions) {
                    ...
                    if (shouldRestartExtensions || shouldReloadWindow) {
                        buttons.push({
                            label: shouldRestartExtensions ? ( localize(9499, "Restart Extensions")) : ( localize(9500, "Reload Now")),
                            run: () => shouldRestartExtensions ? this.extensionsWorkbenchService.updateRunningExtensions() : this.hostService.reload()
                        });
                    }
                    if (link) {
                        buttons.push({
                            label: ( localize(9501, "Learn More")),
...
let ExtensionMarketplaceStatusUpdater = class ExtensionMarketplaceStatusUpdater extends Disposable {
    ...
    async updateBadge() {
        ...
        case ExtensionGalleryManifestStatus.RequiresSignIn:
            badge = ( new NumberBadge(1, () => ( localize(9503, "Sign in required to access marketplace"))));
            break;
        case ExtensionGalleryManifestStatus.AccessDenied:
            badge = ( new WarningBadge(() => ( localize(9504, "Access denied to marketplace"))));
            break;
        }
        if (badge) {
            this.badgeHandle.value = this.activityService.showViewContainerActivity(VIEWLET_ID, {
        ...
        if (status === ExtensionGalleryManifestStatus.RequiresSignIn) {
            const badge = ( new NumberBadge(1, () => ( localize(9505, "Sign in to access Marketplace"))));
