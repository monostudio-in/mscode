...
const SearchExtensionsToolData = {
    ...
    displayName: ( localize(9635, "Search Extensions")),
    ...
    userDescription: ( localize(9636, "Search for VS Code extensions")),
    ...
    async invoke(invocation, _countTokens, _progress, token) {
        ...
        if (!params.keywords?.length && !params.category && !params.ids?.length) {
            return {
                content: [{
                    kind: "text",
                    value: ( localize(9637, "Please provide a category or keywords or ids to search for."))
                }]
            };
        }
