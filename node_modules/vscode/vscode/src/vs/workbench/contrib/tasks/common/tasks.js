...
const TASK_RUNNING_STATE = ( new RawContextKey("taskRunning", false, ( localize(13458, "Whether a task is currently running."))));
const TASK_TERMINAL_ACTIVE = ( new RawContextKey("taskTerminalActive", false, ( localize(13459, "Whether the active terminal is a task terminal."))));
const TASKS_CATEGORY = ( localize2(13460, "Tasks"));
var ShellQuoting;
