...
class ExplorerItem {
    constructor(
        ...
        _readonly,
        _locked,
        _name = basenameOrAuthority(resource),
        _mtime,
        _unknown = false
    ) {
