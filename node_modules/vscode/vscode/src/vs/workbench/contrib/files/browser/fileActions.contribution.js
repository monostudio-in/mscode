...
const copyPathCommand = {
    ...
    title: ( localize(9690, "Copy Path"))
};
const copyRelativePathCommand = {
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize(9691, "Copy Relative Path"))
};
const revealInSideBarCommand = {
    id: REVEAL_IN_EXPLORER_COMMAND_ID,
    title: ( localize(9692, "Reveal in Explorer View"))
};
...
appendSaveConflictEditorTitleAction("workbench.files.action.acceptLocalChanges", ( localize(9693, "Use your changes and overwrite file contents")), Codicon.check, -10, acceptLocalChangesCommand);
appendSaveConflictEditorTitleAction("workbench.files.action.revertLocalChanges", ( localize(9694, "Discard your changes and revert to file contents")), Codicon.discard, -9, revertLocalChangesCommand);
...
appendToCommandPalette({
    id: COPY_PATH_COMMAND_ID,
    title: ( localize2(9695, "Copy Path of Active File")),
    category: Categories.File
});
appendToCommandPalette({
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize2(9696, "Copy Relative Path of Active File")),
    category: Categories.File
});
appendToCommandPalette({
...
appendToCommandPalette({
    ...
    title: ( localize2(9697, "Save All in Group")),
    category: Categories.File
});
appendToCommandPalette({
    id: SAVE_FILES_COMMAND_ID,
    title: ( localize2(9698, "Save All Files")),
    category: Categories.File
});
appendToCommandPalette({
    id: REVERT_FILE_COMMAND_ID,
    title: ( localize2(9699, "Revert File")),
    category: Categories.File
});
appendToCommandPalette({
    id: COMPARE_WITH_SAVED_COMMAND_ID,
    title: ( localize2(9700, "Compare Active File with Saved")),
    category: Categories.File,
    metadata: {
...
appendToCommandPalette({
    ...
    category: Categories.File,
    metadata: {
        description: ( localize2(9702, "Create a new folder or directory"))
    }
}, ( WorkspaceFolderCountContext.notEqualsTo("0")));
appendToCommandPalette({
...
const openToSideCommand = {
    ...
    title: ( localize(9703, "Open to the Side"))
};
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(9704, "Reopen Editor With..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(9699, "Revert File")),
        precondition: OpenEditorsDirtyEditorContext
    },
    when: ( ContextKeyExpr.and((
    OpenEditorsGroupContext.toNegated()), (
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: COMPARE_WITH_SAVED_COMMAND_ID,
        title: ( localize(9706, "Compare with Saved")),
        precondition: OpenEditorsDirtyEditorContext
    },
...
const compareResourceCommand = {
    ...
    title: ( localize(9707, "Compare with Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "3_compare",
    order: 20,
...
const selectForCompareCommand = {
    ...
    title: ( localize(9708, "Select for Compare"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "3_compare",
    order: 30,
...
const compareSelectedCommand = {
    ...
    title: ( localize(9709, "Compare Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "3_compare",
    order: 30,
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(9711, "Close Others"))
    },
    when: ( OpenEditorsGroupContext.toNegated())
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(9712, "Close Saved"))
    }
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: "4_close",
...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
    ...
    alt: {
        id: DELETE_FILE_ID,
        title: ( localize(9716, "Delete Permanently"))
    },
...
for (const menuId of [MenuId.EmptyEditorGroupContext, MenuId.EditorTabsBarContext]) {
    MenuRegistry.appendMenuItem(menuId, {
        command: {
            id: NEW_UNTITLED_FILE_COMMAND_ID,
            title: ( localize(9717, "New Text File"))
        },
        group: "1_file",
        order: 10
    });
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: NEW_UNTITLED_FILE_COMMAND_ID,
        title: ( localize(9719, "&&New Text File"))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(9723, "A&&uto Save")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(9724, "Re&&vert File")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CLOSE_EDITOR_COMMAND_ID,
        title: ( localize(9725, "&&Close Editor")),
        precondition: ( ContextKeyExpr.or(ActiveEditorContext, ( ContextKeyExpr.and(FoldersViewVisibleContext, SidebarFocusContext))))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        id: "workbench.action.quickOpen",
        title: ( localize(9726, "Go to &&File..."))
    },
    order: 1
});
