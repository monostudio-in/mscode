...
const explorerViewIcon = registerIcon("explorer-view-icon", Codicon.files, ( localize(9677, "View icon of the explorer view.")));
const openEditorsViewIcon = registerIcon("open-editors-view-icon", Codicon.book, ( localize(9678, "View icon of the open editors view.")));
...
const VIEW_CONTAINER = viewContainerRegistry.registerViewContainer({
    ...
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        title: ( localize2(9680, "Explorer")),
        mnemonicTitle: ( localize(9681, "&&Explorer")),
        keybindings: {
...
const openFolder = ( localize(9682, "Open Folder"));
const addAFolder = ( localize(9683, "add a folder"));
const openRecent = ( localize(9684, "Open Recent"));
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(9687, "Connected to remote.\n{0}", openFolderButton)),
    when: ( ContextKeyExpr.and((
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(9689, "You have not yet opened a folder.\n{0}", openFolderButton)),
    when: ( ContextKeyExpr.and(
