...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static {
        this.NAME = ( localize2(10004, "Open Editors"));
    }
    constructor(
        options,
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = ( localize(10005, "{0} unsaved", dirty));
...
class OpenEditorsAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(10004, "Open Editors");
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10006, "Toggle Vertical/Horizontal Editor Layout")),
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...( localize2(10007, "Flip Layout")),
            mnemonicTitle: ( localize(10008, "Flip &&Layout"))
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10009, "New Untitled Text File")),
            f1: false,
