...
const ExplorerViewletVisibleContext = ( new RawContextKey("explorerViewletVisible", true, {
    type: "boolean",
    description: ( localize(10016, "True when the EXPLORER viewlet is visible."))
}));
...
const ExplorerFolderContext = ( new RawContextKey("explorerResourceIsFolder", false, {
    type: "boolean",
    description: ( localize(10018, "True when the focused item in the EXPLORER is a folder."))
}));
const ExplorerResourceReadonlyContext = ( new RawContextKey("explorerResourceReadonly", false, {
    type: "boolean",
    description: ( localize(10019, "True when the focused item in the EXPLORER is read-only."))
}));
...
const ExplorerResourceParentReadOnlyContext = ( new RawContextKey("explorerResourceParentReadonly", false, {
    type: "boolean",
    description: ( localize(10020, "True when the focused item in the EXPLORER's parent is read-only."))
}));
...
const ExplorerRootContext = ( new RawContextKey("explorerResourceIsRoot", false, {
    type: "boolean",
    description: ( localize(10021, "True when the focused item in the EXPLORER is a root folder."))
}));
const ExplorerResourceCut = ( new RawContextKey("explorerResourceCut", false, {
    type: "boolean",
    description: ( localize(10022, "True when an item in the EXPLORER has been cut for cut and paste."))
}));
const ExplorerResourceMoveableToTrash = ( new RawContextKey("explorerResourceMoveableToTrash", false, {
    type: "boolean",
    description: ( localize(10023, "True when the focused item in the EXPLORER can be moved to trash."))
}));
const FilesExplorerFocusedContext = ( new RawContextKey("filesExplorerFocus", true, {
    type: "boolean",
    description: ( localize(10024, "True when the focus is inside the EXPLORER view."))
}));
const OpenEditorsFocusedContext = ( new RawContextKey("openEditorsFocus", true, {
    type: "boolean",
    description: ( localize(10025, "True when the focus is inside the OPEN EDITORS view."))
}));
const ExplorerFocusedContext = ( new RawContextKey("explorerViewletFocus", true, {
    type: "boolean",
    description: ( localize(10026, "True when the focus is inside the EXPLORER viewlet."))
}));
const ExplorerFindProviderActive = ( new RawContextKey("explorerFindProviderActive", false, {
    type: "boolean",
    description: ( localize(10027, "True when the explorer tree is using the explorer find provider."))
}));
