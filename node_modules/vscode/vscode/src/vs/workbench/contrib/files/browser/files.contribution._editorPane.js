...
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(
    EditorPaneDescriptor.create(TextFileEditor, TextFileEditor.ID, ( localize(9916, "Text File Editor"))),
    [( new SyncDescriptor(FileEditorInput))]
);
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(
    EditorPaneDescriptor.create(BinaryFileEditor, BinaryFileEditor.ID, ( localize(9917, "Binary File Editor"))),
    [( new SyncDescriptor(FileEditorInput))]
);
