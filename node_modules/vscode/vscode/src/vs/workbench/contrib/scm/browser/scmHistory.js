...
const historyItemRefColor = registerColor("scmGraph.historyItemRefColor", chartsBlue, ( localize(12477, "History item reference color.")));
const historyItemRemoteRefColor = registerColor("scmGraph.historyItemRemoteRefColor", chartsPurple, ( localize(12478, "History item remote reference color.")));
const historyItemBaseRefColor = registerColor("scmGraph.historyItemBaseRefColor", "#EA5C00", ( localize(12479, "History item base reference color.")));
const historyItemHoverDefaultLabelForeground = registerColor(
    "scmGraph.historyItemHoverDefaultLabelForeground",
    foreground,
    ( localize(12480, "History item hover default label foreground color."))
);
const historyItemHoverDefaultLabelBackground = registerColor(
    "scmGraph.historyItemHoverDefaultLabelBackground",
    badgeBackground,
    ( localize(12481, "History item hover default label background color."))
);
const historyItemHoverLabelForeground = registerColor(
    "scmGraph.historyItemHoverLabelForeground",
    PANEL_BACKGROUND,
    ( localize(12482, "History item hover label foreground color."))
);
registerColor("scmGraph.historyItemHoverAdditionsForeground", {
    ...
    hcDark: "#A1E3AD",
    hcLight: "#374E06"
}, ( localize(12483, "History item hover additions foreground color.")));
registerColor("scmGraph.historyItemHoverDeletionsForeground", {
    light: "#AD0707",
    dark: "#C74E39",
    hcDark: "#C74E39",
    hcLight: "#AD0707"
}, ( localize(12484, "History item hover deletions foreground color.")));
const colorRegistry = [registerColor("scmGraph.foreground1", "#FFB000", ( localize(12485, "Source control graph foreground color (1)."))), registerColor("scmGraph.foreground2", "#DC267F", ( localize(12486, "Source control graph foreground color (2)."))), registerColor("scmGraph.foreground3", "#994F00", ( localize(12487, "Source control graph foreground color (3)."))), registerColor("scmGraph.foreground4", "#40B0A6", ( localize(12488, "Source control graph foreground color (4)."))), registerColor("scmGraph.foreground5", "#B66DFF", ( localize(12489, "Source control graph foreground color (5).")))];
            ...
            if (beforeHistoryItemIndex !== -1 && afterHistoryItemIndex !== -1) {
                ...
                if (!incomingChangeMerged) {
                    ...
                    const incomingChangesHistoryItem = {
                        ...
                        subject: ( localize(12490, "Incoming Changes")),
                        message: ""
                    };
        ...
        if (addOutgoingChanges && currentHistoryItemRef?.revision && currentHistoryItemRef.revision !== mergeBase) {
            ...
            if (currentHistoryItemRefIndex !== -1) {
                const outgoingChangesHistoryItem = {
                    ...
                    subject: ( localize(12491, "Outgoing Changes")),
                    message: ""
                };
