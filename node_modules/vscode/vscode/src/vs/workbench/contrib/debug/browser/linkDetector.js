...
let LinkDetector = class LinkDetector {
    ...
    decorateLink(link, uri, fulltext, hoverBehavior, onClick) {
        ...
        const followLink = uri && this.tunnelService.canTunnel(uri) ? ( localize(8658, "follow link using forwarded port")) : ( localize(8659, "follow link"));
        const title = link.ariaLabel = fulltext ? (isMacintosh ? ( localize(8660, "Cmd + click to {0}\n{1}", followLink, fulltext)) : ( localize(8661, "Ctrl + click to {0}\n{1}", followLink, fulltext))) : (isMacintosh ? ( localize(8662, "Cmd + click to {0}", followLink)) : ( localize(8663, "Ctrl + click to {0}", followLink)));
