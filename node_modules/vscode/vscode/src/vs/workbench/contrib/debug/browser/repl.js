...
let Repl = class Repl extends FilterViewPane {
    ...
    constructor(
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: ( localize(8676, "Filter (e.g. text, !exclude, \\escape)")),
                text: filterText,
                history: JSON.parse(
    ...
    get refreshScheduler() {
        ...
        return (new RunOnceScheduler(async () => {
            ...
            this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : ( localize(8677, "Showing {0} of {1}", filtered, total)));
    ...
    getAriaLabel() {
        let ariaLabel = ( localize(8678, "Debug Console"));
        ...
        if (keybinding) {
            ariaLabel = ( localize(8679, "{0}, use ({1}) for accessibility help", ariaLabel, keybinding));
        } else {
            ariaLabel = ( localize(
                8680,
    ...
    updateInputDecoration() {
        ...
        if (this.isReadonly && this.replInput.hasTextFocus() && !this.replInput.getValue()) {
            ...
            decorations.push({
                ...
                renderOptions: {
                    after: {
                        contentText: ( localize(8681, "Please start a debug session to evaluate expressions")),
...
class AcceptReplInputAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(8682, "Debug Console: Accept Input")),
...
class FilterReplAction extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(8683, "Debug Console: Focus Filter")),
            precondition: CONTEXT_IN_DEBUG_REPL,
            keybinding: [{
...
class FindReplAction extends ViewAction {
    constructor() {
        super({
            viewId: REPL_VIEW_ID,
            id: "repl.action.find",
            title: ( localize(8684, "Debug Console: Focus Find")),
            precondition: CONTEXT_IN_DEBUG_REPL,
            keybinding: [{
...
class ReplCopyAllAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(8685, "Debug: Console Copy All")),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: ( localize(8686, "Select Debug Console")),
            f1: false,
            menu: {
                id: MenuId.ViewTitle,
                group: "navigation",
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: ( localize2(8687, "Clear Console")),
            metadata: {
                description: ( localize2(8688, "Clears all program output from your debug REPL"))
            },
            f1: true,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(8689, "Collapse All")),
            viewId: REPL_VIEW_ID,
            menu: {
                id: MenuId.DebugConsoleContext,
                group: "z_commands",
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8693, "Focus on Debug Console View"))
        });
    }
    async run(accessor) {
