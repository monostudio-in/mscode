...
registerColor("editor.inlineValuesForeground", {
    ...
    hcDark: "#ffffff80",
    hcLight: "#00000080"
}, ( localize(8517, "Color for the debug inline value text.")));
registerColor("editor.inlineValuesBackground", "#ffc80033", ( localize(8518, "Color for the debug inline value background.")));
class InlineSegment {
