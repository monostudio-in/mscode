...
const $ = $$1;
const debugExceptionWidgetBorder = registerColor("debugExceptionWidget.border", "#a31515", ( localize(8653, "Exception widget border color.")));
const debugExceptionWidgetBackground = registerColor("debugExceptionWidget.background", {
    dark: "#420b0d",
    light: "#f1dfde",
    hcDark: "#420b0d",
    hcLight: "#f1dfde"
}, ( localize(8654, "Exception widget background color.")));
let ExceptionWidget = class ExceptionWidget extends ZoneWidget {
    ...
    _fillContainer(container) {
        ...
        label.textContent = this.exceptionInfo.id ? ( localize(8655, "Exception has occurred: {0}", this.exceptionInfo.id)) : ( localize(8656, "Exception has occurred."));
        let ariaLabel = label.textContent;
        const actionBar = this._disposables.add(( new ActionBar(actions)));
        actionBar.push(( new Action("editor.closeExceptionWidget", ( localize(8657, "Close")), ThemeIcon.asClassName(widgetClose), true, async () => {
...
ExceptionWidget = ( __decorate([( __param(4, IThemeService)), ( __param(5, IInstantiationService))], ExceptionWidget));
