...
let BreakpointsFolderRenderer = class BreakpointsFolderRenderer {
    ...
    renderElement(node, _index, data) {
        ...
        const removeAction = data.elementDisposables.add(( new Action("debug.removeBreakpointsInFile", ( localize(8207, "Remove Breakpoints in File")), ThemeIcon.asClassName(Codicon.close), true, async () => {
...
let BreakpointsRenderer = class BreakpointsRenderer {
    ...
    renderBreakpointLineLabel(breakpoint, data) {
        data.name.textContent = ( localize(8208, "Loading..."));
        ...
        this.textModelService.createModelReference(breakpoint.uri).then(reference => {
            ...
            if (model && breakpoint.lineNumber <= model.getLineCount()) {
                ...
                data.name.textContent = lineContent || ( localize(8209, "(empty line)"));
            } else {
                data.name.textContent = ( localize(8210, "(line not found)"));
            }
        }).catch(() => {
            if (data.context === breakpoint) {
                data.name.textContent = ( localize(8211, "(cannot load line)"));
            }
        });
    }
...
class ExceptionBreakpointsRenderer {
    ...
    renderExceptionBreakpoint(exceptionBreakpoint, data) {
        ...
        const exceptionBreakpointtitle = exceptionBreakpoint.verified ? (exceptionBreakpoint.description || data.name.textContent) : exceptionBreakpoint.message || ( localize(8212, "Unverified Exception Breakpoint"));
        data.elementDisposables.add(this.hoverService.setupManagedHover(
            getDefaultHoverDelegate("mouse"),
            data.breakpoint,
        ...
        data.elementDisposables.add(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), data.condition, ( localize(8213, "Expression condition: {0}", exceptionBreakpoint.condition)))
        );
...
let FunctionBreakpointsRenderer = class FunctionBreakpointsRenderer {
    ...
    renderFunctionBreakpoint(functionBreakpoint, data) {
        ...
        if (session && !session.capabilities.supportsFunctionBreakpoints) {
            data.elementDisposables.add(
                this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), data.breakpoint, ( localize(8215, "Function breakpoints are not supported by this debug type")))
            );
        }
        this.breakpointSupportsCondition.set(!session || !!session.capabilities.supportsConditionalBreakpoints);
...
let DataBreakpointsRenderer = class DataBreakpointsRenderer {
    ...
    renderDataBreakpoint(dataBreakpoint, data) {
        ...
        if (session && !session.capabilities.supportsDataBreakpoints) {
            data.elementDisposables.add(
                this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), data.breakpoint, ( localize(8216, "Data breakpoints are not supported by this debug type")))
            );
        }
        if (dataBreakpoint.accessType) {
            const accessType = dataBreakpoint.accessType === "read" ? ( localize(8217, "Read")) : dataBreakpoint.accessType === "write" ? ( localize(8218, "Write")) : ( localize(8219, "Access"));
...
let InstructionBreakpointsRenderer = class InstructionBreakpointsRenderer {
    ...
    renderInstructionBreakpoint(breakpoint, data) {
        ...
        data.elementDisposables.add(
            this.hoverService.setupManagedHover(getDefaultHoverDelegate("mouse"), data.name, ( localize(8220, "Decimal Address: {0}", (breakpoint.address.toString()))))
        );
        data.checkbox.checked = breakpoint.enabled;
        const {
            message,
...
class FunctionBreakpointInputRenderer {
    ...
    renderElement(node, _index, data) {
        ...
        let placeholder = ( localize(8221, "Function to break on"));
        let ariaLabel = ( localize(8222, "Type function breakpoint."));
        if (data.type === "condition") {
            data.inputBox.value = functionBreakpoint.condition || "";
            placeholder = ( localize(8223, "Break when expression evaluates to true"));
            ariaLabel = ( localize(
                8224,
            ...
            placeholder = ( localize(8225, "Break when hit count is met"));
            ariaLabel = ( localize(
                8226,
...
class DataBreakpointInputRenderer {
    ...
    renderElement(node, _index, data) {
        ...
        if (data.type === "condition") {
            ...
            placeholder = ( localize(8227, "Break when expression evaluates to true"));
            ariaLabel = ( localize(
                8228,
            ...
            placeholder = ( localize(8229, "Break when hit count is met"));
            ariaLabel = ( localize(8230, "Type hit count. Data breakpoint will break when hit count is met."));
        }
        data.inputBox.setAriaLabel(ariaLabel);
        data.inputBox.setPlaceHolder(placeholder);
        setTimeout(() => {
...
class ExceptionBreakpointInputRenderer {
    ...
    renderTemplate(container) {
        ...
        const inputBoxContainer = append(breakpoint, $(".inputBoxContainer"));
        const inputBox = ( new InputBox(inputBoxContainer, this.contextViewService, {
            ariaLabel: ( localize(8231, "Type exception breakpoint condition")),
            inputBoxStyles: defaultInputBoxStyles
        }));
        toDispose.add(inputBox);
        const wrapUp = success => {
    ...
    renderElement(node, _index, data) {
        const exceptionBreakpoint = node.element;
        const placeHolder = exceptionBreakpoint.conditionDescription || ( localize(8232, "Break when expression evaluates to true"));
        data.inputBox.setPlaceHolder(placeHolder);
...
class BreakpointsAccessibilityProvider {
    ...
    getWidgetAriaLabel() {
        return localize(8233, "Breakpoints");
    }
    getRole() {
        return "checkbox";
    }
...
function getBreakpointMessageAndIcon(state, breakpointsActivated, breakpoint$1, labelService, debugModel) {
    ...
    if (!breakpoint$1.enabled || !breakpointsActivated) {
        return {
            ...
            message: breakpoint$1.logMessage ? ( localize(8235, "Disabled Logpoint")) : ( localize(8236, "Disabled Breakpoint"))
        };
    }
    ...
    if (debugActive && !breakpoint$1.verified) {
        return {
            ...
            message: breakpoint$1.message ? breakpoint$1.message : (breakpoint$1.logMessage ? ( localize(8237, "Unverified Logpoint")) : ( localize(8238, "Unverified Breakpoint"))),
    ...
    if (breakpoint$1 instanceof DataBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(8239, "Data breakpoints not supported by this debug type"))
            };
        }
        return {
            icon: breakpointIcon.regular,
            message: breakpoint$1.message || ( localize(8240, "Data Breakpoint"))
        };
    }
    if (breakpoint$1 instanceof FunctionBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(8241, "Function breakpoints not supported by this debug type"))
            };
        }
        const messages = [];
        messages.push(breakpoint$1.message || ( localize(8242, "Function Breakpoint")));
        if (breakpoint$1.condition) {
            messages.push(( localize(8243, "Condition: {0}", breakpoint$1.condition)));
        }
        if (breakpoint$1.hitCondition) {
            messages.push(( localize(8244, "Hit Count: {0}", breakpoint$1.hitCondition)));
        }
        return {
            icon: breakpointIcon.regular,
    ...
    if (breakpoint$1 instanceof InstructionBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(8245, "Instruction breakpoints not supported by this debug type"))
            };
        }
        const messages = [];
        if (breakpoint$1.message) {
            ...
            messages.push(( localize(8247, "Instruction breakpoint")));
        }
        if (breakpoint$1.hitCondition) {
            messages.push(( localize(8244, "Hit Count: {0}", breakpoint$1.hitCondition)));
        }
    ...
    if (breakpoint$1.logMessage || breakpoint$1.condition || breakpoint$1.hitCondition || triggeringBreakpoint) {
        ...
        if (!breakpoint$1.supported) {
            ...
            messages.push(( localize(8248, "Breakpoints of this type are not supported by the debugger")));
        }
        if (breakpoint$1.logMessage) {
            messages.push(( localize(8249, "Log Message: {0}", breakpoint$1.logMessage)));
        }
        if (breakpoint$1.condition) {
            messages.push(( localize(8243, "Condition: {0}", breakpoint$1.condition)));
        }
    ...
    const message = breakpoint$1.message ? breakpoint$1.message : breakpoint$1 instanceof Breakpoint && labelService ? labelService.getUriLabel(breakpoint$1.uri) : ( localize(8251, "Breakpoint"));
    return {
        icon: breakpointIcon.regular,
        message
    };
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(8252, "Add Function Breakpoint")),
                mnemonicTitle: ( localize(8253, "&&Function Breakpoint..."))
            },
            f1: true,
...
class MemoryBreakpointAction extends Action2 {
    async run(accessor, existingBreakpoint) {
        ...
        if (info.accessTypes && info.accessTypes?.length > 1) {
            ...
            const selectedAccessType = await quickInput.pick(accessTypes, {
                placeHolder: ( localize(8255, "Select the access type to monitor"))
            });
    ...
    getRange(quickInput, defaultValue) {
        return (new Promise(resolve => {
            ...
            input.prompt = ( localize(8256, "Enter a memory range in which to break"));
    ...
    parseAddress(range, isFinal) {
        ...
        if (sign === "-") {
            if (start > end) {
                return {
                    error: ( localize(8260, "End ({1}) should be greater than Start ({0})", startStr, endStr))
                };
            }
            return {
                address,
...
registerAction2(class extends MemoryBreakpointAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(8261, "Add Data Breakpoint at Address")),
                mnemonicTitle: ( localize(8262, "&&Data Breakpoint..."))
            },
            f1: true,
...
registerAction2(class extends MemoryBreakpointAction {
    constructor() {
        super({
            ...
            title: ( localize2(8263, "Edit Address...")),
            menu: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8264, "Toggle Activate Breakpoints")),
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(8265, "Remove Breakpoint")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(8266, "Remove All Breakpoints")),
                mnemonicTitle: ( localize(8267, "Remove &&All Breakpoints"))
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(8268, "Enable All Breakpoints")),
                mnemonicTitle: ( localize(8269, "&&Enable All Breakpoints"))
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(8270, "Disable All Breakpoints")),
                mnemonicTitle: ( localize(8271, "Disable A&&ll Breakpoints"))
            },
            f1: true,
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menu: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8272, "Reapply All Breakpoints")),
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8273, "Toggle Breakpoints View Presentation")),
            f1: true,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(8274, "Edit Condition...")),
            icon: Codicon.edit,
    ...
    async runInView(accessor, view, breakpoint) {
        ...
        if (breakpoint instanceof Breakpoint) {
            ...
            const actions = [( new Action("breakpoint.editCondition", ( localize(8274, "Edit Condition...")), undefined, true, async () => view.renderInputBox({
                breakpoint,
                type: "condition"
            }))), ( new Action("breakpoint.editCondition", ( localize(8275, "Edit Hit Count...")), undefined, true, async () => view.renderInputBox({
                breakpoint,
                type: "hitCount"
            })))];
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: BREAKPOINTS_VIEW_ID,
            title: ( localize(8276, "Edit Function Condition...")),
            menu: [{
                id: MenuId.DebugBreakpointsContext,
                group: "navigation",
                order: 10,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: BREAKPOINTS_VIEW_ID,
            title: ( localize(8275, "Edit Hit Count...")),
            precondition: CONTEXT_BREAKPOINT_SUPPORTS_CONDITION,
            menu: [{
                id: MenuId.DebugBreakpointsContext,
                group: "navigation",
...
registerAction2(class extends ViewAction {
    ...
    async runInView(accessor, view, breakpoint) {
        ...
        const picked = await accessor.get(IQuickInputService).pick(( modes.map(mode => ({
            ...
            placeHolder: ( localize(8278, "Select Breakpoint Mode"))
        });
        if (!picked) {
            return;
        }
