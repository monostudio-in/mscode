...
const DEBUG_COMMAND_CATEGORY = ( localize2(8448, "Debug"));
const RESTART_LABEL = ( localize2(8449, "Restart"));
const STEP_OVER_LABEL = ( localize2(8450, "Step Over"));
const STEP_INTO_LABEL = ( localize2(8451, "Step Into"));
const STEP_INTO_TARGET_LABEL = ( localize2(8452, "Step Into Target"));
const STEP_OUT_LABEL = ( localize2(8453, "Step Out"));
const PAUSE_LABEL = ( localize2(8454, "Pause"));
const DISCONNECT_LABEL = ( localize2(8455, "Disconnect"));
const DISCONNECT_AND_SUSPEND_LABEL = ( localize2(8456, "Disconnect and Suspend"));
const STOP_LABEL = ( localize2(8457, "Stop"));
const CONTINUE_LABEL = ( localize2(8458, "Continue"));
const FOCUS_SESSION_LABEL = ( localize2(8459, "Focus Session"));
const SELECT_AND_START_LABEL = ( localize2(8460, "Select and Start Debugging"));
const DEBUG_CONFIGURE_LABEL = ( localize(8461, "Open '{0}'", "launch.json"));
const DEBUG_START_LABEL = ( localize2(8462, "Start Debugging"));
const DEBUG_RUN_LABEL = ( localize2(8463, "Start Without Debugging"));
const NEXT_DEBUG_CONSOLE_LABEL = ( localize2(8464, "Focus Next Debug Console"));
const PREV_DEBUG_CONSOLE_LABEL = ( localize2(8465, "Focus Previous Debug Console"));
const OPEN_LOADED_SCRIPTS_LABEL = ( localize2(8466, "Open Loaded Script..."));
const CALLSTACK_TOP_LABEL = ( localize2(8467, "Navigate to Top of Call Stack"));
const CALLSTACK_BOTTOM_LABEL = ( localize2(8468, "Navigate to Bottom of Call Stack"));
const CALLSTACK_UP_LABEL = ( localize2(8469, "Navigate Up Call Stack"));
const CALLSTACK_DOWN_LABEL = ( localize2(8470, "Navigate Down Call Stack"));
const COPY_EVALUATE_PATH_LABEL = ( localize2(8471, "Copy as Expression"));
const COPY_VALUE_LABEL = ( localize2(8472, "Copy Value"));
const COPY_ADDRESS_LABEL = ( localize2(8473, "Copy Address"));
const ADD_TO_WATCH_LABEL = ( localize2(8474, "Add to Watch"));
const SELECT_DEBUG_CONSOLE_LABEL = ( localize2(8475, "Select Debug Console"));
const SELECT_DEBUG_SESSION_LABEL = ( localize2(8476, "Select Debug Session"));
...
CommandsRegistry.registerCommand({
    ...
    handler: async accessor => {
                ...
                if (targets && targets.length) {
                    ...
                    if (targets.length > 1) {
                        ...
                        const pick = await quickInputService.pick(picks, {
                            placeHolder: ( localize(8477, "Choose the specific location"))
                        });
                        if (!pick) {
                            return;
                        }
        ...
        return notificationService.warn(( localize(8478, "No executable code is associated at the current cursor position.")));
    }
});
CommandsRegistry.registerCommand({
    id: CALLSTACK_TOP_ID,
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    command: {
        id: JUMP_TO_CURSOR_ID,
        title: ( localize(8479, "Jump to Cursor")),
    ...
    handler: async (accessor, _, context) => {
        ...
        session.stepInTargets(frame.frameId).then(targets => {
            ...
            if (targets?.length) {
                ...
                qp.placeholder = ( localize(8480, "No step targets available"));
            }
        });
    }
});
...
registerAction2(class AddConfigurationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8481, "Add Configuration...")),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
            menu: {
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    command: {
        id: TOGGLE_INLINE_BREAKPOINT_ID,
        title: ( localize(8482, "Add Inline Breakpoint")),
        category: DEBUG_COMMAND_CATEGORY
    },
...
registerAction2(class ToggleExceptionBreakpointsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8483, "Toggle Exception Breakpoints")),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
    ...
    async run(accessor) {
        ...
        quickPick.placeholder = ( localize(8484, "Pick enabled exception breakpoints"));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8485, "Attach to Current Code Renderer"))
        });
    }
    async run(accessor) {
