...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    ...
    "properties": {
        "notebook.lineNumbers": {
            ...
            enum: ["off", "on"],
            default: "off",
            markdownDescription: ( localize(11560, "Controls the display of line numbers in the cell editor."))
        }
    }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(11561, "Toggle Notebook Line Numbers")),
            shortTitle: ( localize2(11562, "Line Numbers")),
            ...
            toggled: {
                ...
                title: ( localize(11563, "Line Numbers"))
            }
        });
    }
    async run(accessor) {
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: ( localize(11564, "Show Cell Line Numbers")),
