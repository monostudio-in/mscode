...
let CodeCell = class CodeCell extends Disposable {
    ...
    _attachInputExpandButton(element) {
        ...
        if (keybinding) {
            element.title = ( localize(11573, "Double-click to expand cell input ({0})", keybinding.getLabel()));
            expandIcon.title = ( localize(11574, "Expand Cell Input ({0})", keybinding.getLabel()));
        }
