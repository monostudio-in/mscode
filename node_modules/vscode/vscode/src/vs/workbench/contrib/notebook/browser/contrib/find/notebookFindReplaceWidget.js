...
const NLS_FIND_INPUT_LABEL = ( localize(11141, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(11142, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(11143, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(11144, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(11145, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(11146, "Close"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(11147, "Toggle Replace"));
const NLS_REPLACE_INPUT_LABEL = ( localize(11148, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(11149, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(11150, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(11151, "Replace All"));
registerIcon("find-filter", Codicon.filter, ( localize(11152, "Icon for Find Filter in find widget.")));
const NOTEBOOK_FIND_FILTERS = ( localize(11153, "Find Filters"));
const NOTEBOOK_FIND_IN_MARKUP_INPUT = ( localize(11154, "Markdown Source"));
const NOTEBOOK_FIND_IN_MARKUP_PREVIEW = ( localize(11155, "Rendered Markdown"));
const NOTEBOOK_FIND_IN_CODE_INPUT = ( localize(11156, "Code Cell Source"));
const NOTEBOOK_FIND_IN_CODE_OUTPUT = ( localize(11157, "Code Cell Output"));
