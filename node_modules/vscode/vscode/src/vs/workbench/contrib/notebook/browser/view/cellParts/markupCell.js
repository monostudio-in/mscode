...
let MarkupCell = class MarkupCell extends Disposable {
    ...
    viewUpdateCollapsed() {
        ...
        if (keybinding) {
            element.title = ( localize(11585, "Double-click to expand cell input ({0})", keybinding.getLabel()));
            expandIcon.title = ( localize(11586, "Expand Cell Input ({0})", keybinding.getLabel()));
        }
