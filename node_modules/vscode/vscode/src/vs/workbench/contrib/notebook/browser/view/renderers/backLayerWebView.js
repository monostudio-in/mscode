...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            "notebook-cell-markup-empty-content": ( localize(11587, "Empty markdown cell, double-click or press enter to edit.")),
            "notebook-cell-renderer-not-found-error": ( localize(11588, "No renderer found for '$0'")),
            "notebook-cell-renderer-fallbacks-exhausted": ( localize(11589, "Could not render content for '$0'")),
    ...
    _createInset(webviewService, content) {
        ...
        const webview = webviewService.createWebviewElement({
            ...
            title: ( localize(11590, "Notebook webview content")),
            options: {
