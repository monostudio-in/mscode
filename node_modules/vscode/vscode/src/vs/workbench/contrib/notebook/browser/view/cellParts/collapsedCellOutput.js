...
let CollapsedCellOutput = class CollapsedCellOutput extends CellContentPart {
    constructor(notebookEditor, cellOutputCollapseContainer, keybindingService) {
        ...
        placeholder.textContent = ( localize(11580, "Outputs are collapsed"));
        ...
        if (keybinding) {
            placeholder.title = ( localize(11581, "Double-click to expand cell output ({0})", keybinding.getLabel()));
            cellOutputCollapseContainer.title = ( localize(11582, "Expand Cell Output (${0})", keybinding.getLabel()));
        }
