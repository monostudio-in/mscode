...
class ToggleCollapseUnchangedRegions extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(167, "Toggle Collapse Unchanged Regions")),
            icon: Codicon.map,
...
class ToggleShowMovedCodeBlocks extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(168, "Toggle Show Moved Code Blocks")),
            precondition: ( ContextKeyExpr.has("isInDiffEditor"))
        });
    }
    run(accessor, ...args) {
...
class ToggleUseInlineViewWhenSpaceIsLimited extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(169, "Toggle Use Inline View When Space Is Limited")),
            precondition: ( ContextKeyExpr.has("isInDiffEditor"))
        });
    }
    run(accessor, ...args) {
...
const diffEditorCategory = ( localize2(170, "Diff Editor"));
class SwitchSide extends EditorAction2 {
    constructor() {
        super({
            id: "diffEditor.switchSide",
            title: ( localize2(171, "Switch Side")),
...
class ExitCompareMove extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(172, "Exit Compare Move")),
            icon: Codicon.close,
...
class CollapseAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(173, "Collapse All Unchanged Regions")),
            icon: Codicon.fold,
            precondition: ( ContextKeyExpr.has("isInDiffEditor")),
            f1: true,
            category: diffEditorCategory
...
class ShowAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(174, "Show All Unchanged Regions")),
            icon: Codicon.unfold,
            precondition: ( ContextKeyExpr.has("isInDiffEditor")),
            f1: true,
            category: diffEditorCategory
...
const accessibleDiffViewerCategory = ( localize2(176, "Accessible Diff Viewer"));
class AccessibleDiffViewerNext extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(177, "Go to Next Difference")),
...
class AccessibleDiffViewerPrev extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(178, "Go to Previous Difference")),
            category: accessibleDiffViewerCategory,
            precondition: ( ContextKeyExpr.has("isInDiffEditor")),
            keybinding: {
