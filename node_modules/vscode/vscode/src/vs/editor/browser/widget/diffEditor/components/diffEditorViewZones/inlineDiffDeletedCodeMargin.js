            ...
            this._contextMenuService.showContextMenu({
                ...
                getActions: () => {
                    ...
                    actions.push(( new Action(
                        ...
                        isDeletion ? (_diff.original.length > 1 ? ( localize(194, "Copy deleted lines")) : ( localize(195, "Copy deleted line"))) : (_diff.original.length > 1 ? ( localize(196, "Copy changed lines")) : ( localize(197, "Copy changed line"))),
                        undefined,
                        true,
                        async () => {
                    ...
                    if (!readOnly) {
                        actions.push(( new Action("diff.inline.revertChange", ( localize(200, "Revert this change")), undefined, true, async () => {
