...
let ScreenReaderSupport = class ScreenReaderSupport extends Disposable {
    ...
    _updateDomAttributes() {
        ...
        this._domNode.domNode.setAttribute("aria-roledescription", ( localize(146, "editor")));
...
ScreenReaderSupport = ( __decorate([( __param(3, IKeybindingService)), ( __param(4, IAccessibilityService))], ScreenReaderSupport));
