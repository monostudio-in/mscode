...
let TextAreaEditContext = class TextAreaEditContext extends AbstractEditContext {
    constructor(
        ...
        this.textArea.setAttribute("aria-roledescription", ( localize(151, "editor")));
        ...
        this._textAreaInput = this._register(
            this._instantiationService.createInstance(TextAreaInput, textAreaInputHost, textAreaWrapper, OS, {
                isAndroid: isAndroid,
                isChrome: isChrome,
                isFirefox: isFirefox,
                isSafari: isSafari
...
TextAreaEditContext = ( __decorate([( __param(5, IKeybindingService)), ( __param(6, IInstantiationService))], TextAreaEditContext));
