    ...
    async initWebgpu() {
        ...
        let layoutInfoUniformBuffer;
        {
            ...
            const updateBufferValues = (
                canvasDevicePixelWidth = this.canvas.width,
                canvasDevicePixelHeight = this.canvas.height
            ) => {
            ...
            this._register(runOnChange(this._viewGpuContext.canvasDevicePixelDimensions, (
                {
                    width,
                    height
                }
...
ViewLinesGpu = ( __decorate([( __param(2, IInstantiationService)), ( __param(3, ILogService))], ViewLinesGpu));
