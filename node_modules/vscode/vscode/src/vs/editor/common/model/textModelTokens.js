...
class TokenizerWithStateStoreAndTextModel extends TokenizerWithStateStore {
    ...
    isCheapToTokenize(lineNumber) {
        ...
        if (lineNumber === firstInvalidLineNumber && this._textModel.getLineLength(lineNumber) < Constants.CHEAP_TOKENIZATION_LENGTH_LIMIT) {
            return true;
        }
        return false;
    }
    ...
    guessStartState(lineNumber) {
        let {
            likelyRelevantLines,
            initialState
        } = findLikelyRelevantLines(this._textModel, lineNumber, this);
        if (!initialState) {
