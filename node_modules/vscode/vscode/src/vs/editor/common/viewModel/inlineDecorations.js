    ...
    _getOrCreateViewModelDecoration(modelDecoration) {
        ...
        if (!r) {
            ...
            if (options.isWholeLine) {
                ...
                const end = this.coordinatesConverter.convertModelPositionToViewPosition(( new Position(
                ...
                if (lineStartOffsetInInputWithInjections < injectedTextEndOffsetInInputWithInjections) {
                    ...
                    if (options.inlineClassName) {
                        ...
                        if (start !== end) {
                            ...
                            const type = options.inlineClassNameAffectsLetterSpacing ? InlineDecorationType.RegularAffectingLetterSpacing : InlineDecorationType.Regular;
...
export { InjectedTextInlineDecorationsComputer, InlineDecoration, InlineDecorationType, InlineModelDecorationsComputer };
