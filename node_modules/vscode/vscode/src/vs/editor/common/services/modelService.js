...
let ModelService = class ModelService extends Disposable {
    ...
    updateModel(
        ...
        model.pushEditOperations(
            [],
            ModelService_1._computeEdits(model, textBuffer),
            () => [],
            undefined,
            reason
        );
    ...
    _schemaShouldMaintainUndoRedoElements(resource) {
        return (
            (resource.scheme === Schemas.file || resource.scheme === Schemas.vscodeRemote || resource.scheme === Schemas.vscodeUserData || resource.scheme === Schemas.vscodeNotebookCell || resource.scheme === "fake-fs")
        );
    }
