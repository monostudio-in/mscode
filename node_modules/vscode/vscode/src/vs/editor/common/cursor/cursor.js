...
class CursorsController extends Disposable {
    ...
    _executeEdit(
        ...
        eventsCollector,
        source,
        cursorChangeReason = CursorChangeReason.NotSet
    ) {
    ...
    endComposition(eventsCollector, source) {
        ...
        this._executeEdit(() => {
            if (source === "keyboard") {
                this._executeEditOperation(TypeOperations.compositionEndWithInterceptors(
        ...
        this._executeEdit(() => {
            if (source === "keyboard") {
                ...
                while (offset < len) {
                    ...
                    this._executeEditOperation(TypeOperations.typeWithInterceptors(
                ...
                this._executeEditOperation(TypeOperations.typeWithoutInterceptors(
                    this._prevEditOperationType,
                    this.context.cursorConfig,
                    this._model,
                    this.getSelections(),
    ...
    compositionType(
        ...
        this._executeEdit(() => {
            this._executeEditOperation(TypeOperations.compositionType(
                this._prevEditOperationType,
                this.context.cursorConfig,
                this._model,
                this.getSelections(),
    ...
    paste(eventsCollector, text, pasteOnNewLine, multicursorText, source) {
        ...
        this._executeEdit(() => {
            this._executeEditOperation(TypeOperations.paste(
                this.context.cursorConfig,
                this._model,
                this.getSelections(),
                text,
...
class CommandExecutor {
    static executeCommands(
        ...
        selectionsBefore,
        commands,
        editReason = EditSources.unknown({
...
class CompositionState {
    ...
    static _deduceOutcome(original, current) {
        const commonPrefix = Math.min(
            ...
            commonPrefixLength(original.text, current.text)
        );
        const commonSuffix = Math.min(
            ...
            commonSuffixLength(original.text, current.text)
        );
