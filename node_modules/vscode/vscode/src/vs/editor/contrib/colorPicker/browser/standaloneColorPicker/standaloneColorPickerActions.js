...
class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1015, "Show or Focus Standalone Color Picker")),
                mnemonicTitle: ( localize(1016, "&&Show or Focus Standalone Color Picker"))
            },
...
class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1018, "Hide the Color Picker")),
            ...
            metadata: {
                description: ( localize2(1019, "Hide the standalone color picker."))
            }
        });
    }
...
class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1020, "Insert Color with Standalone Color Picker")),
