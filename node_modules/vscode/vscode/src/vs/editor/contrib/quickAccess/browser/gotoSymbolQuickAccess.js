...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, ( localize(1481, "The active text editor does not provide symbol information.")));
        (async () => {
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, ( localize(1482, "No matching editor symbols")));
                    } else {
                        this.provideLabelPick(picker, ( localize(1483, "No editor symbols")));
                    }
                }
            } finally {
                if (!token.isCancellationRequested) {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                ...
                tooltip: openSideBySideDirection === "right" ? ( localize(1484, "Open to the Side")) : ( localize(1485, "Open to the Bottom"))
            }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [{
                label: ( localize(1486, "symbols ({0})", filteredSymbolPicks.length)),
                type: "separator"
...
const FALLBACK_NLS_SYMBOL_KIND = ( localize(1487, "properties ({0})"));
const NLS_SYMBOL_KIND_CACHE = {
    [SymbolKind.Method]: ( localize(1488, "methods ({0})")),
    [SymbolKind.Function]: ( localize(1489, "functions ({0})")),
    [SymbolKind.Constructor]: ( localize(1490, "constructors ({0})")),
    [SymbolKind.Variable]: ( localize(1491, "variables ({0})")),
    [SymbolKind.Class]: ( localize(1492, "classes ({0})")),
    [SymbolKind.Struct]: ( localize(1493, "structs ({0})")),
    [SymbolKind.Event]: ( localize(1494, "events ({0})")),
    [SymbolKind.Operator]: ( localize(1495, "operators ({0})")),
    [SymbolKind.Interface]: ( localize(1496, "interfaces ({0})")),
    [SymbolKind.Namespace]: ( localize(1497, "namespaces ({0})")),
    [SymbolKind.Package]: ( localize(1498, "packages ({0})")),
    [SymbolKind.TypeParameter]: ( localize(1499, "type parameters ({0})")),
    [SymbolKind.Module]: ( localize(1500, "modules ({0})")),
    [SymbolKind.Property]: ( localize(1487, "properties ({0})")),
    [SymbolKind.Enum]: ( localize(1501, "enumerations ({0})")),
    [SymbolKind.EnumMember]: ( localize(1502, "enumeration members ({0})")),
    [SymbolKind.String]: ( localize(1503, "strings ({0})")),
    [SymbolKind.File]: ( localize(1504, "files ({0})")),
    [SymbolKind.Array]: ( localize(1505, "arrays ({0})")),
    [SymbolKind.Number]: ( localize(1506, "numbers ({0})")),
    [SymbolKind.Boolean]: ( localize(1507, "booleans ({0})")),
    [SymbolKind.Object]: ( localize(1508, "objects ({0})")),
    [SymbolKind.Key]: ( localize(1509, "keys ({0})")),
    [SymbolKind.Field]: ( localize(1510, "fields ({0})")),
    [SymbolKind.Constant]: ( localize(1511, "constants ({0})"))
};
