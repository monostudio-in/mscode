...
class ToggleCommentLineAction extends CommentLineAction {
    constructor() {
        super(Type.Toggle, {
            ...
            label: ( localize2(1022, "Toggle Line Comment")),
            ...
            menuOpts: {
                ...
                group: "5_insert",
                title: ( localize(1023, "&&Toggle Line Comment")),
                order: 1
            },
...
class AddLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceAdd, {
            ...
            label: ( localize2(1024, "Add Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceRemove, {
            ...
            label: ( localize2(1025, "Remove Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class BlockCommentAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1026, "Toggle Block Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarEditMenu,
                group: "5_insert",
                title: ( localize(1027, "Toggle &&Block Comment")),
                order: 2
            },
            canTriggerInlineEdits: true
        });
