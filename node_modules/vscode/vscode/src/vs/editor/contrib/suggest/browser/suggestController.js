...
class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1598, "Trigger Suggest")),
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1604, "Reset Suggest Widget Size")),
