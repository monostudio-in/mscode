...
var SuggestWidget_1;
registerCss(suggest);
registerColor("editorSuggestWidget.background", editorWidgetBackground, ( localize(1605, "Background color of the suggest widget.")));
registerColor("editorSuggestWidget.border", editorWidgetBorder, ( localize(1606, "Border color of the suggest widget.")));
const editorSuggestWidgetForeground = registerColor("editorSuggestWidget.foreground", editorForeground, ( localize(1607, "Foreground color of the suggest widget.")));
registerColor(
    "editorSuggestWidget.selectedForeground",
    quickInputListFocusForeground,
    ( localize(1608, "Foreground color of the selected entry in the suggest widget."))
);
registerColor(
    "editorSuggestWidget.selectedIconForeground",
    quickInputListFocusIconForeground,
    ( localize(1609, "Icon foreground color of the selected entry in the suggest widget."))
);
const editorSuggestWidgetSelectedBackground = registerColor(
    "editorSuggestWidget.selectedBackground",
    quickInputListFocusBackground,
    ( localize(1610, "Background color of the selected entry in the suggest widget."))
);
registerColor(
    "editorSuggestWidget.highlightForeground",
    listHighlightForeground,
    ( localize(1611, "Color of the match highlights in the suggest widget."))
);
registerColor(
...
registerColor("editorSuggestWidgetStatus.foreground", ( transparent(editorSuggestWidgetForeground, .5)), ( localize(1613, "Foreground color of the suggest widget status.")));
var State;
(function(State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static {
        this.LOADING_MESSAGE = ( localize(1614, "Loading..."));
    }
    static {
        this.NO_SUGGESTIONS_MESSAGE = ( localize(1615, "No suggestions."));
    }
    constructor(
        editor,
        _storageService,
        ...
        this._list = ( new List("SuggestWidget", this._listElement, {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => ( localize(1616, "Suggest")),
                ...
                getAriaLabel: item => {
                    ...
                    if (typeof item.completion.label !== "string") {
                        ...
                        if (detail && description) {
                            label = ( localize(1617, "{0} {1}, {2}, {3}", label, detail, description, kindLabel));
                        } else if (detail) {
                            label = ( localize(1618, "{0} {1}, {2}", label, detail, kindLabel));
                        } else if (description) {
                            label = ( localize(1619, "{0}, {1}, {2}", label, description, kindLabel));
                        }
                    } else {
                        label = ( localize(1620, "{0}, {1}", label, kindLabel));
                    }
                    ...
                    return localize(1621, "{0}, docs: {1}", label, docs);
                }
            }
        }));
