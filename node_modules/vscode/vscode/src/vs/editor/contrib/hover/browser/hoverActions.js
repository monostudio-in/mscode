...
class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1238, "Show or Focus Hover")),
            metadata: {
                    ...
                    schema: {
                        ...
                        properties: {
                            "focus": {
                                ...
                                enumDescriptions: [( localize(1240, "The hover will not automatically take focus.")), ( localize(1241, "The hover will take focus only if it is already visible.")), ( localize(1242, "The hover will automatically take focus when it appears."))],
...
class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1243, "Show Definition Preview Hover")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1244, "Show the definition preview hover in the editor."))
            }
        });
    }
    run(accessor, editor) {
...
class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1245, "Hide Hover")),
...
class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1246, "Scroll Up Hover")),
            ...
            metadata: {
                description: ( localize2(1247, "Scroll up the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1248, "Scroll Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1249, "Scroll down the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1250, "Scroll Left Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1251, "Scroll left the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1252, "Scroll Right Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1253, "Scroll right the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1254, "Page Up Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1255, "Page up the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1256, "Page Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1257, "Page down the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1258, "Go To Top Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1259, "Go to the top of the editor hover."))
            }
        });
    }
    run(accessor, editor) {
...
class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1260, "Go To Bottom Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
                primary: KeyCode.End,
            ...
            metadata: {
                description: ( localize2(1261, "Go to the bottom of the editor hover."))
            }
        });
    }
    run(accessor, editor) {
