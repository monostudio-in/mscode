...
const $ = $$1;
const increaseHoverVerbosityIcon = registerIcon("hover-increase-verbosity", Codicon.addSmall, ( localize(1264, "Icon for increaseing hover verbosity.")));
const decreaseHoverVerbosityIcon = registerIcon("hover-decrease-verbosity", Codicon.removeSmall, ( localize(1265, "Icon for decreasing hover verbosity.")));
class MarkdownHover {
...
let MarkdownHoverParticipant = class MarkdownHoverParticipant {
    ...
    createLoadingMessage(anchor) {
        return (new MarkdownHover(
            this,
            anchor.range,
            [( new MarkdownString()).appendText(( localize(1266, "Loading...")))],
            false,
            2000
        ));
    }
...
function labelForHoverVerbosityAction(keybindingService, action) {
    switch (action) {
    case HoverVerbosityAction.Increase:
        return keybindingService.appendKeybinding(( localize(1269, "Increase Hover Verbosity")), INCREASE_HOVER_VERBOSITY_ACTION_ID);
    case HoverVerbosityAction.Decrease:
        return keybindingService.appendKeybinding(( localize(1270, "Decrease Hover Verbosity")), DECREASE_HOVER_VERBOSITY_ACTION_ID);
    }
}
