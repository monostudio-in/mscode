...
let GlyphHoverWidget = class GlyphHoverWidget extends Disposable {
    ...
    constructor(editor, _markdownRendererService) {
        ...
        this._register(
            addStandardDisposableListener(this._hover.containerDomNode, "mouseleave", e => {
    ...
    _renderMessages(lineNumber, laneOrLine, messages) {
        ...
        for (const msg of messages) {
            ...
            const renderedContents = this._renderDisposeables.add(this._markdownRendererService.render(msg.value, {
...
GlyphHoverWidget = GlyphHoverWidget_1 = ( __decorate([( __param(1, IMarkdownRendererService))], GlyphHoverWidget));
