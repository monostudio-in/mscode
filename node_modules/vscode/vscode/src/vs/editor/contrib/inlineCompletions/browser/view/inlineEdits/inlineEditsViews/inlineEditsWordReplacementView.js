    ...
    constructor(
        ...
        this._layout = derived(this, reader => {
            ...
            if (this._viewData.alternativeAction) {
                ...
                const occurrencesLabel = count !== undefined ? count === 1 ? ( localize(1353, "{0} 1 occurrence", label)) : ( localize(1354, "{0} {1} occurrences", label, count)) : label;
                const keybindingTooltip = ( localize(1355, "{0} show occurrences", "[shift]"));
                alternativeAction = {
