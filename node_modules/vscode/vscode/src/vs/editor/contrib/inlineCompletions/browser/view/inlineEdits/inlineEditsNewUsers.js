...
let InlineEditsOnboardingExperience = class InlineEditsOnboardingExperience extends Disposable {
    constructor(_model, _indicator, _collapsedView, _storageService, _configurationService) {
        ...
        this._setupDone = observableValue({
            name: "setupDone"
        }, false);
...
InlineEditsOnboardingExperience = ( __decorate([( __param(3, IStorageService)), ( __param(4, IConfigurationService))], InlineEditsOnboardingExperience));
