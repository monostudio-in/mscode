...
let InlineEditsSideBySideView = class InlineEditsSideBySideView extends Disposable {
    ...
    constructor(
        ...
        this.previewEditor = this._register(
            this._instantiationService.createInstance(EmbeddedCodeEditorWidget, this.previewRef.element, {
                glyphMargin: false,
                lineNumbers: "off",
                minimap: {
                    enabled: false
        ...
        this._backgroundSvg = n.svg({
            ...
            d: derived(this, reader => {
                ...
                return ( new PathBuilder()).moveTo(layoutInfo.codeRect.getRightTop()).lineTo(layoutInfo.codeRect.getRightTop().deltaX(1000)).lineTo(layoutInfo.codeRect.getRightBottom().deltaX(1000)).lineTo(layoutInfo.codeRect.getRightBottom()).build();
            }),
            style: {
        ...
        this._originalOverlay = n.div({
            ...
            const transitionRect = ( overlayRect.map(overlayRect => Rect.fromLeftTopWidthHeight(
        ...
        }, [this._backgroundSvg, derived(
            this,
            reader => this._shouldOverflow.read(reader) ? [] : [this._editorContainer, this._originalOverlay, this._modifiedOverlay]
        )]).keepUpdated(this._store);
...
InlineEditsSideBySideView = ( __decorate([( __param(5, IInstantiationService)), ( __param(6, IThemeService)), ( __param(7, IUserInteractionService))], InlineEditsSideBySideView));
