...
let InlineEditsLineReplacementView = class InlineEditsLineReplacementView extends Disposable {
    constructor(_editor, _edit, _editorType, _tabAction, _languageService, _themeService) {
        ...
        this._maxPrefixTrim = ( this._edit.map((e, reader) => e ? getPrefixTrim(
        ...
        this._div = n.div({
            ...
            return [n.div({
                ...
                style: {
                    position: "absolute",
                    ...rectToProps(
                        reader => layout.read(reader).background.translateX(-contentLeft).withMargin(separatorWidth)
                    ),
        ...
        this._register(autorunDelta(this._viewZoneInfo, (
            {
                lastValue,
                newValue
            }
...
InlineEditsLineReplacementView = ( __decorate([( __param(4, ILanguageService)), ( __param(5, IThemeService))], InlineEditsLineReplacementView));
