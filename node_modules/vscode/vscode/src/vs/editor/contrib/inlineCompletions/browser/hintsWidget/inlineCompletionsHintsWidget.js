...
const inlineSuggestionHintsNextIcon = registerIcon("inline-suggestion-hints-next", Codicon.chevronRight, ( localize(1341, "Icon for show next parameter hint.")));
const inlineSuggestionHintsPreviousIcon = registerIcon("inline-suggestion-hints-previous", Codicon.chevronLeft, ( localize(1342, "Icon for show previous parameter hint.")));
let InlineSuggestionHintsContentWidget = class InlineSuggestionHintsContentWidget extends Disposable {
    ...
    constructor(
        ...
        this.previousAction = this._register(
            this.createCommandAction(showPreviousInlineSuggestionActionId, ( localize(1343, "Previous")), ThemeIcon.asClassName(inlineSuggestionHintsPreviousIcon))
        );
        ...
        this.nextAction = this._register(this.createCommandAction(showNextInlineSuggestionActionId, ( localize(1344, "Next")), ThemeIcon.asClassName(inlineSuggestionHintsNextIcon)));
