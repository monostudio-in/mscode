...
let StickyScrollController = class StickyScrollController extends Disposable {
    ...
    constructor(
        ...
        this._register(
            addDisposableListener(stickyScrollDomNode, EventType.CONTEXT_MENU, async event => {
        ...
        this._register(
            addDisposableListener(stickyScrollDomNode, EventType.MOUSE_DOWN, e => {
    ...
    _registerMouseListeners() {
        ...
        this._register(
            addStandardDisposableListener(stickyScrollWidgetDomNode, EventType.CLICK, mouseEvent => {
        ...
        this._register(
            addDisposableListener(mainWindow, EventType.MOUSE_MOVE, mouseEvent => {
                this._mouseTarget = mouseEvent.target;
                this._onMouseMoveOrKeyDown(mouseEvent);
            })
        );
        this._register(
            addDisposableListener(mainWindow, EventType.KEY_DOWN, mouseEvent => {
                this._onMouseMoveOrKeyDown(mouseEvent);
            })
        );
