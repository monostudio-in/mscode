...
class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1577, "Toggle Editor Sticky Scroll")),
                mnemonicTitle: ( localize(1578, "&&Toggle Editor Sticky Scroll"))
            },
            metadata: {
            ...
            toggled: {
                ...
                title: ( localize(1580, "Sticky Scroll")),
                mnemonicTitle: ( localize(1581, "&&Sticky Scroll"))
            },
            menu: [{
    ...
    constructor() {
        super({
            ...
            title: {
                ...
                mnemonicTitle: ( localize(1583, "&&Focus Editor Sticky Scroll"))
            },
...
class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1584, "Select the next editor sticky scroll line")),
...
class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1585, "Select the previous sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1586, "Go to the focused sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1587, "Select Editor")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
