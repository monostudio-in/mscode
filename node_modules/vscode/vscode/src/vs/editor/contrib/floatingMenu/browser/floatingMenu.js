...
FloatingEditorToolbar = ( __decorate([( __param(1, IInstantiationService)), ( __param(2, IKeybindingService)), ( __param(3, IMenuService))], FloatingEditorToolbar));
let FloatingEditorToolbarWidget = class FloatingEditorToolbarWidget extends Disposable {
    constructor(
        ...
        const menuPrimaryActionsObs = derived(reader => {
            ...
            const {
                primary
            } = getActionBarActions(menuGroups, () => true);
...
FloatingEditorToolbarWidget = ( __decorate([( __param(3, IInstantiationService)), ( __param(4, IKeybindingService)), ( __param(5, IMenuService))], FloatingEditorToolbarWidget));
