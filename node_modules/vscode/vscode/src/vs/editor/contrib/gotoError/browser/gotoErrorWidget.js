...
class MessageWidget {
    ...
    getAriaLabel(marker) {
        ...
        case MarkerSeverity.Error:
            severityLabel = ( localize(1157, "Error"));
            break;
        case MarkerSeverity.Warning:
            severityLabel = ( localize(1158, "Warning"));
            break;
        case MarkerSeverity.Info:
            severityLabel = ( localize(1159, "Info"));
            break;
        case MarkerSeverity.Hint:
            severityLabel = ( localize(1160, "Hint"));
            break;
        }
...
let MarkerNavigationWidget = class MarkerNavigationWidget extends PeekViewWidget {
    ...
    showAtMarker(marker, markerIdx, markerCount) {
        ...
        if (model) {
            const detail = markerCount > 1 ? ( localize(1162, "{0} of {1} problems", markerIdx, markerCount)) : ( localize(1163, "{0} of {1} problem", markerIdx, markerCount));
...
}, ( localize(1164, "Editor marker navigation widget error color.")));
const editorMarkerNavigationErrorHeader = registerColor("editorMarkerNavigationError.headerBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(1165, "Editor marker navigation widget error heading background.")));
const editorMarkerNavigationWarning = registerColor("editorMarkerNavigationWarning.background", {
    dark: warningDefault,
    light: warningDefault,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(1166, "Editor marker navigation widget warning color.")));
...
}, ( localize(1167, "Editor marker navigation widget warning heading background.")));
const editorMarkerNavigationInfo = registerColor("editorMarkerNavigationInfo.background", {
    dark: infoDefault,
    light: infoDefault,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(1168, "Editor marker navigation widget info color.")));
const editorMarkerNavigationInfoHeader = registerColor("editorMarkerNavigationInfo.headerBackground", {
    ...
    hcDark: null,
    hcLight: null
}, ( localize(1169, "Editor marker navigation widget info heading background.")));
const editorMarkerNavigationBackground = registerColor("editorMarkerNavigation.background", editorBackground, ( localize(1170, "Editor marker navigation widget background.")));
