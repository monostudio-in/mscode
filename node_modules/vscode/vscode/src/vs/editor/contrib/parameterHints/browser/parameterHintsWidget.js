...
const $ = $$1;
const parameterHintsNextIcon = registerIcon("parameter-hints-next", Codicon.chevronDown, ( localize(1446, "Icon for show next parameter hint.")));
const parameterHintsPreviousIcon = registerIcon("parameter-hints-previous", Codicon.chevronUp, ( localize(1447, "Icon for show previous parameter hint.")));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                alert(( localize(1448, "{0}, hint", labelToAnnounce)));
...
registerColor(
    ...
    ( localize(1449, "Foreground color of the active item in the parameter hint."))
);
