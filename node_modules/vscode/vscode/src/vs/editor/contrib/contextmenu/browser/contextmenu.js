...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        actions.push(createAction({
            label: ( localize(1029, "Render Characters")),
        ...
        actions.push(createEnumAction(( localize(1030, "Vertical size")), minimapOptions.enabled, "editor.minimap.size", minimapOptions.size, [{
            label: ( localize(1031, "Proportional")),
            value: "proportional"
        }, {
            label: ( localize(1032, "Fill")),
            value: "fill"
        }, {
            label: ( localize(1033, "Fit")),
            value: "fit"
        }]));
        actions.push(createEnumAction(( localize(1034, "Slider")), minimapOptions.enabled, "editor.minimap.showSlider", minimapOptions.showSlider, [{
            label: ( localize(1035, "Mouse Over")),
            value: "mouseover"
        }, {
            label: ( localize(1036, "Always")),
            value: "always"
        }]));
        actions.push(createEnumAction(( localize(1037, "Side")), minimapOptions.enabled, "editor.minimap.side", minimapOptions.side, [{
            label: ( localize(1038, "Right")),
            value: "right"
        }, {
            label: ( localize(1039, "Left")),
            value: "left"
        }]));
        const useShadowDOM = this._editor.getOption(EditorOption.useShadowDOM) && !isIOS;
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1040, "Show Editor Context Menu")),
