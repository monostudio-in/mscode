...
class Gesture extends Disposable {
    ...
    constructor() {
        ...
        this._register(Event.runAndSubscribe(onDidRegisterWindow, (
            ...
            disposables.add(
                addDisposableListener(window.document, "touchstart", e => this.onTouchStart(e), {
                    passive: false
                })
            );
            disposables.add(
